...
function useDisableClick(disabled, handleClick) {
  const handleClickWrapper = (0, import_react22.useCallback)((event) => {
    if (disabled) {
...
function Spinner({
  ...
  const spinnerSVGMarkup = size === "large" ? import_react25.default.createElement("svg", {
    viewBox: "0 0 44 44",
  ...
  const accessibilityLabelMarkup = (isAfterInitialMount || !hasFocusableParent) && import_react25.default.createElement(VisuallyHidden, null, accessibilityLabel);
  return import_react25.default.createElement(import_react25.default.Fragment, null, import_react25.default.createElement("span", {
    className
  }, spinnerSVGMarkup), import_react25.default.createElement("span", spanAttributes, accessibilityLabelMarkup));
}
...
function usePortalsManager() {
  const portalsManager = (0, import_react26.useContext)(PortalsManagerContext);
  if (!portalsManager) {
...
function useUniqueId(prefix = "", overrideId = "") {
  const idFactory = (0, import_react27.useContext)(UniqueIdFactoryContext);
  const uniqueIdRef = (0, import_react27.useRef)(null);
  if (!idFactory) {
...
function Portal({
  ...
  return container ? (0, import_react_dom.createPortal)(import_react28.default.createElement("div", {
...
function wrapWithComponent(element, Component9, props) {
  ...
  return isElementOfType(element, Component9) ? element : import_react29.default.createElement(Component9, props, element);
}
...
function isElementOfType(element, Component9) {
  var _element$props;
  if (element == null || !(0, import_react29.isValidElement)(element) || typeof element.type === "string") {
    return false;
  }
  const {
    type: defaultType
...
function elementChildren(children2, predicate = () => true) {
  return import_react29.Children.toArray(children2).filter((child) => (0, import_react29.isValidElement)(child) && predicate(child));
}
...
function KeypressListener({
  ...
  const tracked = (0, import_react30.useRef)({
    handler,
    keyCode
  });
  useIsomorphicLayoutEffect(() => {
  ...
  const handleKeyEvent = (0, import_react30.useCallback)((event) => {
    const {
      handler: handler2,
      keyCode: keyCode2
    } = tracked.current;
...
var ScrollableContext = (0, import_react31.createContext)(void 0);
...
function ScrollTo() {
  const anchorNode = (0, import_react32.useRef)(null);
  const scrollToPosition = (0, import_react32.useContext)(ScrollableContext);
  ...
  return import_react32.default.createElement("a", {
    id,
    ref: anchorNode
  });
}
...
var Scrollable = class extends import_react33.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      topShadow: false,
  ...
  render() {
    ...
    return import_react33.default.createElement(ScrollableContext.Provider, {
      value: this.scrollToPosition
    }, import_react33.default.createElement(StickyManagerContext.Provider, {
      value: this.stickyManager
    }, import_react33.default.createElement("div", Object.assign({
...
var PositionedOverlay = class extends import_react34.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      measuring: true,
  ...
  render() {
    ...
    return import_react34.default.createElement("div", {
      ...
      style,
      ref: this.setOverlay
    }, import_react34.default.createElement(EventListener, {
      event: "resize",
...
function Pane({
  ...
  return fixed ? import_react36.default.createElement("div", {
    style,
    className
  }, content) : import_react36.default.createElement(Scrollable, {
    shadow: true,
    className,
    style,
    onScrolledToBottom
...
var PopoverOverlay = class extends import_react37.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      transitionStatus: this.props.active ? TransitionStatus.Entering : TransitionStatus.Exited
    };
    this.contentNode = (0, import_react37.createRef)();
    ...
    this.renderPopover = (overlayDetails) => {
      ...
      const content = import_react37.default.createElement("div", {
        id,
      ...
      return import_react37.default.createElement("div", Object.assign({
        className
      }, overlay.props), import_react37.default.createElement(EventListener, {
        event: "click",
        handler: this.handleClick
      }), import_react37.default.createElement(EventListener, {
        event: "touchstart",
        handler: this.handleClick
      }), import_react37.default.createElement(KeypressListener, {
        keyCode: Key.Escape,
      ...
      }, content), import_react37.default.createElement("div", {
        className: styles6.FocusTracker,
        tabIndex: 0,
    ...
    this.overlayRef = (0, import_react37.createRef)();
  }
  forceUpdatePosition() {
  ...
  render() {
    ...
    return import_react37.default.createElement(PositionedOverlay, {
      ref: this.overlayRef,
      fullWidth,
      active,
      activator,
...
function renderPopoverContent(children2, props) {
  const childrenArray = import_react37.Children.toArray(children2);
...
// node_modules/@shopify/polaris/build/esm/components/Popover/Popover.js
var PopoverComponent = (0, import_react38.forwardRef)(function Popover({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react38.useState)();
  const overlayRef = (0, import_react38.useRef)(null);
  const activatorContainer = (0, import_react38.useRef)(null);
  ...
  const setAccessibilityAttributes = (0, import_react38.useCallback)(() => {
  ...
  const portal2 = activatorNode ? import_react38.default.createElement(Portal, {
    idPrefix: "popover"
  }, import_react38.default.createElement(PopoverOverlay, Object.assign({
    ref: overlayRef,
    id,
  ...
  return import_react38.default.createElement(WrapperComponent, {
    ref: activatorContainer
  }, import_react38.Children.only(activator), portal2);
});
...
function TextStyle({
  ...
  return import_react39.default.createElement(Element2, {
    className
  }, children2);
}
...
var WithinFilterContext = (0, import_react40.createContext)(false);
...
function Pip({
  ...
  return import_react42.default.createElement("span", {
    className
  }, import_react42.default.createElement(VisuallyHidden, null, accessibilityLabel));
}
...
function Icon({
  ...
  const contentMarkup = {
    function: import_react43.default.createElement(SourceComponent, {
      className: styles13.Svg,
      focusable: "false",
      "aria-hidden": "true"
    }),
    placeholder: import_react43.default.createElement("div", {
      className: styles13.Placeholder
    }),
    external: import_react43.default.createElement("img", {
  ...
  return import_react43.default.createElement("span", {
    className
  }, import_react43.default.createElement(VisuallyHidden, null, accessibilityLabel), contentMarkup[sourceType]);
}
...
function Badge({
  ...
  let accessibilityMarkup = Boolean(accessibilityLabel) && import_react44.default.createElement(VisuallyHidden, null, accessibilityLabel);
  if (progress && !icon) {
    accessibilityMarkup = import_react44.default.createElement("span", {
      className: styles11.PipContainer
    }, import_react44.default.createElement(Pip, {
      progress,
      status,
      accessibilityLabelOverride: accessibilityLabel
    }));
  }
  return import_react44.default.createElement("span", {
    className
  }, accessibilityMarkup, icon && import_react44.default.createElement("span", {
    className: styles11.Icon
  }, import_react44.default.createElement(Icon, {
    source: icon
  })), children2 && import_react44.default.createElement("span", null, children2));
}
Badge.Pip = Pip;
...
function useLink() {
  return (0, import_react45.useContext)(LinkContext);
}

// node_modules/@shopify/polaris/build/esm/components/UnstyledLink/UnstyledLink.js
var UnstyledLink = (0, import_react46.memo)((0, import_react46.forwardRef)(function UnstyledLink2(props, _ref) {
  const LinkComponent = useLink();
  if (LinkComponent) {
    return import_react46.default.createElement(LinkComponent, Object.assign({}, unstyled.props, props));
  }
  const {
    external,
    url,
  ...
  return import_react46.default.createElement("a", Object.assign({
    target
  }, rest, {
    href: url,
    rel
...
function Item({
  ...
  if (prefix) {
    prefixMarkup = import_react47.default.createElement("span", {
      className: styles9.Prefix
    }, prefix);
  } else if (icon) {
    prefixMarkup = import_react47.default.createElement("span", {
      className: styles9.Prefix
    }, import_react47.default.createElement(Icon, {
      source: icon
    }));
  } else if (image) {
    prefixMarkup = import_react47.default.createElement("span", {
  ...
  const contentMarkup = helpText ? import_react47.default.createElement("span", {
    className: styles9.ContentBlock
  }, import_react47.default.createElement("span", {
    className: styles9.ContentBlockInner
  }, contentText), import_react47.default.createElement(TextStyle, {
    variation: "subdued"
  }, helpText)) : contentText;
  const badgeMarkup = badge && import_react47.default.createElement("span", {
    className: styles9.Suffix
  }, import_react47.default.createElement(Badge, {
    status: badge.status
  }, badge.content));
  const suffixMarkup = suffix && import_react47.default.createElement("span", {
    className: styles9.Suffix
  }, suffix);
  const textMarkup = import_react47.default.createElement("span", {
    className: styles9.Text
  }, contentMarkup);
  const contentElement = import_react47.default.createElement("span", {
    className: styles9.Content
  }, prefixMarkup, textMarkup, badgeMarkup, suffixMarkup);
  const scrollMarkup = active ? import_react47.default.createElement(Scrollable.ScrollTo, null) : null;
  const control = url ? import_react47.default.createElement(UnstyledLink, {
    id,
    ...
    role
  }, contentElement) : import_react47.default.createElement("button", {
    id,
    type: "button",
    className,
    disabled,
  ...
  return import_react47.default.createElement(import_react47.default.Fragment, null, scrollMarkup, control);
}
...
function Section2({
  ...
  const actionMarkup = section.items.map(({
    ...
    }, import_react48.default.createElement(Item, Object.assign({
      content,
      helpText,
      role: actionRole,
  ...
  const titleMarkup = section.title ? import_react48.default.createElement("p", {
  ...
  const sectionMarkup = import_react48.default.createElement("div", {
    className
  }, titleMarkup, import_react48.default.createElement("ul", {
    className: styles9.Actions,
    role: sectionRole,
    tabIndex: !hasMultipleSections ? -1 : void 0
  }, actionMarkup));
  return hasMultipleSections ? import_react48.default.createElement("li", {
...
function ActionList({
  ...
  let finalSections = [];
  const actionListRef = (0, import_react49.useRef)(null);
  if (items) {
    finalSections = [{
      items
    }, ...sections];
  ...
  const sectionMarkup = finalSections.map((section, index) => {
    return section.items.length > 0 ? import_react49.default.createElement(Section2, {
  ...
  const listeners = actionRole === "menuitem" ? import_react49.default.createElement(import_react49.default.Fragment, null, import_react49.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleFocusNextItem
  }), import_react49.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
    handler: handleFocusPreviousItem
  })) : null;
  return import_react49.default.createElement(Element2, {
    ref: actionListRef,
    className,
    role: elementRole,
...
function UnstyledButton({
  ...
  if (url) {
    buttonMarkup = disabled ? import_react50.default.createElement("a", commonProps, children2) : import_react50.default.createElement(UnstyledLink, Object.assign({}, interactiveProps, {
      url,
      external,
      download
    }, rest), children2);
  } else {
    buttonMarkup = import_react50.default.createElement("button", Object.assign({}, interactiveProps, {
...
function Button({
  ...
  const disclosureMarkup = disclosure ? import_react51.default.createElement("span", {
  ...
  const iconSource = isIconSource(icon) ? import_react51.default.createElement(Icon, {
    source: loading ? "placeholder" : icon
  }) : icon;
  const iconMarkup = iconSource ? import_react51.default.createElement("span", {
    className: classNames(styles3.Icon, loading && styles3.hidden)
  }, iconSource) : null;
  const childMarkup = children2 ? import_react51.default.createElement("span", {
    className: classNames(styles3.Text, removeUnderline && styles3.removeUnderline),
    key: disabled ? "text-disabled" : "text"
  }, children2) : null;
  const spinnerSVGMarkup = loading ? import_react51.default.createElement("span", {
    className: styles3.Spinner
  }, import_react51.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: i18n.translate("Polaris.Button.spinnerAccessibilityLabel")
  })) : null;
  const [disclosureActive, setDisclosureActive] = (0, import_react51.useState)(false);
  const toggleDisclosureActive = (0, import_react51.useCallback)(() => {
  ...
  if (connectedDisclosure) {
    ...
    const connectedDisclosureActivator = import_react51.default.createElement("button", {
      type: "button",
    ...
    connectedDisclosureMarkup = import_react51.default.createElement(Popover2, {
      active: disclosureActive,
      onClose: toggleDisclosureActive,
      activator: connectedDisclosureActivator,
      preferredAlignment: "right"
    }, import_react51.default.createElement(ActionList, {
  ...
  const buttonMarkup = import_react51.default.createElement(UnstyledButton, Object.assign({}, commonProps, linkProps, actionProps), import_react51.default.createElement("span", {
    className: styles3.Content
  }, spinnerSVGMarkup, iconMarkup, childMarkup, disclosureMarkup));
  return connectedDisclosureMarkup ? import_react51.default.createElement("div", {
...
function buttonFrom({
  ...
  return import_react52.default.createElement(Button, Object.assign({
    key,
    onClick: onAction
...
function ButtonGroup({
  ...
  const contents = elementChildren(children2).map((child, index) => import_react54.default.createElement(Item2, {
    button: child,
    key: index
  }));
...
// node_modules/@shopify/polaris/build/esm/components/Stack/Stack.js
var Stack = (0, import_react56.memo)(function Stack2({
  children: children2,
  vertical,
  spacing: spacing3,
  distribution,
...
function Heading({
  ...
  return import_react57.default.createElement(Element2, {
...
function Header({
  ...
  const actionMarkup = actions ? import_react58.default.createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
  const titleMarkup = (0, import_react58.isValidElement)(title) ? title : import_react58.default.createElement(Heading, null, title);
  const headingMarkup = actionMarkup || children2 ? import_react58.default.createElement(Stack, {
    alignment: "baseline"
  }, import_react58.default.createElement(Stack.Item, {
    fill: true
...
function Subheading({
  ...
  return import_react59.default.createElement(Element2, {
...
function Section3({
  ...
  const actionMarkup = actions ? import_react60.default.createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
  const titleMarkup = typeof title === "string" ? import_react60.default.createElement(Subheading, null, title) : title;
  const titleAreaMarkup = titleMarkup || actionMarkup ? import_react60.default.createElement("div", {
    className: styles2.SectionHeader
  }, actionMarkup ? import_react60.default.createElement(Stack, {
    alignment: "baseline"
  }, import_react60.default.createElement(Stack.Item, {
    fill: true
...
var Card = function Card2({
  ...
  const headerMarkup = title || actions ? import_react62.default.createElement(Header, {
    actions,
    title
  }) : null;
  const content = sectioned ? import_react62.default.createElement(Section3, null, children2) : children2;
  ...
  if (secondaryFooterActions && secondaryFooterActions.length) {
    if (secondaryFooterActions.length === 1) {
      ...
      secondaryFooterActionsMarkup = import_react62.default.createElement(import_react62.default.Fragment, null, import_react62.default.createElement(Popover2, {
        active: secondaryActionsPopoverOpen,
        activator: import_react62.default.createElement(Button, {
          disclosure: true,
      ...
      }, import_react62.default.createElement(ActionList, {
        items: secondaryFooterActions
      })));
    }
  }
  const footerMarkup = primaryFooterActionMarkup || secondaryFooterActionsMarkup ? import_react62.default.createElement("div", {
    className: classNames(styles2.Footer, footerActionAlignment === "left" && styles2.LeftJustified)
  }, footerActionAlignment === "right" ? import_react62.default.createElement(ButtonGroup, null, secondaryFooterActionsMarkup, primaryFooterActionMarkup) : import_react62.default.createElement(ButtonGroup, null, primaryFooterActionMarkup, secondaryFooterActionsMarkup)) : null;
  return import_react62.default.createElement(WithinContentContext.Provider, {
    value: true
...
function SettingAction({
  ...
  }, children2), import_react63.default.createElement("div", {
...
function Image({
  ...
  return import_react64.default.createElement("img", Object.assign({
    alt,
    src: source,
    crossOrigin,
    className,
...
function Avatar({
  ...
  const [status, setStatus] = (0, import_react65.useState)(Status.Pending);
  ...
  const imageMarkUp = source && isAfterInitialMount && status !== Status.Errored ? import_react65.default.createElement(Image, {
  ...
  const avatarBody = customer || !initials ? import_react65.default.createElement("path", {
    fill: "currentColor",
  ...
  const svgMarkup = hasImage ? null : import_react65.default.createElement("span", {
    className: styles19.Initials
  }, import_react65.default.createElement("svg", {
...
function AccountConnection({
  ...
  const avatarMarkup = connected ? import_react66.default.createElement(Avatar, {
    accessibilityLabel: "",
    name: accountName,
    initials,
    source: avatarUrl
  ...
  if (title) {
    titleMarkup = import_react66.default.createElement("div", null, title);
  } else if (accountName) {
    titleMarkup = import_react66.default.createElement("div", null, accountName);
  }
  const detailsMarkup = details ? import_react66.default.createElement("div", null, import_react66.default.createElement(TextStyle, {
    variation: "subdued"
  }, details)) : null;
  const termsOfServiceMarkup = termsOfService ? import_react66.default.createElement("div", {
    className: styles.TermsOfService
  }, termsOfService) : null;
  const actionElement = action ? buttonFrom(action, {
    primary: !connected
  }) : null;
  return import_react66.default.createElement(Card, {
    sectioned: true
  }, import_react66.default.createElement(SettingAction, {
    action: actionElement
  }, import_react66.default.createElement(Stack, null, avatarMarkup, import_react66.default.createElement(Stack.Item, {
    fill: true
...
function RollupActions({
  ...
  const activatorMarkup = import_react67.default.createElement("div", {
  ...
  return import_react67.default.createElement(Popover2, {
    active: rollupOpen,
    activator: activatorMarkup,
    preferredAlignment: "right",
    onClose: toggleRollupOpen,
    hideOnPrint: true
  }, import_react67.default.createElement(ActionList, {
    items,
    sections,
...
function TooltipOverlay({
  ...
  const i18n = useI18n();
  const markup = active ? import_react68.default.createElement(PositionedOverlay, {
    active,
    activator,
    preferredPosition,
    preventInteraction,
  ...
  function renderTooltip(overlayDetails) {
    ...
    return import_react68.default.createElement("div", Object.assign({
      className: containerClassName
    }, layer.props), import_react68.default.createElement("div", {
      id,
      role: "tooltip",
...
function Tooltip({
  ...
  const portal2 = activatorNode ? import_react69.default.createElement(Portal, {
    idPrefix: "tooltip"
  }, import_react69.default.createElement(TooltipOverlay, {
    id,
    preferredPosition,
    activator: activatorNode,
    active,
  ...
  return import_react69.default.createElement(WrapperComponent, {
    onFocus: handleFocus,
    onBlur: handleBlur,
...
function SecondaryAction({
  ...
  const buttonMarkup = import_react70.default.createElement(Button, Object.assign({
    onClick: onAction
  }, rest), children2);
  const actionMarkup = helpText ? import_react70.default.createElement(Tooltip, {
    content: helpText
...
function MenuGroup({
  ...
  const popoverActivator = import_react71.default.createElement(SecondaryAction, {
    disclosure: true,
    disabled,
    icon,
    accessibilityLabel,
  ...
  return import_react71.default.createElement(Popover2, {
    active: Boolean(active),
    activator: popoverActivator,
    preferredAlignment: "left",
    onClose: handleClose,
    hideOnPrint: true
  }, import_react71.default.createElement(ActionList, {
    items: actions,
    sections,
    onActionAnyItem: handleClose
  }), details && import_react71.default.createElement("div", {
...
function Actions({
  ...
  const actionsMarkup = actions.map((action) => {
    ...
    return import_react72.default.createElement(SecondaryAction, Object.assign({
      key: content,
      onClick: onAction
    }, rest, {
  ...
  const rollUppableActionsMarkup = measuredActions.showable.length > 0 ? measuredActions.showable.map((action) => action.content && import_react72.default.createElement(SecondaryAction, Object.assign({
    key: action.content
  }, action, {
    getOffsetWidth: handleActionsOffsetWidth
  }), action.content)) : null;
  ...
  const groupsMarkup = filteredGroups.map((group) => {
    ...
    if (!isDefaultGroup && !isLastMenuGroup) {
      return import_react72.default.createElement(MenuGroup, Object.assign({
        key: title,
        title,
  ...
  const groupedActionsMarkup = import_react72.default.createElement(ButtonGroup, {
    spacing: "extraTight"
  ...
  }, groupedActionsMarkup, import_react72.default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }));
}
...
function ActionMenu({
  ...
  }, rollup ? import_react73.default.createElement(RollupActions, {
    accessibilityLabel: rollupActionsLabel,
    items: actions,
    sections: rollupSections
  }) : import_react73.default.createElement(Actions, {
    actions,
    groups,
    onActionRollup
  }));
...
var ComboboxTextFieldContext = (0, import_react74.createContext)(void 0);
var ComboboxListboxContext = (0, import_react74.createContext)({});
var ComboboxListboxOptionContext = (0, import_react74.createContext)({});

// node_modules/@shopify/polaris/build/esm/utilities/combobox/hooks.js
function useComboboxTextField() {
  const context = (0, import_react75.useContext)(ComboboxTextFieldContext);
  if (!context) {
...
function useComboboxListbox() {
  const context = (0, import_react75.useContext)(ComboboxListboxContext);
  return context;
}
...
var ListboxContext = (0, import_react76.createContext)(void 0);
var WithinListboxContext = (0, import_react76.createContext)(false);
var ActionContext = (0, import_react76.createContext)(false);
...
function InlineError({
  ...
  }, import_react77.default.createElement(Icon, {
...
function Choice({
  ...
  const labelMarkup = import_react78.default.createElement("label", {
    className,
    htmlFor: id,
    onClick,
    onMouseOver,
  ...
  }, children2), import_react78.default.createElement("span", {
    className: styles31.Label
  }, label));
  const helpTextMarkup = helpText ? import_react78.default.createElement("div", {
    className: styles31.HelpText,
    id: helpTextID(id)
  }, helpText) : null;
  const errorMarkup = error && typeof error !== "boolean" && import_react78.default.createElement("div", {
    className: styles31.Error
  }, import_react78.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const descriptionMarkup = helpTextMarkup || errorMarkup ? import_react78.default.createElement("div", {
    className: styles31.Descriptions
  }, errorMarkup, helpTextMarkup) : null;
  return descriptionMarkup ? import_react78.default.createElement("div", null, labelMarkup, descriptionMarkup) : labelMarkup;
}
...
// node_modules/@shopify/polaris/build/esm/components/Checkbox/Checkbox.js
var Checkbox = (0, import_react79.forwardRef)(function Checkbox2({
  ariaControls,
  ...
  const inputNode = (0, import_react79.useRef)(null);
  ...
  const [keyFocused, setKeyFocused] = (0, import_react79.useState)(false);
  const isWithinListbox = (0, import_react79.useContext)(WithinListboxContext);
  ...
  return import_react79.default.createElement(Choice, {
    id,
    label,
    labelHidden,
    helpText,
  ...
  }, import_react79.default.createElement("input", Object.assign({
    ref: inputNode,
    id,
    name,
    value,
  ...
  }, indeterminateAttributes)), import_react79.default.createElement("span", {
    className: backdropClassName,
    onClick: stopPropagation,
    onKeyUp: stopPropagation
  }), import_react79.default.createElement("span", {
    className: styles30.Icon
  }, import_react79.default.createElement(Icon, {
    source: iconSource
  }))));
});
function noop4() {
...
// node_modules/@shopify/polaris/build/esm/components/Listbox/components/TextOption/TextOption.js
var TextOption = (0, import_react80.memo)(function TextOption2({
  children: children2,
  selected,
  disabled
}) {
  const {
    allowMultiple
  } = (0, import_react80.useContext)(ComboboxListboxOptionContext);
  const isAction = (0, import_react80.useContext)(ActionContext);
  ...
  }, allowMultiple && !isAction ? import_react80.default.createElement("div", {
    className: styles29.Checkbox
  }, import_react80.default.createElement(Checkbox, {
    disabled,
    checked: selected,
    label: children2
  })) : children2));
...
function useListbox() {
  const listbox = (0, import_react81.useContext)(ListboxContext);
  if (!listbox) {
...
// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Loading/Loading.js
var Loading = (0, import_react82.memo)(function LoadingOption({
  children: children2,
  ...
  return import_react82.default.createElement("li", {
    ...
    role: "presentation"
  }, children2 ? children2 : import_react82.default.createElement("div", {
    className: styles33.Loading
  }, import_react82.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: label
  })));
});
...
var SectionContext = (0, import_react83.createContext)(null);
...
function Section4({
  ...
  return import_react84.default.createElement(SectionContext.Provider, {
    value: sectionId
  }, import_react84.default.createElement("li", Object.assign({
    role: "presentation"
  }, listboxSectionDataSelector.props), title, import_react84.default.createElement("ul", {
    role: "group",
...
function useSection() {
  const context = (0, import_react85.useContext)(SectionContext);
  return context;
}
...
function Header2({
  ...
  const content = typeof children2 === "string" ? import_react86.default.createElement("div", {
...
var MappedActionContext = (0, import_react87.createContext)({});

// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Option/Option.js
var Option = (0, import_react88.memo)(function Option2({
  value,
  children: children2,
  selected,
  disabled = false,
  ...
  const isAction = (0, import_react88.useContext)(ActionContext);
  const {
    role,
    url,
    external,
    onAction,
    destructive
  } = (0, import_react88.useContext)(MappedActionContext);
  const listItemRef = (0, import_react88.useRef)(null);
  const domId = useUniqueId("ListboxOption");
  const sectionId = useSection();
  const isWithinSection = Boolean(sectionId);
  const handleOptionSelect = (0, import_react88.useCallback)((event) => {
    event.preventDefault();
    event.stopPropagation();
    onAction && onAction();
  ...
  const content = typeof children2 === "string" ? import_react88.default.createElement(TextOption, {
    selected,
    disabled
  }, children2) : children2;
  ...
  const contentMarkup = url ? import_react88.default.createElement(UnstyledLink, {
    url,
    external
  }, content) : content;
  return import_react88.default.createElement("li", Object.assign({}, sectionAttributes, {
...
function Action(props) {
  ...
  const iconMarkup = icon && import_react89.default.createElement("div", {
    className: styles36.Icon
  }, import_react89.default.createElement(Icon, {
    color: "subdued",
    source: icon
  }));
  const className = classNames(styles36.Action, divider && styles36.ActionDivider);
  return import_react89.default.createElement(ActionContext.Provider, {
    value: true
  }, import_react89.default.createElement(Option, props, import_react89.default.createElement("div", {
    className
  }, import_react89.default.createElement(TextOption, {
    selected,
    disabled
...
function Listbox({
  ...
  const [loading, setLoading] = (0, import_react90.useState)();
  const [activeOption, setActiveOption] = (0, import_react90.useState)();
  const [lazyLoading, setLazyLoading] = (0, import_react90.useState)(false);
  const [currentOptions, setCurrentOptions] = (0, import_react90.useState)([]);
  const {
  ...
  const scrollableRef = (0, import_react90.useRef)(null);
  const listboxRef = (0, import_react90.useRef)(null);
  const {
    listboxId,
    textFieldLabelId,
    textFieldFocused,
  ...
  const getNavigableOptions = (0, import_react90.useCallback)(() => {
    if (!listboxRef.current) {
      return [];
    }
    return [...new Set(listboxRef.current.querySelectorAll(OPTION_SELECTOR))];
  }, []);
  const getFirstNavigableOption = (0, import_react90.useCallback)((currentOptions2) => {
  ...
  const handleScrollIntoView = (0, import_react90.useCallback)((option) => {
    const {
      current: scrollable2
    } = scrollableRef;
    if (scrollable2) {
  ...
  const handleKeyToBottom = (0, import_react90.useCallback)(() => {
    if (onKeyToBottom) {
      setLazyLoading(true);
      return Promise.resolve(onKeyToBottom());
    }
  }, [onKeyToBottom]);
  const handleChangeActiveOption = (0, import_react90.useCallback)((nextOption) => {
    if (!nextOption)
  ...
  const getFormattedOption = (0, import_react90.useCallback)((element, index) => {
    return {
      element,
      index,
      domId: element.id,
  ...
  const resetActiveOption = (0, import_react90.useCallback)(() => {
  ...
  (0, import_react90.useEffect)(() => {
    if (autoSelection !== AutoSelection.None && !loading && children2 && import_react90.Children.count(children2) > 0) {
      resetActiveOption();
    }
  ...
  const onOptionSelect = (0, import_react90.useCallback)((option) => {
  ...
  const getNextIndex = (0, import_react90.useCallback)((currentIndex, lastIndex, direction) => {
    let nextIndex;
    if (direction === "down") {
  ...
  const getNextValidOption = (0, import_react90.useCallback)(async (key) => {
  ...
  const handleArrow = (0, import_react90.useCallback)(async (type, event) => {
    event.preventDefault();
    const {
      element,
      nextIndex
  ...
  const handleDownArrow = (0, import_react90.useCallback)((event) => {
    handleArrow("down", event);
  }, [handleArrow]);
  const handleUpArrow = (0, import_react90.useCallback)((event) => {
    handleArrow("up", event);
  }, [handleArrow]);
  const handleEnter = (0, import_react90.useCallback)((event) => {
    event.preventDefault();
    event.stopPropagation();
    if (activeOption) {
  ...
  const handleFocus = (0, import_react90.useCallback)(() => {
    if (enableKeyboardControl)
      return;
    enableKeyboardEvents();
  }, [enableKeyboardControl, enableKeyboardEvents]);
  const handleBlur = (0, import_react90.useCallback)((event) => {
    event.stopPropagation();
  ...
  const listeners = keyboardEventsEnabled || textFieldFocused ? import_react90.default.createElement(import_react90.default.Fragment, null, import_react90.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleDownArrow
  }), import_react90.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
  ...
  const listboxContext = (0, import_react90.useMemo)(() => ({
    onOptionSelect,
    setLoading
  }), [onOptionSelect]);
  return import_react90.default.createElement(import_react90.default.Fragment, null, listeners, import_react90.default.createElement(VisuallyHidden, null, import_react90.default.createElement("div", {
    "aria-live": "polite"
  }, loading ? loading : null)), import_react90.default.createElement(ListboxContext.Provider, {
    value: listboxContext
  }, import_react90.default.createElement(WithinListboxContext.Provider, {
    value: true
  }, children2 ? import_react90.default.createElement("ul", {
    tabIndex: 0,
    role: "listbox",
...
// node_modules/@shopify/polaris/build/esm/components/Autocomplete/components/MappedOption/MappedOption.js
var MappedOption = (0, import_react91.memo)(function MappedOption2({
  label,
  value,
  disabled,
  media,
  ...
  const mediaMarkup = media ? import_react91.default.createElement("div", {
    className: mediaClassNames
  }, media) : null;
  const accessibilityLabel = typeof label === "string" ? label : void 0;
  return import_react91.default.createElement(Listbox.Option, {
    accessibilityLabel,
    key: value,
    selected,
    value,
    disabled
  }, import_react91.default.createElement(Listbox.TextOption, {
    selected,
    disabled
...
var Spinner2 = import_react92.default.forwardRef(function Spinner3({
  onChange,
  onClick,
  onMouseDown,
  onMouseUp
...
function Label({
  ...
  return import_react93.default.createElement("div", {
    className
  }, import_react93.default.createElement("label", {
    id: labelID(id),
    htmlFor: id,
...
function Labelled({
  ...
  const actionMarkup = action ? import_react94.default.createElement("div", {
    className: styles40.Action
  }, buttonFrom(action, {
    plain: true
  })) : null;
  const helpTextMarkup = helpText ? import_react94.default.createElement("div", {
    className: styles40.HelpText,
    id: helpTextID2(id)
  }, helpText) : null;
  const errorMarkup = error && typeof error !== "boolean" && import_react94.default.createElement("div", {
    className: styles40.Error
  }, import_react94.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const labelMarkup = label ? import_react94.default.createElement("div", {
    className: styles40.LabelWrapper
  }, import_react94.default.createElement(Label, Object.assign({
    id,
    requiredIndicator
  }, rest, {
    hidden: false
...
function Connected({
  ...
  const leftConnectionMarkup = left ? import_react96.default.createElement(Item4, {
    position: "left"
  }, left) : null;
  const rightConnectionMarkup = right ? import_react96.default.createElement(Item4, {
    position: "right"
  }, right) : null;
  return import_react96.default.createElement("div", {
    className: styles42.Connected
  }, leftConnectionMarkup, import_react96.default.createElement(Item4, {
    position: "primary"
...
function Resizer({
  ...
  const contentNode = (0, import_react97.useRef)(null);
  const minimumLinesNode = (0, import_react97.useRef)(null);
  const animationFrame = (0, import_react97.useRef)();
  const currentHeight = (0, import_react97.useRef)(currentHeightProp);
  ...
  const minimumLinesMarkup = minimumLines ? import_react97.default.createElement("div", {
  ...
  const handleHeightCheck = (0, import_react97.useCallback)(() => {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
  ...
  }, import_react97.default.createElement(EventListener, {
    event: "resize",
...
function TextField({
  ...
  const i18n = useI18n();
  const [height, setHeight] = (0, import_react98.useState)(null);
  const [focus, setFocus] = (0, import_react98.useState)(Boolean(focused));
  ...
  const verticalContentRef = (0, import_react98.useRef)(null);
  const buttonPressTimer = (0, import_react98.useRef)();
  const spinnerRef = (0, import_react98.useRef)(null);
  ...
  const prefixMarkup = prefix ? import_react98.default.createElement("div", {
    className: styles39.Prefix,
    id: `${id}-Prefix`,
    ref: prefixRef
  }, prefix) : null;
  const suffixMarkup = suffix ? import_react98.default.createElement("div", {
  ...
  if (showCharacterCount) {
    ...
    characterCountMarkup = import_react98.default.createElement("div", {
  ...
  const clearButtonMarkup = clearButton && clearButtonVisible ? import_react98.default.createElement("button", {
    type: "button",
    className: styles39.ClearButton,
    onClick: handleClearButtonPress,
    disabled
  }, import_react98.default.createElement(VisuallyHidden, null, i18n.translate("Polaris.Common.clear")), import_react98.default.createElement(Icon, {
    source: SvgCircleCancelMinor,
    color: "base"
  })) : null;
  const handleNumberChange = (0, import_react98.useCallback)((steps) => {
    if (onChange == null) {
      return;
    }
  ...
  const handleButtonRelease = (0, import_react98.useCallback)(() => {
    clearTimeout(buttonPressTimer.current);
  }, []);
  const handleButtonPress = (0, import_react98.useCallback)((onChange2) => {
  ...
  const spinnerMarkup = type === "number" && step !== 0 && !disabled && !readOnly ? import_react98.default.createElement(Spinner2, {
    onClick: handleClickChild,
  ...
  const handleExpandingResize = (0, import_react98.useCallback)((height2) => {
    setHeight(height2);
  }, []);
  const resizer = multiline && isAfterInitial ? import_react98.default.createElement(Resizer, {
  ...
  const input = (0, import_react98.createElement)(multiline ? "textarea" : "input", {
    name,
    id,
    disabled,
    readOnly,
  ...
  const inputWithVerticalContentMarkup = verticalContent ? import_react98.default.createElement("div", {
  ...
  const backdropMarkup = import_react98.default.createElement("div", {
  ...
  return import_react98.default.createElement(Labelled, {
    label,
    id,
    error,
    action: labelAction,
    ...
    helpText,
    requiredIndicator
  }, import_react98.default.createElement(Connected, {
    left: connectedLeft,
...
function TextField2({
  ...
  const textFieldId = (0, import_react99.useMemo)(() => idProp || uniqueId, [uniqueId, idProp]);
  const labelId = (0, import_react99.useMemo)(() => labelID(idProp || uniqueId), [uniqueId, idProp]);
  (0, import_react99.useEffect)(() => {
    if (setTextFieldLabelId)
      setTextFieldLabelId(labelId);
  }, [labelId, setTextFieldLabelId]);
  const handleFocus = (0, import_react99.useCallback)((event) => {
    if (onFocus)
      onFocus(event);
    if (onTextFieldFocus)
      onTextFieldFocus();
  ...
  const handleBlur = (0, import_react99.useCallback)((event) => {
    if (onBlur)
      onBlur(event);
    if (onTextFieldBlur)
      onTextFieldBlur();
  ...
  const handleChange = (0, import_react99.useCallback)((value2, id) => {
    if (onChange)
      onChange(value2, id);
    if (onTextFieldChange)
      onTextFieldChange(value2);
  }, [onChange, onTextFieldChange]);
  return import_react99.default.createElement(TextField, Object.assign({}, rest, {
    value,
    id: textFieldId,
    type,
    ariaAutocomplete,
...
function Combobox({
  ...
  const [popoverActive, setPopoverActive] = (0, import_react100.useState)(false);
  const [activeOptionId, setActiveOptionId] = (0, import_react100.useState)();
  const [textFieldLabelId, setTextFieldLabelId] = (0, import_react100.useState)();
  const [listboxId, setListboxId] = (0, import_react100.useState)();
  const [textFieldFocused, setTextFieldFocused] = (0, import_react100.useState)(false);
  const shouldOpen = Boolean(!popoverActive && import_react100.Children.count(children2) > 0);
  const ref = (0, import_react100.useRef)(null);
  const handleClose = (0, import_react100.useCallback)(() => {
    setPopoverActive(false);
    onClose === null || onClose === void 0 ? void 0 : onClose();
    setActiveOptionId(void 0);
  }, [onClose]);
  const handleOpen = (0, import_react100.useCallback)(() => {
    setPopoverActive(true);
    setActiveOptionId(void 0);
  }, []);
  const onOptionSelected = (0, import_react100.useCallback)(() => {
    var _ref$current;
    if (!allowMultiple) {
      handleClose();
      setActiveOptionId(void 0);
  ...
  const handleBlur = (0, import_react100.useCallback)(() => {
    if (popoverActive) {
      handleClose();
    }
  }, [popoverActive, handleClose]);
  const textFieldContextValue = (0, import_react100.useMemo)(() => ({
    activeOptionId,
  ...
  const listboxOptionContextValue = (0, import_react100.useMemo)(() => ({
    allowMultiple
  }), [allowMultiple]);
  const listboxContextValue = (0, import_react100.useMemo)(() => ({
    listboxId,
    textFieldLabelId,
    textFieldFocused,
    willLoadMoreOptions,
  ...
  return import_react100.default.createElement(Popover2, {
    ref,
    active: popoverActive,
    activator: import_react100.default.createElement(ComboboxTextFieldContext.Provider, {
    ...
    preferredPosition,
    onClose: handleClose
  }, import_react100.Children.count(children2) > 0 ? import_react100.default.createElement(Popover2.Pane, {
    onScrolledToBottom,
    height
  }, import_react100.default.createElement(ComboboxListboxContext.Provider, {
    value: listboxContextValue
  }, import_react100.default.createElement(ComboboxListboxOptionContext.Provider, {
...
function MappedAction({
  ...
  if (prefix) {
    prefixMarkup = import_react101.default.createElement("div", {
  ...
  const badgeMarkup = badge && import_react101.default.createElement("span", {
    className: styles43.Suffix
  }, import_react101.default.createElement(Badge, {
    status: badge.status
  }, badge.content));
  const suffixMarkup = suffix && import_react101.default.createElement("span", {
    className: styles43.Suffix
  }, suffix);
  const contentText = ellipsis && content ? i18n.translate("Polaris.Autocomplete.ellipsis", {
    content
  }) : content;
  const contentMarkup = import_react101.default.createElement("div", {
    className: styles43.Text
  }, import_react101.default.createElement("div", {
    className: contentOverflowStyle
  }, contentText), helpText ? import_react101.default.createElement(TextStyle, {
    variation: "subdued"
  }, helpText) : null);
  ...
  return import_react101.default.createElement(MappedActionContext.Provider, {
    value: context
  }, import_react101.default.createElement("div", {
    className: styles43.ActionContainer
  }, import_react101.default.createElement(Listbox.Action, {
    selected: active,
    disabled,
    value: content || ""
  }, import_react101.default.createElement("div", {
...
var Autocomplete = function Autocomplete2({
  ...
  const i18n = useI18n();
  const buildMappedOptionFromOption = (0, import_react102.useCallback)((options2) => {
    return options2.map((option) => import_react102.default.createElement(MappedOption, Object.assign({
  ...
  const optionsMarkup = (0, import_react102.useMemo)(() => {
    ...
    if (isSection(conditionalOptions)) {
      ...
      const optionsMarkup2 = conditionalOptions.map(({
        ...
        return import_react102.default.createElement(Listbox.Section, {
          divider: false,
          title: import_react102.default.createElement(Listbox.Header, null, title),
          key: title
        }, optionMarkup);
      });
    ...
    if (listTitle) {
      return import_react102.default.createElement(Listbox.Section, {
        divider: false,
        title: import_react102.default.createElement(Listbox.Header, null, listTitle)
      }, optionList);
    }
    return optionList;
  }, [listTitle, loading, options, willLoadMoreResults, buildMappedOptionFromOption]);
  const loadingMarkup = loading ? import_react102.default.createElement(Listbox.Loading, {
    accessibilityLabel: i18n.translate("Polaris.Autocomplete.spinnerAccessibilityLabel")
  }) : null;
  const updateSelection = (0, import_react102.useCallback)((newSelection) => {
  ...
  const actionMarkup = actionBefore && import_react102.default.createElement(MappedAction, actionBefore);
  const emptyStateMarkup = emptyState && options.length < 1 && !loading && import_react102.default.createElement("div", {
    role: "status"
  }, emptyState);
  const autoSelection = actionBefore ? AutoSelection.First : void 0;
  return import_react102.default.createElement(Combobox, {
    activator: textField,
    allowMultiple,
    onScrolledToBottom: onLoadMoreResults,
    preferredPosition,
    willLoadMoreOptions: willLoadMoreResults
  }, actionMarkup || optionsMarkup || loadingMarkup || emptyStateMarkup ? import_react102.default.createElement(Listbox, {
    autoSelection,
...
function Backdrop(props) {
  ...
  return import_react105.default.createElement(import_react105.default.Fragment, null, import_react105.default.createElement(ScrollLock, null), import_react105.default.createElement("div", {
    className,
    onClick,
    onTouchStart
  }));
...
var BannerContext = (0, import_react106.createContext)(false);
...
function unstyledButtonFrom({
  ...
  return import_react107.default.createElement(UnstyledButton, Object.assign({
    key,
    onClick: onAction
  }, action, overrides), content);
}
...
// node_modules/@shopify/polaris/build/esm/components/Banner/Banner.js
var Banner = (0, import_react108.forwardRef)(function Banner2({
  icon,
  action,
  secondaryAction,
  title,
  ...
  const withinContentContainer = (0, import_react108.useContext)(WithinContentContext);
  ...
  if (title) {
    ...
    headingMarkup = import_react108.default.createElement("div", {
      className: styles45.Heading,
      id: headingID
    }, import_react108.default.createElement(Heading, {
      element: "p"
    }, title));
  }
  const spinnerMarkup = action !== null && action !== void 0 && action.loading ? import_react108.default.createElement("button", {
    disabled: true,
    "aria-busy": true,
  ...
  }, import_react108.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: i18n.translate("Polaris.Button.spinnerAccessibilityLabel")
  })), action.content) : null;
  const primaryActionMarkup = action ? import_react108.default.createElement("div", {
    className: styles45.PrimaryAction
  }, action.loading ? spinnerMarkup : unstyledButtonFrom(action, {
    className: styles45.Button
  })) : null;
  const secondaryActionMarkup = secondaryAction ? import_react108.default.createElement(SecondaryActionFrom, {
    action: secondaryAction
  }) : null;
  const actionMarkup = action || secondaryAction ? import_react108.default.createElement("div", {
    className: styles45.Actions
  }, import_react108.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup)) : null;
  let contentMarkup = null;
  let contentID;
  if (children2 || actionMarkup) {
    contentID = `${id}Content`;
    contentMarkup = import_react108.default.createElement("div", {
      className: styles45.Content,
      id: contentID
    }, children2, actionMarkup);
  }
  const dismissButton = onDismiss && import_react108.default.createElement("div", {
    className: styles45.Dismiss
  }, import_react108.default.createElement(Button, {
    plain: true,
    icon: SvgCancelSmallMinor,
    onClick: onDismiss,
    accessibilityLabel: "Dismiss notification"
  }));
  return import_react108.default.createElement(BannerContext.Provider, {
    value: true
  ...
  }, dismissButton, import_react108.default.createElement("div", {
    className: styles45.Ribbon
  }, import_react108.default.createElement(Icon, {
    source: iconName,
    color: iconColor
  })), import_react108.default.createElement("div", {
...
function SecondaryActionFrom({
  ...
  if (action.url) {
    return import_react108.default.createElement(UnstyledLink, {
  ...
  return import_react108.default.createElement(UnstyledButton, {
    className: styles45.SecondaryAction,
...
function useBannerFocus(bannerRef) {
  ...
  const [shouldShowFocus, setShouldShowFocus] = (0, import_react108.useState)(false);
  (0, import_react108.useImperativeHandle)(bannerRef, () => ({
    focus: () => {
...
function Breadcrumbs({
  ...
  const contentMarkup = import_react109.default.createElement(import_react109.default.Fragment, null, import_react109.default.createElement("span", {
    className: styles46.Icon
  }, import_react109.default.createElement(Icon, {
    source: SvgArrowLeftMinor
  })), import_react109.default.createElement(VisuallyHidden, null, content));
  const breadcrumbMarkup = "url" in breadcrumb ? import_react109.default.createElement(UnstyledLink, {
    key: content,
    url: breadcrumb.url,
    className: styles46.Breadcrumb,
    onMouseUp: handleMouseUpByBlurring,
    "aria-label": breadcrumb.accessibilityLabel
  }, contentMarkup) : import_react109.default.createElement("button", {
    key: content,
    className: styles46.Breadcrumb,
  ...
  return import_react109.default.createElement("nav", {
    role: "navigation"
  }, breadcrumbMarkup);
}
...
var TransitionGroupContext_default = import_react110.default.createContext(null);
...
var Transition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react111.default.createElement(TransitionGroupContext_default.Provider, {
      value: null
    }, typeof children2 === "function" ? children2(status, childProps) : import_react111.default.cloneElement(import_react111.default.Children.only(children2), childProps));
  };
  return Transition2;
...
var CSSTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react112.default.createElement(Transition_default, _extends({}, props, {
...
function getChildMapping(children2, mapFn) {
  var mapper = function mapper2(child) {
    return mapFn && (0, import_react113.isValidElement)(child) ? mapFn(child) : child;
  };
  var result = /* @__PURE__ */ Object.create(null);
  if (children2)
    import_react113.Children.map(children2, function(c) {
      return c;
...
function getInitialChildMapping(props, onExited) {
  return getChildMapping(props.children, function(child) {
    return (0, import_react113.cloneElement)(child, {
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach(function(key) {
    ...
    if (!(0, import_react113.isValidElement)(child))
      return;
    var hasPrev = key in prevChildMapping;
    var hasNext = key in nextChildMapping;
    var prevChild = prevChildMapping[key];
    var isLeaving = (0, import_react113.isValidElement)(prevChild) && !prevChild.props.in;
    if (hasNext && (!hasPrev || isLeaving)) {
      children2[key] = (0, import_react113.cloneElement)(child, {
        onExited: onExited.bind(null, child),
        in: true,
    ...
    } else if (hasNext && hasPrev && (0, import_react113.isValidElement)(prevChild)) {
      children2[key] = (0, import_react113.cloneElement)(child, {
        onExited: onExited.bind(null, child),
...
var TransitionGroup = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    delete props.exit;
    if (Component9 === null) {
      return import_react114.default.createElement(TransitionGroupContext_default.Provider, {
        value: contextValue
      }, children2);
    }
    return import_react114.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, import_react114.default.createElement(Component9, props, children2));
  };
...
var ReplaceTransition = function(_React$Component) {
  ...
  _proto.handleLifecycle = function handleLifecycle(handler, idx, originalArgs) {
    ...
    var child = import_react115.default.Children.toArray(children2)[idx];
  ...
  _proto.render = function render() {
    ...
    var _React$Children$toArr = import_react115.default.Children.toArray(children2), first = _React$Children$toArr[0], second = _React$Children$toArr[1];
    ...
    return import_react115.default.createElement(TransitionGroup_default, props, inProp ? import_react115.default.cloneElement(first, {
      key: "first",
      onEnter: this.handleEnter,
      onEntering: this.handleEntering,
      onEntered: this.handleEntered
    }) : import_react115.default.cloneElement(second, {
      key: "second",
...
ReplaceTransition.propTypes = true ? {
  ...
  children: function children(props, propName) {
    if (import_react115.default.Children.count(props[propName]) !== 2)
...
function areChildrenDifferent(oldChildren, newChildren) {
  if (oldChildren === newChildren)
    return false;
  if (import_react116.default.isValidElement(oldChildren) && import_react116.default.isValidElement(newChildren) && oldChildren.key != null && oldChildren.key === newChildren.key) {
    return false;
  }
  return true;
}
...
var leaveRenders = (_leaveRenders = {}, _leaveRenders[modes.out] = function(_ref) {
  ...
  return import_react116.default.cloneElement(current, {
    in: false,
  ...
  return [current, import_react116.default.cloneElement(children2, {
    in: true,
...
var enterRenders = (_enterRenders = {}, _enterRenders[modes.out] = function(_ref3) {
  ...
  return import_react116.default.cloneElement(children2, {
    in: true,
    onEntered: callHook(children2, "onEntered", function() {
      changeState(ENTERED, import_react116.default.cloneElement(children2, {
        in: true
      }));
    })
  });
  ...
  }), import_react116.default.cloneElement(children2, {
    in: true
  })];
}, _enterRenders);
var SwitchTransition = function(_React$Component) {
  ...
  SwitchTransition2.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    return {
      current: import_react116.default.cloneElement(props.children, {
        in: true
      })
    };
  };
  _proto.render = function render() {
    ...
    return import_react116.default.createElement(TransitionGroupContext_default.Provider, {
      value: {
...
function useComponentDidMount(callback) {
  const isAfterInitialMount = useIsAfterInitialMount();
  const hasInvokedLifeCycle = (0, import_react117.useRef)(false);
...
function BulkActionButton({
  ...
  return import_react119.default.createElement("div", {
  ...
  }, import_react119.default.createElement(Button, {
    external,
    url,
    "aria-label": accessibilityLabel,
    onClick: onAction,
    disabled,
    disclosure
  }, content), indicator && import_react119.default.createElement(Indicator, null));
}
...
var ResourceListContext = (0, import_react121.createContext)({});
...
function CheckableButton({
  ...
  const checkBoxRef = (0, import_react122.useRef)(null);
  const {
    registerCheckableButtons
  } = (0, import_react122.useContext)(ResourceListContext);
  ...
  return import_react122.default.createElement("div", {
  ...
  }, import_react122.default.createElement(Checkbox, {
    label: accessibilityLabel,
    labelHidden: true,
    checked: selected,
    disabled,
    ...
    ref: checkBoxRef
  })), import_react122.default.createElement("span", {
...
var BulkActionsInner = class extends import_react123.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.checkableWrapperNode = (0, import_react123.createRef)();
    this.largeScreenGroupNode = (0, import_react123.createRef)();
    this.smallScreenGroupNode = (0, import_react123.createRef)();
  ...
  render() {
    ...
    const paginatedSelectAllActionMarkup = paginatedSelectAllAction ? import_react123.default.createElement(Button, {
      onClick: paginatedSelectAllAction.onAction,
      plain: true,
      disabled
    }, paginatedSelectAllAction.content) : null;
    const paginatedSelectAllTextMarkup = paginatedSelectAllText && paginatedSelectAllAction ? import_react123.default.createElement("span", {
      "aria-live": "polite"
    }, paginatedSelectAllText) : paginatedSelectAllText;
    const paginatedSelectAllMarkup = paginatedSelectAllActionMarkup || paginatedSelectAllTextMarkup ? import_react123.default.createElement("div", {
      className: styles47.PaginatedSelectAll
    }, paginatedSelectAllTextMarkup, " ", paginatedSelectAllActionMarkup) : null;
    const cancelButton = import_react123.default.createElement(Button, {
      onClick: this.setSelectMode.bind(this, false),
      disabled
    }, i18n.translate("Polaris.Common.cancel"));
    const numberOfPromotedActionsToRender = this.numberOfPromotedActionsToRender();
    const allActionsPopover = this.hasActions() ? import_react123.default.createElement("div", {
      className: styles47.Popover,
      ref: this.setMoreActionsNode
    }, import_react123.default.createElement(Popover2, {
      active: smallScreenPopoverVisible,
      activator: import_react123.default.createElement(BulkActionButton, {
        disclosure: true,
    ...
    const actionsPopover = actionSections || rolledInPromotedActions.length > 0 || measuring ? import_react123.default.createElement("div", {
      className: styles47.Popover,
      ref: this.setMoreActionsNode
    }, import_react123.default.createElement(Popover2, {
    ...
    const smallScreenGroup = smallScreen ? import_react123.default.createElement(Transition_default, {
      timeout: 0,
      in: selectMode,
      key: "smallGroup",
      ...
      }, import_react123.default.createElement(ButtonGroup, {
        segmented: true
      }, import_react123.default.createElement(CSSTransition_default, {
      ...
      }, import_react123.default.createElement(CheckableButton, Object.assign({}, checkableButtonProps, {
        smallScreen: true
      })))), allActionsPopover, cancelButton)), paginatedSelectAllMarkup);
    }) : null;
    const largeGroupContent = promotedActionsMarkup || actionsPopover ? import_react123.default.createElement(ButtonGroup, {
      segmented: true
    }, import_react123.default.createElement(CheckableButton, checkableButtonProps), promotedActionsMarkup, actionsPopover) : import_react123.default.createElement(CheckableButton, checkableButtonProps);
    const largeScreenGroup = smallScreen ? null : import_react123.default.createElement(Transition_default, {
      timeout: 0,
      in: selectMode,
      key: "largeGroup",
      ...
      }, import_react123.default.createElement(EventListener, {
        event: "resize",
...
function BulkActions(props) {
  const i18n = useI18n();
  return import_react123.default.createElement(BulkActionsInner, Object.assign({}, props, {
    i18n
  }));
}
...
function CalloutCard({
  ...
  const buttonMarkup = secondaryActionMarkup ? import_react125.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup) : primaryActionMarkup;
  const dismissButton = onDismiss ? import_react125.default.createElement("div", {
  ...
  return import_react125.default.createElement(Card, null, import_react125.default.createElement("div", {
    className: containerClassName
  }, dismissButton, import_react125.default.createElement(Card.Section, null, import_react125.default.createElement("div", {
  ...
  }, import_react125.default.createElement(Heading, null, title)), import_react125.default.createElement(TextContainer, null, children2), import_react125.default.createElement("div", {
    className: styles50.Buttons
  }, buttonMarkup)), import_react125.default.createElement(Image, {
    alt: "",
    className: imageClassName,
    source: illustration
  })))));
...
function Caption({
  ...
  return import_react126.default.createElement("p", {
...
function RadioButton({
  ...
  const [keyFocused, setKeyFocused] = (0, import_react127.useState)(false);
  const {
    value: mouseOver,
    setTrue: handleMouseOver,
    setFalse: handleMouseOut
  ...
  return import_react127.default.createElement(Choice, {
    label,
    labelHidden,
    disabled,
    id,
    ...
    onMouseOver: handleMouseOver,
    onMouseOut: handleMouseOut
  }, import_react127.default.createElement("span", {
    className: styles54.RadioButton
  }, import_react127.default.createElement("input", {
    id,
    name,
    value,
    type: "radio",
...
function ChoiceList({
  ...
  const titleMarkup = title ? import_react128.default.createElement("legend", {
  ...
  const choicesMarkup = choices.map((choice) => {
    ...
    const children2 = renderedChildren ? import_react128.default.createElement("div", {
      className: styles53.ChoiceChildren
    }, renderedChildren) : null;
    return import_react128.default.createElement("li", {
      key: value,
      className: styles53.ChoiceItem
    }, import_react128.default.createElement(ControlComponent, {
      name: finalName,
      value,
      id,
      label,
  ...
  const errorMarkup = error && import_react128.default.createElement("div", {
    className: styles53.ChoiceError
  }, import_react128.default.createElement(InlineError, {
    message: error,
    fieldID: finalName
  }));
  return import_react128.default.createElement("fieldset", {
    className,
    id: finalName,
    "aria-invalid": error != null
  }, titleMarkup, import_react128.default.createElement("ul", {
...
function Collapsible({
  ...
  const [height, setHeight] = (0, import_react129.useState)(0);
  const [isOpen, setIsOpen] = (0, import_react129.useState)(open);
  const [animationState, setAnimationState] = (0, import_react129.useState)("idle");
  const collapsibleContainer = (0, import_react129.useRef)(null);
  ...
  const handleCompleteAnimation = (0, import_react129.useCallback)(({
    target
  }) => {
...
var Slidable = class extends import_react130.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      dragging: false
  ...
  render() {
    ...
    const moveListener = dragging ? import_react130.default.createElement(EventListener, {
      event: "mousemove",
      handler: this.handleMove,
      passive: false
    }) : null;
    const touchMoveListener = dragging ? import_react130.default.createElement(EventListener, {
      event: "touchmove",
      handler: this.handleMove,
      passive: false
    }) : null;
    const endDragListener = dragging ? import_react130.default.createElement(EventListener, {
      event: "mouseup",
      handler: this.handleDragEnd
    }) : null;
    const touchEndListener = dragging ? import_react130.default.createElement(EventListener, {
      event: "touchend",
      handler: this.handleDragEnd
    }) : null;
    const touchCancelListener = dragging ? import_react130.default.createElement(EventListener, {
      event: "touchcancel",
      handler: this.handleDragEnd
    }) : null;
    ...
    }, endDragListener, moveListener, touchMoveListener, touchEndListener, touchCancelListener, import_react130.default.createElement("div", {
...
// node_modules/@shopify/polaris/build/esm/components/ColorPicker/components/AlphaPicker/AlphaPicker.js
var AlphaPicker = class extends import_react131.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      sliderHeight: 0,
  ...
  render() {
    ...
    }), import_react131.default.createElement(Slidable, {
      draggerY,
      draggerX: 0,
...
// node_modules/@shopify/polaris/build/esm/components/ColorPicker/components/HuePicker/HuePicker.js
var HuePicker = class extends import_react132.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      sliderHeight: 0,
  ...
  render() {
    ...
    return import_react132.default.createElement("div", {
      ...
      ref: this.setSliderHeight
    }, import_react132.default.createElement(Slidable, {
      draggerY,
      draggerX: 0,
      onChange: this.handleChange,
      onDraggerHeight: this.setDraggerHeight
...
var ColorPicker = class extends import_react133.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      pickerSize: {
  ...
  render() {
    ...
    const alphaSliderMarkup = allowAlpha ? import_react133.default.createElement(AlphaPicker, {
      alpha,
      color,
    ...
    }), import_react133.default.createElement(Slidable, {
      onChange: this.handleDraggerMove,
      draggerX,
      draggerY
    })), import_react133.default.createElement(HuePicker, {
      hue,
      onChange: this.handleHueChange
    }), alphaSliderMarkup, import_react133.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    }));
  }
...
var FrameContext = (0, import_react134.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/frame/hooks.js
function useFrame() {
  const frame = (0, import_react135.useContext)(FrameContext);
  if (!frame) {
...
// node_modules/@shopify/polaris/build/esm/components/ContextualSaveBar/ContextualSaveBar.js
var ContextualSaveBar = (0, import_react136.memo)(function ContextualSaveBar2({
  message,
  saveAction,
  discardAction,
  alignContentFlush,
...
function Cell({
  ...
  const iconMarkup = import_react137.default.createElement("span", {
    className: iconClassName
  }, import_react137.default.createElement(Icon, {
    source,
    accessibilityLabel: sortAccessibilityLabel
  }));
  const focusable = !(stickyHeadingCell && hasFixedNthColumn && nthColumn && !inFixedNthColumn);
  const sortableHeadingContent = import_react137.default.createElement("button", {
  ...
  const stickyHeading = import_react137.default.createElement("th", Object.assign({
    ref: setRef
  ...
  const headingMarkup = header ? import_react137.default.createElement("th", Object.assign({}, headerCell.props, {
    "aria-sort": sortDirection
  }, colSpanProp, {
    ref: setRef,
    className,
  ...
  }), columnHeadingContent) : import_react137.default.createElement("th", Object.assign({}, colSpanProp, {
    ref: setRef,
    className,
    scope: "row",
    style: {
  ...
  }), truncate ? import_react137.default.createElement(TruncatedText, {
    className: styles57.TooltipContent
  }, content) : content);
  const cellMarkup = header || firstColumn || nthColumn ? headingMarkup : import_react137.default.createElement("td", Object.assign({
    className
  }, colSpanProp), content);
...
var TruncatedText = ({
  ...
  const textRef = (0, import_react137.useRef)(null);
  const {
    current
  } = textRef;
  const text = import_react137.default.createElement("span", {
    ref: textRef,
    className
  }, children2);
  return (current === null || current === void 0 ? void 0 : current.scrollWidth) > (current === null || current === void 0 ? void 0 : current.offsetWidth) ? import_react137.default.createElement(Tooltip, {
...
function AfterInitialMount({
  ...
  return import_react138.default.createElement(import_react138.default.Fragment, null, content);
}
...
function useStickyManager() {
  const stickyManager = (0, import_react139.useContext)(StickyManagerContext);
  if (!stickyManager) {
...
// node_modules/@shopify/polaris/build/esm/components/Sticky/Sticky.js
var StickyInner = class extends import_react140.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      isSticky: false,
  ...
  render() {
    ...
    return import_react140.default.createElement("div", null, import_react140.default.createElement("div", {
...
function Sticky(props) {
  ...
  return import_react140.default.createElement(StickyInner, Object.assign({}, props, {
    stickyManager
  }));
}
...
function Navigation({
  ...
  return import_react141.default.createElement("div", {
    ...
    ref: setRef
  }, import_react141.default.createElement(Button, {
    plain: true,
    icon: SvgChevronLeftMinor,
    disabled: isScrolledFarthestLeft,
    accessibilityLabel: leftA11yLabel,
    onClick: navigateTableLeft
  }), pipMarkup, import_react141.default.createElement(Button, {
    plain: true,
...
var DataTableInner = class extends import_react142.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      condensed: false,
    ...
    this.dataTable = (0, import_react142.createRef)();
    this.scrollContainer = (0, import_react142.createRef)();
    this.table = (0, import_react142.createRef)();
    this.stickyTable = (0, import_react142.createRef)();
    this.stickyNav = null;
    this.headerNav = null;
    this.tableHeadings = [];
    this.stickyHeadings = [];
    ...
    this.renderHeading = ({
      ...
      if (inFixedNthColumn && inStickyHeader) {
        ...
        return [import_react142.default.createElement(Cell, Object.assign({
          key: id
        }, cellProps, {
          setRef: (ref) => {
            this.setCellRef({
        ...
        })), import_react142.default.createElement(Cell, Object.assign({
          key: `${id}-sticky`
        }, cellProps, {
          setRef: (ref) => {
            this.setCellRef({
    ...
    this.renderTotals = ({
      ...
      return import_react142.default.createElement(Cell, {
        total: true,
        totalInFooter,
    ...
    this.defaultRenderRow = ({
      ...
      return import_react142.default.createElement("tr", {
        key: `row-${index}`,
        className,
  ...
  render() {
    ...
    const headingMarkup = import_react142.default.createElement("tr", null, headings.map((heading, index) => this.renderHeading({
      heading,
      headingIndex: index,
      inFixedNthColumn: false,
      inStickyHeader: false
    })));
    const totalsMarkup = totals ? import_react142.default.createElement("tr", null, totals.map((total, index) => this.renderTotals({
      total,
      index
    }))) : null;
    ...
    const fixedNthColumnMarkup = condensed && fixedFirstColumns !== 0 && import_react142.default.createElement("table", {
    ...
    }, import_react142.default.createElement("thead", null, import_react142.default.createElement("tr", {
      style: {
      ...
      inStickyHeader: false
    }))), totals && !showTotalsInFooter && import_react142.default.createElement("tr", {
      style: {
      ...
      total,
      index
    })))), import_react142.default.createElement("tbody", null, nthColumns.map((row, index) => this.defaultRenderRow({
      row,
      index,
      inFixedNthColumn: true,
      rowHeights: bodyRowHeights
    }))), totals && showTotalsInFooter && import_react142.default.createElement("tfoot", null, import_react142.default.createElement("tr", null, nthTotals === null || nthTotals === void 0 ? void 0 : nthTotals.map((total, index) => this.renderTotals({
      total,
      index
    })))));
    ...
    const footerMarkup = footerContent ? import_react142.default.createElement("div", {
      className: styles57.Footer
    }, footerContent) : null;
    const headerTotalsMarkup = !showTotalsInFooter ? totalsMarkup : null;
    const footerTotalsMarkup = showTotalsInFooter ? import_react142.default.createElement("tfoot", null, totalsMarkup) : null;
    const navigationMarkup = (location) => hideScrollIndicator ? null : import_react142.default.createElement(Navigation, {
      columnVisibilityData,
      isScrolledFarthestLeft,
      isScrolledFarthestRight,
    ...
    const stickyHeaderMarkup = stickyHeader ? import_react142.default.createElement(AfterInitialMount, null, import_react142.default.createElement("div", {
      className: styles57.StickyHeaderWrapper,
      role: "presentation"
    }, import_react142.default.createElement(Sticky, {
      ...
      }, import_react142.default.createElement("div", null, navigationMarkup("sticky")), import_react142.default.createElement("table", {
    ...
    return import_react142.default.createElement("div", {
      className: wrapperClassName,
      ref: this.dataTable
    }, stickyHeaderMarkup, navigationMarkup("header"), import_react142.default.createElement("div", {
      className
    }, import_react142.default.createElement("div", {
      className: styles57.ScrollContainer,
      ref: this.scrollContainer
    }, import_react142.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    }), import_react142.default.createElement(EventListener, {
      capture: true,
    ...
    }), fixedNthColumnMarkup, import_react142.default.createElement("table", {
      className: styles57.Table,
      ref: this.table
    }, import_react142.default.createElement("thead", null, headingMarkup, headerTotalsMarkup), import_react142.default.createElement("tbody", null, bodyMarkup), footerTotalsMarkup)), footerMarkup));
  }
  fixedFirstColumns() {
    const {
      hasFixedFirstColumn,
...
function DataTable(props) {
  const i18n = useI18n();
  return import_react142.default.createElement(DataTableInner, Object.assign({}, props, {
    i18n
  }));
}
...
var Weekday = (0, import_react143.memo)(function Weekday2({
  label,
  title,
  current
}) {
  const className = classNames(styles58.Weekday, current && styles58["Weekday-current"]);
  return import_react143.default.createElement("th", {
    "aria-label": label,
    scope: "col",
    className
  }, title);
...
var Day = (0, import_react144.memo)(function Day2({
  day,
  focused,
  onClick,
  onHover = noop7,
  ...
  const i18n = useI18n();
  const dayNode = (0, import_react144.useRef)(null);
  ...
  if (!day) {
    return import_react144.default.createElement("td", {
...
function Month({
  ...
  const weeks = (0, import_react145.useMemo)(() => getWeeksForMonth(month, year, weekStartsOn), [month, weekStartsOn, year]);
  const weekdays = getOrderedWeekdays(weekStartsOn).map((weekday) => import_react145.default.createElement(Weekday, {
    key: weekday,
    title: i18n.translate(`Polaris.DatePicker.daysAbbreviated.${weekdayName(weekday)}`),
    label: weekdayLabel(weekday),
    current: current && new Date().getDay() === weekday
  }));
  const handleDateClick = (0, import_react145.useCallback)((selectedDate) => {
    onChange(getNewRange(allowRange ? selected : void 0, selectedDate));
  }, [allowRange, onChange, selected]);
  const lastDayOfMonth = (0, import_react145.useMemo)(() => new Date(year, month + 1, 0), [month, year]);
  function renderWeek(day, dayIndex) {
    if (day == null) {
      return import_react145.default.createElement(Day, {
        key: dayIndex,
        onHover,
        lastDayOfMonth
      });
  ...
  const weeksMarkup = weeks.map((week, index) => import_react145.default.createElement("tr", {
    className: styles58.Week,
    key: index
  }, week.map(renderWeek)));
  return import_react145.default.createElement("div", {
    className: styles58.MonthContainer
  }, import_react145.default.createElement("table", {
    role: "grid",
    className: styles58.Month
  }, import_react145.default.createElement("caption", {
    className
  }, i18n.translate(`Polaris.DatePicker.months.${monthName(month)}`), " ", year), import_react145.default.createElement("thead", null, import_react145.default.createElement("tr", {
    className: styles58.WeekHeadings
  }, weekdays)), import_react145.default.createElement("tbody", null, weeksMarkup)));
...
function DatePicker({
  ...
  const i18n = useI18n();
  const [hoverDate, setHoverDate] = (0, import_react146.useState)(void 0);
  const [focusDate, setFocusDate] = (0, import_react146.useState)(void 0);
  (0, import_react146.useEffect)(() => {
    setFocusDate(void 0);
  }, [selected]);
  const handleFocus = (0, import_react146.useCallback)((date) => {
    setFocusDate(date);
  }, []);
  const setFocusDateAndHandleMonthChange = (0, import_react146.useCallback)((date) => {
    if (onMonthChange) {
  ...
  const handleDateSelection = (0, import_react146.useCallback)((range) => {
    const {
      end
    } = range;
    setHoverDate(end);
  ...
  const handleMonthChangeClick = (0, import_react146.useCallback)((month2, year2) => {
    if (!onMonthChange) {
      return;
    }
    setFocusDate(void 0);
  ...
  const handleHover = (0, import_react146.useCallback)((date) => {
    setHoverDate(date);
  }, []);
  const handleKeyUp = (0, import_react146.useCallback)((event) => {
    const {
      key
    } = event;
  ...
  const monthIsSelected = (0, import_react146.useMemo)(() => deriveRange(selected), [selected]);
  ...
  const secondDatePicker = multiMonth ? import_react146.default.createElement(Month, {
    onFocus: handleFocus,
  ...
  }, import_react146.default.createElement(Button, {
    plain: true,
  ...
  }, import_react146.default.createElement(Month, {
    onFocus: handleFocus,
    focusedDate: focusDate,
    month,
    year,
...
function DescriptionList({
  ...
  const terms = items.reduce((allTerms, {
    term,
    description
  }, index) => [...allTerms, import_react147.default.createElement("dt", {
    key: `dt${index}`,
    className: styles59.Term
  }, term), import_react147.default.createElement("dd", {
    key: `dd${index}`,
    className: styles59.Description
  }, description)], []);
  const className = classNames(styles59.DescriptionList, spacing3 === "tight" && styles59.spacingTight);
  return import_react147.default.createElement("dl", {
    className
  }, terms);
}
...
function DisplayText({
  ...
  return import_react148.default.createElement(Element2, {
    className
  }, children2);
}
...
// node_modules/@shopify/polaris/build/esm/components/DropZone/context.js
var DropZoneContext = (0, import_react149.createContext)({
  disabled: false,
  focused: false,
  size: "extraLarge",
  type: "file",
...
function FileUpload(props) {
  ...
  const {
    ...
    disabled,
    allowMultiple
  } = (0, import_react150.useContext)(DropZoneContext);
  ...
  const actionMarkup = import_react150.default.createElement("div", {
    className: actionClassNames
  }, actionTitle);
  ...
  const actionHintMarkup = actionHint && import_react150.default.createElement(Caption, null, import_react150.default.createElement(TextStyle, {
    variation: "subdued"
  }, actionHint));
  let viewMarkup;
  switch (size) {
    case "large":
      viewMarkup = import_react150.default.createElement(Stack, {
        vertical: true,
        spacing: "tight"
    ...
    case "medium":
      ...
      break;
    case "small":
      viewMarkup = import_react150.default.createElement("img", {
        width: "20",
        src: uploadArrow,
        alt: ""
      });
  ...
  return import_react150.default.createElement("div", {
...
var DropZone = function DropZone2({
  ...
  const node = (0, import_react151.useRef)(null);
  const dragTargets = (0, import_react151.useRef)([]);
  const adjustSize = (0, import_react151.useCallback)(debounce(() => {
    if (!node.current) {
      return;
    }
    if (variableHeight) {
  ...
  const [dragging, setDragging] = (0, import_react151.useState)(false);
  const [internalError, setInternalError] = (0, import_react151.useState)(false);
  const {
    value: focused,
    setTrue: handleFocus,
    setFalse: handleBlur
  } = useToggle(false);
  const [size, setSize] = (0, import_react151.useState)("large");
  const [measuring, setMeasuring] = (0, import_react151.useState)(true);
  const i18n = useI18n();
  const getValidatedFiles = (0, import_react151.useCallback)((files) => {
    const acceptedFiles = [];
    const rejectedFiles = [];
  ...
  const handleDrop = (0, import_react151.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
  ...
  const handleDragEnter = (0, import_react151.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
    const fileList = getDataTransferFiles(event);
  ...
  const handleDragOver = (0, import_react151.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
    onDragOver && onDragOver();
  }, [disabled, onDragOver]);
  const handleDragLeave = (0, import_react151.useCallback)((event) => {
    event.preventDefault();
    if (disabled)
      return;
  ...
  return import_react151.default.createElement(DropZoneContext.Provider, {
    value: context
  }, import_react151.default.createElement(Labelled, {
    id,
    label: labelValue,
    action: labelAction,
  ...
  }, dragOverlay, dragErrorOverlay, import_react151.default.createElement(VisuallyHidden, null, import_react151.default.createElement(DropZoneInput, Object.assign({}, inputAttributes, {
    openFileDialog,
    onFileDialogClose
  }))), import_react151.default.createElement("div", {
  ...
  function overlayMarkup(icon, color, text) {
    ...
    }, import_react151.default.createElement(Stack, {
      vertical: true,
      spacing: "tight"
    }, size === "small" && import_react151.default.createElement(Icon, {
      source: icon,
      color
    }), (size === "medium" || size === "large") && import_react151.default.createElement(Caption, null, import_react151.default.createElement(TextStyle, {
      variation: "strong"
    }, text))));
  }
  function open() {
...
var DropZoneInput = class extends import_react151.Component {
  constructor(...args) {
    super(...args);
    this.fileInputNode = (0, import_react151.createRef)();
  ...
  render() {
    ...
    return import_react151.default.createElement("input", Object.assign({}, inputProps, {
...
function EmptySearchResult({
  ...
  const descriptionMarkup = description ? import_react152.default.createElement("p", null, description) : null;
  const illustrationMarkup = withIllustration ? import_react152.default.createElement(Image, {
    alt: altText,
    source: emptySearch,
    draggable: false
  }) : null;
  return import_react152.default.createElement(Stack, {
    alignment: "center",
    vertical: true
  }, illustrationMarkup, import_react152.default.createElement(DisplayText, {
    size: "small"
  }, title), import_react152.default.createElement(TextStyle, {
    variation: "subdued"
  }, descriptionMarkup));
}
...
function EmptyState({
  ...
  const withinContentContainer = (0, import_react153.useContext)(WithinContentContext);
  ...
  const imageMarkup = largeImage ? import_react153.default.createElement(Image, {
    alt: "",
    role: "presentation",
  ...
  }) : import_react153.default.createElement(Image, {
    role: "presentation",
    alt: "",
    className: styles63.Image,
    source: image
  ...
  const footerContentMarkup = footerContent ? import_react153.default.createElement("div", {
    className: styles63.FooterContent
  }, import_react153.default.createElement(TextContainer, null, footerContent)) : null;
  const headingSize = withinContentContainer ? "small" : "medium";
  const primaryActionMarkup = action ? buttonFrom(action, {
    primary: true,
    size: "medium"
  }) : null;
  const headingMarkup = heading ? import_react153.default.createElement(DisplayText, {
    size: headingSize
  }, heading) : null;
  const childrenMarkup = children2 ? import_react153.default.createElement("div", {
    className: styles63.Content
  }, children2) : null;
  const textContentMarkup = headingMarkup || children2 ? import_react153.default.createElement(TextContainer, null, headingMarkup, childrenMarkup) : null;
  const actionsMarkup = primaryActionMarkup || secondaryActionMarkup ? import_react153.default.createElement("div", {
    className: styles63.Actions
  }, import_react153.default.createElement(Stack, {
    alignment: "center",
    distribution: "center",
    spacing: "tight"
  }, secondaryActionMarkup, primaryActionMarkup)) : null;
  const detailsMarkup = textContentMarkup || actionsMarkup || footerContentMarkup ? import_react153.default.createElement("div", {
    className: styles63.DetailsContainer
  }, import_react153.default.createElement("div", {
    className: styles63.Details
  }, textContentMarkup, actionsMarkup, footerContentMarkup)) : import_react153.default.createElement("div", {
    className: styles63.DetailsContainer
  });
  ...
  }, detailsMarkup, import_react153.default.createElement("div", {
...
function ExceptionList({
  ...
  const items = itemsList.map((item, index) => {
    ...
    const iconMarkup = icon ? import_react155.default.createElement(Icon, {
      source: icon
    }) : import_react155.default.createElement("span", {
      className: styles64.Bullet
    });
    const titleMarkup = title && import_react155.default.createElement("span", {
      className: styles64.Title
    }, title);
    const descriptionMarkup = description && import_react155.default.createElement("span", {
      className: styles64.Description
    }, description);
    const Element2 = truncate ? Truncate : import_react155.Fragment;
    return import_react155.default.createElement("li", {
      className: itemClasses,
      key: index
    }, import_react155.default.createElement("span", {
      className: styles64.Icon
    }, iconMarkup), import_react155.default.createElement(Element2, null, titleMarkup, descriptionMarkup));
  });
  return import_react155.default.createElement("ul", {
...
var ConnectedFilterControl = class extends import_react157.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      availableWidth: 0,
    ...
    this.container = (0, import_react157.createRef)();
    this.proxyButtonContainer = (0, import_react157.createRef)();
    this.moreFiltersButtonContainer = (0, import_react157.createRef)();
    this.handleResize = debounce(() => {
  ...
  render() {
    ...
    const rightMarkup = actionsToRender.length > 0 ? import_react157.default.createElement("div", {
    ...
    const rightActionMarkup = rightAction ? import_react157.default.createElement("div", {
      ref: this.moreFiltersButtonContainer,
      className: moreFiltersButtonContainerClassname
    }, shouldRenderMoreFiltersButton && import_react157.default.createElement(Item5, null, rightAction)) : null;
    const proxyButtonMarkup = rightPopoverableActions ? import_react157.default.createElement("div", {
      className: styles67.ProxyButtonContainer,
      ref: this.proxyButtonContainer,
      "aria-hidden": true
    }, rightPopoverableActions.map((action) => import_react157.default.createElement("div", {
      key: action.key,
      "data-key": action.key
    }, this.activatorButtonFrom(action, {
      proxy: true
    })))) : null;
    const auxMarkup = auxiliary ? import_react157.default.createElement("div", {
      className: styles67.AuxiliaryContainer
    }, auxiliary) : null;
    return import_react157.default.createElement(import_react157.default.Fragment, null, proxyButtonMarkup, import_react157.default.createElement("div", {
    ...
    }, import_react157.default.createElement(Item5, null, children2)) : null, rightMarkup, rightActionMarkup, import_react157.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })), auxMarkup));
  }
  ...
  activatorButtonFrom(action, options) {
    ...
    return import_react157.default.createElement(Button, {
      onClick: action.onAction,
      disclosure: true,
  ...
  popoverFrom(actions) {
    return actions.map((action) => {
      return import_react157.default.createElement(Item5, {
        key: action.key
      }, import_react157.default.createElement(Popover2, {
...
function TagsWrapper({
  ...
  if (hidden) {
    return import_react158.default.createElement(VisuallyHidden, null, children2);
  }
  return import_react158.default.createElement(import_react158.default.Fragment, null, children2);
}
...
function Tag({
  ...
  if (onClick) {
    return import_react159.default.createElement("button", {
      type: "button",
      disabled,
      className,
      onClick
  ...
  const removeButton = onRemove ? import_react159.default.createElement("button", {
    type: "button",
    "aria-label": ariaLabel,
    ...
    onMouseUp: handleMouseUpByBlurring,
    disabled
  }, import_react159.default.createElement(Icon, {
    source: SvgCancelSmallMinor
  })) : null;
  const tagContent = url && !disabled ? import_react159.default.createElement("a", {
    className: classNames(styles68.Link, segmented && styles68.segmented),
    href: url
  }, import_react159.default.createElement("span", {
    title: tagTitle,
    className: styles68.LinkText
  }, children2)) : import_react159.default.createElement("span", {
    title: tagTitle,
    className: styles68.TagText
  }, children2);
  return import_react159.default.createElement("span", {
    className
...
function useMediaQuery() {
  const mediaQuery = (0, import_react160.useContext)(MediaQueryContext);
  if (!mediaQuery) {
...
function useFocusManager({
  ...
  const focusManager = (0, import_react161.useContext)(FocusManagerContext);
...
var Focus = (0, import_react162.memo)(function Focus2({
  children: children2,
  disabled,
  root
}) {
  ...
  return import_react162.default.createElement(import_react162.default.Fragment, null, children2);
});
function isRef(ref) {
...
function TrapFocus({
  ...
  const focusTrapWrapper = (0, import_react163.useRef)(null);
  const [disableFocus, setDisableFocus] = (0, import_react163.useState)(true);
  ...
  return import_react163.default.createElement(Focus, {
    disabled: disableFocus,
    root: focusTrapWrapper.current
  }, import_react163.default.createElement("div", {
    ref: focusTrapWrapper
  }, import_react163.default.createElement(EventListener, {
    event: "focusin",
    handler: handleFocusIn
  }), import_react163.default.createElement(KeypressListener, {
    keyCode: Key.Tab,
    keyEvent: "keydown",
    handler: handleTab
  }), children2));
...
function Sheet({
  ...
  const container = (0, import_react164.useRef)(null);
  const activatorRef = (0, import_react164.useRef)(null);
  ...
  const activatorMarkup = activator && !isRef2(activator) ? import_react164.default.createElement("div", {
    ref: activatorRef
  }, activator) : null;
  return import_react164.default.createElement(import_react164.default.Fragment, null, activatorMarkup, import_react164.default.createElement(Portal, {
    idPrefix: "sheet"
  }, import_react164.default.createElement(CSSTransition_default, {
    nodeRef: container,
    ...
    onEntered,
    onExit
  }, import_react164.default.createElement("div", Object.assign({
    className: styles69.Container
  }, layer.props, overlay.props, {
    ref: container
  }), import_react164.default.createElement(TrapFocus, {
    trapping: open
    ...
    "aria-label": accessibilityLabel
  }, children2)))), import_react164.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: handleClose
  }), open && import_react164.default.createElement(Backdrop, {
    transparent: true,
    onClick: handleClose
  })));
}
...
var FiltersInner = class extends import_react165.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      open: false,
    ...
    this.moreFiltersButtonContainer = (0, import_react165.createRef)();
    this.moreFiltersDoneButtonContainer = (0, import_react165.createRef)();
    this.focusNode = (0, import_react165.createRef)();
    this.closeFilters = () => {
      this.setState({
        open: false
      }, () => {
  ...
  render() {
    ...
    const backdropMarkup = open ? import_react165.default.createElement(import_react165.default.Fragment, null, import_react165.default.createElement(ScrollLock, null), import_react165.default.createElement("div", {
    ...
    const filtersContentMarkup = filters.map((filter, index) => {
      ...
      const appliedFilterBadgeMarkup = appliedFilterContent ? import_react165.default.createElement("div", {
        className: styles66.AppliedFilterBadgeContainer
      }, import_react165.default.createElement(Badge, {
        size: "small",
        status: "new"
      ...
      }, import_react165.default.createElement("h3", {
        className: styles66.FilterTriggerTitle
      }, import_react165.default.createElement(TextStyle, {
        variation: this.props.disabled || filter.disabled ? "subdued" : void 0
      }, filter.label)), import_react165.default.createElement("span", {
        className: styles66.FilterTriggerIcon
      }, import_react165.default.createElement(Icon, {
        source: icon,
        color: "base"
      }))), appliedFilterBadgeMarkup), import_react165.default.createElement(Collapsible, {
        id: collapsibleID,
        open: filterIsOpen
      }, import_react165.default.createElement("div", {
        className: styles66.FilterNodeContainer
      }, import_react165.default.createElement(Focus, {
    ...
    const rightActionMarkup = filters.length ? import_react165.default.createElement("div", {
      ref: this.moreFiltersButtonContainer
    }, import_react165.default.createElement(Button, {
    ...
    const filtersControlMarkup = import_react165.default.createElement(ConnectedFilterControl, {
    ...
    }, hideQueryField ? null : import_react165.default.createElement(TextField, {
      ...
      labelHidden: true,
      prefix: import_react165.default.createElement("span", {
    ...
    const filtersDesktopHeaderMarkup = import_react165.default.createElement("div", {
      className: filtersContainerHeaderClassname
    }, import_react165.default.createElement(DisplayText, {
      size: "small",
      element: "h3"
    }, moreFiltersLabel), import_react165.default.createElement(Button, {
      icon: SvgCancelSmallMinor,
      plain: true,
      accessibilityLabel: i18n.translate("Polaris.Filters.cancel"),
      onClick: this.closeFilters
    }));
    const filtersMobileHeaderMarkup = import_react165.default.createElement("div", {
      className: filtersContainerHeaderClassname
    }, import_react165.default.createElement(Button, {
      icon: SvgCancelSmallMinor,
      plain: true,
    ...
    const filtersDesktopFooterMarkup = import_react165.default.createElement("div", {
      className: filtersDesktopFooterClassname
    }, import_react165.default.createElement(Button, {
      onClick: this.handleClearAll,
      disabled: !this.hasAppliedFilters()
    }, i18n.translate("Polaris.Filters.clearAllFilters")), import_react165.default.createElement("div", {
      ref: this.moreFiltersDoneButtonContainer
    }, import_react165.default.createElement(Button, {
      onClick: this.closeFilters,
      primary: true
    }, i18n.translate("Polaris.Filters.done"))));
    const filtersMobileFooterMarkup = import_react165.default.createElement("div", {
      className: styles66.FiltersMobileContainerFooter
    }, this.hasAppliedFilters() ? import_react165.default.createElement(Button, {
      onClick: onClearAll,
      fullWidth: true
    }, i18n.translate("Polaris.Filters.clearAllFilters")) : import_react165.default.createElement("div", {
      ...
      variation: "subdued"
    }, import_react165.default.createElement("p", null, i18n.translate("Polaris.Filters.noFiltersApplied")))));
    const shouldHideTagsContainer = !appliedFilters || appliedFilters.length < 1;
    const tagsMarkup = !hideTags ? import_react165.default.createElement(TagsWrapper, {
      hidden: shouldHideTagsContainer
    }, import_react165.default.createElement("div", {
      className: styles66.TagsContainer,
      "aria-live": "polite"
    }, (appliedFilters || []).map((filter) => {
      return import_react165.default.createElement(Tag, {
        key: filter.key,
        onRemove: () => {
    ...
    const filtersContainerMarkup = isNavigationCollapsed ? import_react165.default.createElement(Sheet, {
      accessibilityLabel: moreFiltersLabel,
      open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
      onExit: this.setReadyForFocus(false)
    }, filtersMobileHeaderMarkup, import_react165.default.createElement(Scrollable, {
      className: filtersMobileContainerContentClassName,
      shadow: true
    }, filtersContentMarkup, filtersMobileFooterMarkup)) : import_react165.default.createElement(Sheet, {
      accessibilityLabel: moreFiltersLabel,
      open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
    ...
    }, filtersDesktopHeaderMarkup, import_react165.default.createElement(Scrollable, {
      className: filtersDesktopContainerContentClassName,
      shadow: true
    }, filtersContentMarkup), filtersDesktopFooterMarkup));
    const helpTextMarkup = helpText ? import_react165.default.createElement("div", {
      id: "FiltersHelpText",
      className: styles66.HelpText
    }, import_react165.default.createElement(TextStyle, {
      variation: "subdued"
    }, helpText)) : null;
    return import_react165.default.createElement(WithinFilterContext.Provider, {
      value: true
    }, import_react165.default.createElement("div", {
      className: styles66.Filters
    }, filtersControlMarkup, filtersContainerMarkup, tagsMarkup, helpTextMarkup, backdropMarkup, import_react165.default.createElement(KeypressListener, {
      keyCode: Key.Escape,
  ...
  generateFilterMarkup(filter) {
    ...
    const clearButtonMarkup = !filter.hideClearButton && import_react165.default.createElement(Button, {
      plain: true,
    ...
    return import_react165.default.createElement("div", {
      ref: this.focusNode
    }, import_react165.default.createElement(Stack, {
      vertical: true,
      spacing: "tight"
...
function Filters(props) {
  ...
  return import_react165.default.createElement(FiltersInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
function Form({
  ...
  const i18n = useI18n();
  const handleSubmit = (0, import_react167.useCallback)((event) => {
    if (!preventDefault2) {
      return;
    }
    event.preventDefault();
  ...
  const submitMarkup = implicitSubmit ? import_react167.default.createElement(VisuallyHidden, null, import_react167.default.createElement("button", {
    type: "submit",
    "aria-hidden": "true",
    tabIndex: -1
  }, i18n.translate("Polaris.Common.submit"))) : null;
  return import_react167.default.createElement("form", {
    acceptCharset,
    action,
...
function Item6({
  ...
  return children2 ? import_react168.default.createElement("div", {
...
function Group({
  ...
  if (helpText) {
    ...
    helpTextElement = import_react169.default.createElement("div", {
      id: helpTextID3,
  ...
  if (title) {
    titleID = `${id}Title`;
    titleElement = import_react169.default.createElement("div", {
      id: titleID,
      className: styles71.Title
    }, title);
  }
  const itemsMarkup = import_react169.Children.map(children2, (child) => wrapWithComponent(child, Item6, {}));
...
// node_modules/@shopify/polaris/build/esm/components/FormLayout/FormLayout.js
var FormLayout = (0, import_react170.memo)(function FormLayout2({
  children: children2
}) {
  return import_react170.default.createElement("div", {
    className: styles71.FormLayout
  }, import_react170.Children.map(children2, wrapChildren));
});
...
function useIsMountedRef() {
  const isMounted = (0, import_react171.useRef)(false);
...
function Loading2() {
  ...
  const [progress, setProgress] = (0, import_react172.useState)(0);
  const [animating, setAnimating] = (0, import_react172.useState)(false);
...
function CSSAnimation({
  ...
  const [transitionStatus, setTransitionStatus] = (0, import_react173.useState)(inProp ? TransitionStatus2.Entering : TransitionStatus2.Exited);
  const isMounted = (0, import_react173.useRef)(false);
  const node = (0, import_react173.useRef)(null);
...
function Dialog({
  ...
  const containerNode = (0, import_react174.useRef)(null);
  ...
  return import_react174.default.createElement(TransitionChild, Object.assign({}, props, {
    ...
    onEntered,
    onExited
  }), import_react174.default.createElement("div", {
    className: styles77.Container,
    "data-polaris-layer": true,
    "data-polaris-overlay": true,
    ref: containerNode
  }, import_react174.default.createElement(TrapFocus, null, import_react174.default.createElement("div", {
    role: "dialog",
    "aria-modal": true,
    ...
    className: classes
  }, import_react174.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: onClose
  }), children2)))));
}
...
function FadeUp({
  ...
  return import_react174.default.createElement(CSSTransition_default, Object.assign({}, props, {
...
function Header3({
  ...
  }, import_react176.default.createElement(DisplayText, {
    element: "h2",
    size: "small"
  }, children2)), import_react176.default.createElement(CloseButton, {
    titleHidden,
    onClick: onClose
  }));
}
...
function Section5({
  ...
  return import_react177.default.createElement("section", {
    className
  }, children2);
}
...
function Footer({
  ...
  const actions = primaryActionButton || secondaryActionButtons ? import_react178.default.createElement(ButtonGroup, null, secondaryActionButtons, primaryActionButton) : null;
  ...
  }, import_react178.default.createElement(Stack, {
    alignment: "center"
  }, import_react178.default.createElement(Stack.Item, {
    fill: true
  }, children2), actions)));
}
...
var Modal = function Modal2({
  ...
  const [iframeHeight, setIframeHeight] = (0, import_react179.useState)(IFRAME_LOADING_HEIGHT);
  const headerId = useUniqueId("modal-header");
  const activatorRef = (0, import_react179.useRef)(null);
  const i18n = useI18n();
  const iframeTitle = i18n.translate("Polaris.Modal.iFrameTitle");
  let dialog;
  let backdrop;
  const handleEntered = (0, import_react179.useCallback)(() => {
    if (onTransitionEnd) {
      onTransitionEnd();
    }
  }, [onTransitionEnd]);
  const handleExited = (0, import_react179.useCallback)(() => {
  ...
  const handleIFrameLoad = (0, import_react179.useCallback)((evt) => {
  ...
  if (open) {
    const footerMarkup = !footer && !primaryAction && !secondaryActions ? null : import_react179.default.createElement(Footer, {
      primaryAction,
      secondaryActions
    }, footer);
    ...
    const body = loading ? import_react179.default.createElement("div", {
      className: styles76.Spinner
    }, import_react179.default.createElement(Spinner, null)) : content;
    const scrollContainerMarkup = noScroll ? import_react179.default.createElement("div", {
      className: styles76.Body
    }, body) : import_react179.default.createElement(Scrollable, {
      shadow: true,
      className: styles76.Body,
      onScrolledToBottom
    }, body);
    const bodyMarkup = src ? import_react179.default.createElement("iframe", {
      name: iFrameName,
      title: iframeTitle,
      src,
    ...
    dialog = import_react179.default.createElement(Dialog, {
      instant,
      labelledBy: headerId,
      onClose,
      ...
      limitHeight,
      fullScreen
    }, import_react179.default.createElement(Header3, {
      titleHidden,
      id: headerId,
      onClose
    }, title), import_react179.default.createElement("div", {
      className: styles76.BodyWrapper
    }, bodyMarkup), footerMarkup);
    backdrop = import_react179.default.createElement(Backdrop, {
      onClick: onClose
    });
  }
  const animated = !instant;
  const activatorMarkup = activator && !isRef3(activator) ? import_react179.default.createElement("div", {
    ref: activatorRef
  }, activator) : null;
  return import_react179.default.createElement(WithinContentContext.Provider, {
    value: true
  }, activatorMarkup, import_react179.default.createElement(Portal, {
    idPrefix: "modal"
  }, import_react179.default.createElement(TransitionGroup_default, {
    appear: animated,
    enter: animated,
    exit: animated
  }, dialog), backdrop));
...
function DiscardConfirmationModal({
  ...
  const i18n = useI18n();
  return import_react180.default.createElement(Modal, {
...
function ContextualSaveBar3({
  ...
  const handleDiscardAction = (0, import_react181.useCallback)(() => {
  ...
  const discardConfirmationModalMarkup = discardAction && discardAction.onAction && discardAction.discardConfirmationModal && import_react181.default.createElement(DiscardConfirmationModal, {
    open: discardConfirmationModalVisible,
    onCancel: toggleDiscardConfirmationModal,
    onDiscard: handleDiscardAction
  });
  const discardActionMarkup = discardAction && import_react181.default.createElement(Button, {
  ...
  const saveActionMarkup = saveAction && import_react181.default.createElement(Button, {
    primary: true,
    url: saveAction.url,
  ...
  const imageMarkup = logo && import_react181.default.createElement(Image, {
    style: {
      width
    },
  ...
  const logoMarkup = alignContentFlush || contextControl ? null : import_react181.default.createElement("div", {
    className: styles75.LogoContainer,
    style: {
      width
    }
  }, imageMarkup);
  const contextControlMarkup = contextControl ? import_react181.default.createElement("div", {
    className: styles75.ContextControl
  }, contextControl) : null;
  const contentsClassName = classNames(styles75.Contents, fullWidth && styles75.fullWidth);
  return import_react181.default.createElement(import_react181.default.Fragment, null, import_react181.default.createElement("div", {
    className: styles75.ContextualSaveBar
  }, contextControlMarkup, logoMarkup, import_react181.default.createElement("div", {
    className: contentsClassName
  }, import_react181.default.createElement("h2", {
    className: styles75.Message
  }, message), import_react181.default.createElement("div", {
    className: styles75.ActionContainer
  }, import_react181.default.createElement(Stack, {
    spacing: "tight",
    wrap: false
...
function useDeepCompareRef(dependencies, comparator = import_react_fast_compare2.default) {
  const dependencyList = (0, import_react182.useRef)(dependencies);
...
function useDeepEffect(callback, dependencies, customCompare) {
  (0, import_react183.useEffect)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
function useDeepCallback(callback, dependencies, customCompare) {
  return (0, import_react184.useCallback)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
function Toast({
  ...
  const dismissMarkup = import_react185.default.createElement("button", {
    type: "button",
    className: styles83.CloseButton,
    onClick: onDismiss
  }, import_react185.default.createElement(Icon, {
    source: SvgMobileCancelMajor
  }));
  const actionMarkup = action ? import_react185.default.createElement("div", {
    className: styles83.Action
  }, import_react185.default.createElement(Button, {
    plain: true,
    monochrome: true,
    onClick: action.onAction
  }, action.content)) : null;
  ...
  return import_react185.default.createElement("div", {
    className
  }, import_react185.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: onDismiss
...
// node_modules/@shopify/polaris/build/esm/components/Frame/components/ToastManager/ToastManager.js
var ToastManager = (0, import_react186.memo)(function ToastManager2({
  toastMessages
}) {
  const toastNodes = [];
  ...
  const toastsMarkup = toastMessages.map((toast, index) => {
    const toastNode = (0, import_react186.createRef)();
    toastNodes[index] = toastNode;
    return import_react186.default.createElement(CSSTransition_default, {
      ...
      ref: toastNode
    }, import_react186.default.createElement(Toast, toast)));
  });
  return import_react186.default.createElement(Portal, null, import_react186.default.createElement(EventListener, {
    event: "resize",
...
var FrameInner = class extends import_react187.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      skipFocused: false,
    ...
    this.navigationNode = (0, import_react187.createRef)();
  ...
  render() {
    ...
    const navigationMarkup = navigation ? import_react187.default.createElement(TrapFocus, {
      trapping: mobileNavShowing
    }, import_react187.default.createElement(CSSTransition_default, {
    ...
    }, import_react187.default.createElement("div", Object.assign({
      key: "NavContent"
    }, mobileNavAttributes, {
    ...
    }), navigation, import_react187.default.createElement("button", {
      type: "button",
      ...
      tabIndex
    }, import_react187.default.createElement(Icon, {
      source: SvgMobileCancelMajor
    }))))) : null;
    const loadingMarkup = loadingStack > 0 ? import_react187.default.createElement("div", {
      className: styles72.LoadingBar,
      id: APP_FRAME_LOADING_BAR
    }, import_react187.default.createElement(Loading2, null)) : null;
    const contextualSaveBarMarkup = import_react187.default.createElement(CSSAnimation, {
      in: showContextualSaveBar,
      className: styles72.ContextualSaveBar,
      type: "fade"
    }, import_react187.default.createElement(ContextualSaveBar3, this.contextualSaveBar));
    const topBarMarkup = topBar ? import_react187.default.createElement("div", Object.assign({
      className: styles72.TopBar
    }, layer.props, dataPolarisTopBar.props, {
      id: APP_FRAME_TOP_BAR
    }), topBar) : null;
    const globalRibbonMarkup = globalRibbon ? import_react187.default.createElement("div", {
    ...
    const skipMarkup = import_react187.default.createElement("div", {
    ...
    const navigationOverlayMarkup = showMobileNavigation && isNavigationCollapsed ? import_react187.default.createElement(Backdrop, {
    ...
    return import_react187.default.createElement(FrameContext.Provider, {
      value: context
    }, import_react187.default.createElement("div", Object.assign({
      className: frameClassName
    }, layer.props, navigationAttributes), skipMarkup, topBarMarkup, navigationMarkup, contextualSaveBarMarkup, loadingMarkup, navigationOverlayMarkup, import_react187.default.createElement("main", {
      className: styles72.Main,
      id: APP_FRAME_MAIN,
      "data-has-global-ribbon": Boolean(globalRibbon)
    }, import_react187.default.createElement("div", {
      className: styles72.Content
    }, children2)), import_react187.default.createElement(ToastManager, {
      toastMessages
    }), globalRibbonMarkup, import_react187.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })));
  }
...
function Frame(props) {
  const i18n = useI18n();
  const mediaQuery = useMediaQuery();
  return import_react187.default.createElement(FrameInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
function FullscreenBar({
  ...
  }, import_react188.default.createElement("button", {
...
var IndexContext = (0, import_react191.createContext)(void 0);
var IndexSelectionChangeContext = (0, import_react191.createContext)(void 0);
var IndexRowContext = (0, import_react191.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/index-provider/hooks.js
function useIndexSelectionChange() {
  const onSelectionChange = (0, import_react192.useContext)(IndexSelectionChangeContext);
...
function useIndexRow() {
  const indexRow = (0, import_react192.useContext)(IndexRowContext);
  if (!indexRow) {
    throw new Error(`Missing IndexProvider context`);
  }
  return indexRow;
...
function useIndexValue() {
  const index = (0, import_react192.useContext)(IndexContext);
  if (!index) {
    throw new Error(`Missing IndexProvider context`);
  }
  return index;
...
function useHandleBulkSelection({
  ...
  const lastSelected = (0, import_react192.useRef)(null);
  const handleSelectionChange = (0, import_react192.useCallback)((selectionType, toggleType, selection, sortOrder) => {
...
function IndexProvider({
  ...
  const rowContextValue = (0, import_react193.useMemo)(() => ({
    selectable: isSelectableIndex,
    selectMode: selectMode && isSelectableIndex,
    condensed
  }), [condensed, selectMode, isSelectableIndex]);
  return import_react193.default.createElement(IndexContext.Provider, {
    value: contextValue
  }, import_react193.default.createElement(IndexRowContext.Provider, {
    value: rowContextValue
  }, import_react193.default.createElement(IndexSelectionChangeContext.Provider, {
...
var Cell3 = (0, import_react194.memo)(function Cell4({
  children: children2,
  className,
  flush
}) {
  const cellClassName = classNames(className, styles87.TableCell, flush && styles87["TableCell-flush"]);
  return import_react194.default.createElement("td", {
...
var RowContext = (0, import_react195.createContext)({});
var RowHoveredContext = (0, import_react195.createContext)(void 0);
var scrollDefaultContext = {
  scrollableContainer: null,
  canScrollLeft: false,
  canScrollRight: false
};
var ScrollContext = (0, import_react195.createContext)(scrollDefaultContext);

// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Checkbox/Checkbox.js
var Checkbox3 = (0, import_react196.memo)(function Checkbox4() {
  const i18n = useI18n();
  const {
    resourceName,
    condensed
  ...
  const {
    ...
    disabled,
    onInteraction
  } = (0, import_react196.useContext)(RowContext);
  const wrapperClassName = classNames(styles88.Wrapper, condensed ? styles88.condensed : styles88.expanded);
  const Wrapper = condensed ? import_react196.Fragment : CheckboxWrapper;
  return import_react196.default.createElement(Wrapper, null, import_react196.default.createElement("div", {
    className: styles88.TableCellContentContainer
  }, import_react196.default.createElement("div", {
    className: wrapperClassName,
    onClick: onInteraction,
    onKeyUp: noop10
  }, import_react196.default.createElement(Checkbox, {
    id: itemId,
...
function CheckboxWrapper({
  ...
  const checkboxNode = (0, import_react196.useRef)(null);
  const handleResize = (0, import_react196.useCallback)(debounce(() => {
  ...
  return import_react196.default.createElement("td", {
...
// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Row/Row.js
var Row = (0, import_react197.memo)(function Row2({
  children: children2,
  selected,
  id,
  position,
  ...
  const handleInteraction = (0, import_react197.useCallback)((event) => {
    event.stopPropagation();
  ...
  const contextValue = (0, import_react197.useMemo)(() => ({
    itemId: id,
    selected,
    position,
  ...
  const primaryLinkElement = (0, import_react197.useRef)(null);
  const isNavigating = (0, import_react197.useRef)(false);
  const tableRowRef = (0, import_react197.useRef)(null);
  const tableRowCallbackRef = (0, import_react197.useCallback)((node) => {
  ...
  const checkboxMarkup = selectable ? import_react197.default.createElement(Checkbox3, null) : null;
  return import_react197.default.createElement(RowContext.Provider, {
    value: contextValue
  }, import_react197.default.createElement(RowHoveredContext.Provider, {
    value: hovered
  }, import_react197.default.createElement(RowWrapper, {
    key: id,
...
function ScrollContainer({
  ...
  const [containerScroll, setContainerScroll] = (0, import_react198.useState)(scrollDefaultContext);
  const handleScroll = (0, import_react198.useCallback)(debounce(() => {
    if (!scrollableContainerRef.current) {
      return;
    }
  ...
  return import_react198.default.createElement(ScrollContext.Provider, {
...
function IndexTableBase({
  ...
  const tablePosition = (0, import_react199.useRef)({
    top: 0,
    left: 0
  });
  const tableHeadingRects = (0, import_react199.useRef)([]);
  const scrollableContainerElement = (0, import_react199.useRef)(null);
  const tableElement = (0, import_react199.useRef)(null);
  const condensedListElement = (0, import_react199.useRef)(null);
  const [tableInitialized, setTableInitialized] = (0, import_react199.useState)(false);
  const [isSmallScreenSelectable, setIsSmallScreenSelectable] = (0, import_react199.useState)(false);
  const [stickyWrapper, setStickyWrapper] = (0, import_react199.useState)(null);
  const [hideScrollContainer, setHideScrollContainer] = (0, import_react199.useState)(false);
  const [smallScreen, setSmallScreen] = (0, import_react199.useState)(isBreakpointsXS());
  const tableHeadings = (0, import_react199.useRef)([]);
  const stickyTableHeadings = (0, import_react199.useRef)([]);
  const stickyHeaderWrapperElement = (0, import_react199.useRef)(null);
  const firstStickyHeaderElement = (0, import_react199.useRef)(null);
  const stickyHeaderElement = (0, import_react199.useRef)(null);
  const scrollBarElement = (0, import_react199.useRef)(null);
  const scrollContainerElement = (0, import_react199.useRef)(null);
  const scrollingWithBar = (0, import_react199.useRef)(false);
  const scrollingContainer = (0, import_react199.useRef)(false);
  const tableBodyRef = (0, import_react199.useCallback)((node) => {
    if (node !== null && !tableInitialized) {
      setTableInitialized(true);
    }
  }, [tableInitialized]);
  const toggleIsSmallScreenSelectable = (0, import_react199.useCallback)(() => {
  ...
  const calculateFirstHeaderOffset = (0, import_react199.useCallback)(() => {
    if (!selectable) {
  ...
  const resizeTableHeadings = (0, import_react199.useMemo)(() => debounce(() => {
  ...
  const resizeTableScrollBar = (0, import_react199.useCallback)(() => {
  ...
  const debounceResizeTableScrollbar = (0, import_react199.useCallback)(debounce(resizeTableScrollBar, SCROLL_BAR_DEBOUNCE_PERIOD, {
    trailing: true
  }), [resizeTableScrollBar]);
  const [canScrollRight, setCanScrollRight] = (0, import_react199.useState)(true);
  const handleCanScrollRight = (0, import_react199.useCallback)(debounce(() => {
  ...
  const handleIsSmallScreen = (0, import_react199.useCallback)(() => {
    setSmallScreen(smallScreen);
  }, [smallScreen]);
  const [canFitStickyColumn, setCanFitStickyColumn] = (0, import_react199.useState)(true);
  const handleCanFitStickyColumn = (0, import_react199.useCallback)(() => {
  ...
  const handleResize = (0, import_react199.useCallback)(() => {
  ...
  const handleScrollContainerScroll = (0, import_react199.useCallback)((canScrollLeft, canScrollRight2) => {
  ...
  const handleScrollBarScroll = (0, import_react199.useCallback)(() => {
    if (!scrollableContainerElement.current || !scrollBarElement.current) {
      return;
    }
  ...
  const stickyColumnHeader = import_react199.default.createElement("div", {
    className: styles87.TableHeading,
    key: headings[0].title,
    style: stickyColumnHeaderStyle,
    "data-index-table-sticky-heading": true
  }, import_react199.default.createElement(Stack, {
    spacing: "none",
    wrap: false,
    alignment: "center"
  }, selectable && import_react199.default.createElement("div", {
    className: styles87.FirstStickyHeaderElement,
    ref: firstStickyHeaderElement
  }, renderCheckboxContent()), selectable && import_react199.default.createElement("div", {
    className: styles87["StickyTableHeading-second-scrolling"]
  }, renderHeadingContent(headings[0], 0)), !selectable && import_react199.default.createElement("div", {
    className: styles87.FirstStickyHeaderElement,
    ref: firstStickyHeaderElement
  }, renderHeadingContent(headings[0], 0))));
  const stickyHeadingsMarkup = headings.map(renderStickyHeading);
  const selectedItemsCountLabel = selectedItemsCount === SELECT_ALL_ITEMS ? `${itemCount}+` : selectedItemsCount;
  const handleTogglePage = (0, import_react199.useCallback)(() => {
  ...
  const loadingMarkup = import_react199.default.createElement(CSSTransition_default, {
    in: loading,
  ...
  }, import_react199.default.createElement(Spinner, {
    size: "small"
  }), import_react199.default.createElement("span", {
  ...
  const stickyHeaderMarkup = import_react199.default.createElement("div", {
    className: stickyTableClassNames,
    role: "presentation"
  }, import_react199.default.createElement(Sticky, {
    ...
    const bulkActionsMarkup = shouldShowBulkActions ? import_react199.default.createElement("div", {
      className: bulkActionClassNames,
      "data-condensed": condensed
    }, loadingMarkup, import_react199.default.createElement(BulkActions, {
      smallScreen,
    ...
    const selectButtonMarkup = import_react199.default.createElement(Button, {
      icon: SvgEnableSelectionMinor,
      onClick: toggleIsSmallScreenSelectable
    }, i18n.translate("Polaris.IndexTable.selectButtonText"));
    const headerMarkup = condensed ? import_react199.default.createElement("div", {
      className: classNames(styles87.HeaderWrapper, !selectable && styles87.unselectable)
    }, loadingMarkup, sort, selectable && selectButtonMarkup) : import_react199.default.createElement("div", {
      className: stickyHeaderClassNames,
      ref: stickyHeaderWrapperElement
    }, loadingMarkup, import_react199.default.createElement("div", {
      className: stickyColumnHeaderClassNames
    }, stickyColumnHeader), import_react199.default.createElement("div", {
  ...
  const scrollBarMarkup = itemCount > 0 ? import_react199.default.createElement(AfterInitialMount, null, import_react199.default.createElement("div", {
  ...
  const emptyStateMarkup = emptyState ? emptyState : import_react199.default.createElement(EmptySearchResult, {
  ...
  const sharedMarkup = import_react199.default.createElement(import_react199.default.Fragment, null, import_react199.default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }), import_react199.default.createElement(AfterInitialMount, null, stickyHeaderMarkup));
  const bodyMarkup = condensed ? import_react199.default.createElement(import_react199.default.Fragment, null, sharedMarkup, import_react199.default.createElement("ul", {
    "data-selectmode": Boolean(selectMode || isSmallScreenSelectable),
    className: styles87.CondensedList,
    ref: condensedListElement
  }, children2)) : import_react199.default.createElement(import_react199.default.Fragment, null, sharedMarkup, import_react199.default.createElement(ScrollContainer, {
    scrollableContainerRef: scrollableContainerElement,
    onScroll: handleScrollContainerScroll
  }, import_react199.default.createElement("table", {
    ref: tableElement,
    className: tableClassNames
  }, import_react199.default.createElement("thead", null, import_react199.default.createElement("tr", {
    className: styles87.HeadingRow
  }, headingsMarkup)), import_react199.default.createElement("tbody", {
    ref: tableBodyRef
  }, children2))));
  const tableContentMarkup = itemCount > 0 ? bodyMarkup : import_react199.default.createElement("div", {
    className: styles87.EmptySearchResultWrapper
  }, emptyStateMarkup);
  return import_react199.default.createElement(import_react199.default.Fragment, null, import_react199.default.createElement("div", {
  ...
  function renderHeading(heading, index) {
    ...
    const headingContent = import_react199.default.createElement("th", {
    ...
    const checkboxContent = import_react199.default.createElement("th", {
      className: checkboxClassName,
      key: `${heading}-${index}`,
      "data-index-table-heading": true
  ...
  function renderCheckboxContent() {
    ...
    }, import_react199.default.createElement(Checkbox, {
  ...
  function renderHeadingContent(heading, index) {
    let headingContent;
    if (heading.new) {
      headingContent = import_react199.default.createElement(Stack, {
        wrap: false,
        alignment: "center"
      }, import_react199.default.createElement("span", null, heading.title), import_react199.default.createElement(Badge, {
        status: "new"
      }, i18n.translate("Polaris.IndexTable.onboardingBadgeText")));
    } else if (heading.hidden) {
      headingContent = import_react199.default.createElement(VisuallyHidden, null, heading.title);
    } else {
    ...
    if (sortable !== null && sortable !== void 0 && sortable[index]) {
      ...
      const iconMarkup = import_react199.default.createElement("span", {
      ...
      return import_react199.default.createElement(UnstyledButton, {
...
function IndexTable({
  ...
  return import_react199.default.createElement(IndexProvider, {
    selectable,
    itemCount,
    selectedItemsCount,
    resourceName: passedResourceName,
    ...
    condensed,
    onSelectionChange
  }, import_react199.default.createElement(IndexTableBase, indexTableBaseProps, children2));
}
...
var InlineCode = ({
  children: children2
}) => import_react200.default.createElement("code", {
...
function KeyboardKey({
  ...
  return import_react201.default.createElement("kbd", {
...
function KonamiCode({
  ...
  const [position, setPosition] = (0, import_react202.useState)(0);
...
function AnnotatedSection({
  ...
  const descriptionMarkup = typeof description === "string" ? import_react203.default.createElement("p", null, description) : description;
  ...
  }, import_react203.default.createElement(TextContainer, null, import_react203.default.createElement(Heading, {
    id
  }, title), descriptionMarkup && import_react203.default.createElement("div", {
    className: styles92.AnnotationDescription
  }, descriptionMarkup))), import_react203.default.createElement("div", {
...
var Layout = function Layout2({
  ...
  const content = sectioned ? import_react205.default.createElement(Section6, null, children2) : children2;
...
function Link({
  ...
  return import_react206.default.createElement(BannerContext.Consumer, null, (BannerContext2) => {
    ...
    return url ? import_react206.default.createElement(UnstyledLink, {
      onClick,
      className,
      url,
      external,
      ...
      "aria-label": accessibilityLabel,
      "data-primary-link": dataPrimaryLink
    }, children2) : import_react206.default.createElement("button", {
      type: "button",
      onClick,
      className,
      id,
...
var List = function List2({
  ...
  return import_react208.default.createElement(ListElement, {
    className
  }, children2);
};
List.Item = Item7;
...
var Loading3 = (0, import_react209.memo)(function Loading4() {
  const {
    startLoading,
    stopLoading
  } = useFrame();
...
function MediaCard({
  ...
  if (title) {
    const headerContent = typeof title === "string" ? import_react210.default.createElement(Heading, null, title) : title;
    headerMarkup = import_react210.default.createElement("div", {
      className: styles95.Heading
    }, headerContent);
  }
  const popoverActivator = import_react210.default.createElement(Button, {
    icon: SvgHorizontalDotsMinor,
  ...
  const popoverActionsMarkup = popoverActions.length > 0 ? import_react210.default.createElement("div", {
    className: styles95.Popover
  }, import_react210.default.createElement(Popover2, {
    active: popoverActive,
    activator: popoverActivator,
    onClose: togglePopoverActive,
    preferredAlignment: "left",
    preferredPosition: "below"
  }, import_react210.default.createElement(ActionList, {
    items: popoverActions,
    onActionAnyItem: togglePopoverActive
  }))) : null;
  const primaryActionMarkup = primaryAction ? import_react210.default.createElement("div", {
    className: styles95.PrimaryAction
  }, buttonFrom(primaryAction)) : null;
  const secondaryActionMarkup = secondaryAction ? import_react210.default.createElement("div", {
  ...
  const actionMarkup = primaryActionMarkup || secondaryActionMarkup ? import_react210.default.createElement("div", {
    className: actionClassName
  }, import_react210.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup)) : null;
  ...
  return import_react210.default.createElement(Card, null, import_react210.default.createElement("div", {
    className: mediaCardClassName
  }, import_react210.default.createElement("div", {
    className: mediaContainerClassName
  }, children2), import_react210.default.createElement("div", {
    className: infoContainerClassName
  }, import_react210.default.createElement(Card.Section, null, popoverActionsMarkup, import_react210.default.createElement(Stack, {
    vertical: true,
    spacing: "tight"
  }, headerMarkup, import_react210.default.createElement("p", {
...
var NavigationContext = (0, import_react211.createContext)({
  location: ""
});
...
function Secondary({
  ...
  return import_react212.default.createElement(Collapsible, {
    id: id || uid,
    open: expanded,
    transition: {
      duration: "0ms",
  ...
  }, import_react212.default.createElement("ul", {
...
function Item8({
  ...
  const {
    location,
    onNavigationDismiss
  } = (0, import_react213.useContext)(NavigationContext);
  const [keyFocused, setKeyFocused] = (0, import_react213.useState)(false);
  ...
  const handleKeyUp = (0, import_react213.useCallback)((event) => {
    if (event.keyCode === Key.Tab) {
      !keyFocused && setKeyFocused(true);
    }
  }, [keyFocused]);
  const handleBlur = (0, import_react213.useCallback)(() => {
  ...
  const indicatorMarkup = hasNewChild ? import_react213.default.createElement("span", {
    className: styles96.Indicator
  }, import_react213.default.createElement(Indicator, {
    pulse: true
  })) : null;
  const iconMarkup = icon ? import_react213.default.createElement("div", {
    className: classNames(styles96.Icon, shouldResizeIcon && styles96["Icon-resized"])
  }, import_react213.default.createElement(Icon, {
    source: icon
  })) : null;
  let badgeMarkup = null;
  if (isNew) {
    badgeMarkup = import_react213.default.createElement(Badge, {
      status: "new",
      size: "small"
  ...
  const wrappedBadgeMarkup = badgeMarkup == null ? null : import_react213.default.createElement("div", {
    className: styles96.Badge
  }, badgeMarkup);
  const itemContentMarkup = import_react213.default.createElement(import_react213.default.Fragment, null, iconMarkup, import_react213.default.createElement("span", {
  ...
  if (url == null) {
    ...
    return import_react213.default.createElement("li", {
      className: styles96.ListItem
    }, import_react213.default.createElement("button", {
      type: "button",
  ...
  const secondaryActionLinkMarkup = secondaryAction && import_react213.default.createElement(UnstyledLink, {
    external: true,
  ...
  const secondaryActionMarkup = secondaryAction && (secondaryAction.tooltip ? import_react213.default.createElement(Tooltip, secondaryAction.tooltip, secondaryActionLinkMarkup) : secondaryActionLinkMarkup);
  ...
  if (subNavigationItems.length > 0) {
    ...
    secondaryNavigationMarkup = import_react213.default.createElement("div", {
      className: SecondaryNavigationClassName
    }, import_react213.default.createElement(Secondary, {
      ...
      return import_react213.default.createElement(Item8, Object.assign({
        key: label2
      }, rest, {
        label: label2,
  ...
  }, import_react213.default.createElement(UnstyledLink, Object.assign({
    url,
...
function Section7({
  ...
  const animationFrame = (0, import_react214.useRef)(null);
  const {
    isNavigationCollapsed
  } = useMediaQuery();
  const [expandedIndex, setExpandedIndex] = (0, import_react214.useState)();
  ...
  const buttonMarkup = action && import_react214.default.createElement("button", {
    type: "button",
    className: styles96.Action,
    "aria-label": action.accessibilityLabel,
    onClick: action.onClick
  }, import_react214.default.createElement(Icon, {
    source: action.icon
  }));
  const actionMarkup = action && (action.tooltip ? import_react214.default.createElement(Tooltip, action.tooltip, buttonMarkup) : buttonMarkup);
  const sectionHeadingMarkup = title && import_react214.default.createElement("li", {
  ...
  const itemsMarkup = items.map((item, index) => {
    ...
    return import_react214.default.createElement(Item8, Object.assign({
      key: label
    }, rest, {
      label,
      subNavigationItems,
  ...
  const toggleRollup = rollup && items.length > rollup.after && import_react214.default.createElement("div", {
    className: styles96.ListItem,
    key: "List Item"
  }, import_react214.default.createElement("button", {
    type: "button",
  ...
  const activeItemsMarkup = rollup && additionalItems.length > 0 && import_react214.default.createElement("li", {
    className: styles96.RollupSection
  }, import_react214.default.createElement(Collapsible, {
    id: additionalItemsId,
    open: expanded
  }, import_react214.default.createElement("ul", {
    className: styles96.List
  }, additionalItems)), toggleRollup);
  return import_react214.default.createElement("ul", {
    className
...
var Navigation2 = function Navigation3({
  ...
  const width = getWidth(logo, 104);
  const logoMarkup = logo ? import_react215.default.createElement("div", {
    className: classNames(styles96.LogoContainer, logoSuffix && styles96.hasLogoSuffix)
  }, import_react215.default.createElement(UnstyledLink, {
    url: logo.url || "",
    className: styles96.LogoLink,
    style: {
      width
    }
  }, import_react215.default.createElement(Image, {
  ...
  const mediaMarkup = contextControl ? import_react215.default.createElement("div", {
    className: styles96.ContextControl
  }, contextControl) : logoMarkup;
  const context = (0, import_react215.useMemo)(() => ({
    location,
    onNavigationDismiss: onDismiss
  }), [location, onDismiss]);
  return import_react215.default.createElement(NavigationContext.Provider, {
    value: context
  }, import_react215.default.createElement(WithinContentContext.Provider, {
    value: true
  }, import_react215.default.createElement("nav", {
    className: styles96.Navigation,
    "aria-labelledby": ariaLabelledBy
  }, mediaMarkup, import_react215.default.createElement(Scrollable, {
...
function Checkbox5({
  ...
  const id = useUniqueId("Checkbox", idProp);
  const [keyFocused, setKeyFocused] = (0, import_react216.useState)(false);
  ...
  return import_react216.default.createElement("div", {
    className
  }, import_react216.default.createElement("input", {
    id,
    name,
    value,
    type: "checkbox",
  ...
  }, import_react216.default.createElement(Icon, {
...
function Option3({
  ...
  const handleClick = (0, import_react217.useCallback)(() => {
    if (disabled) {
      return;
    }
    onClick(section, index);
  }, [disabled, index, onClick, section]);
  const mediaMarkup = media ? import_react217.default.createElement("div", {
  ...
  const optionMarkup = allowMultiple ? import_react217.default.createElement("label", {
    htmlFor: id,
    className: multiSelectClassName
  }, import_react217.default.createElement("div", {
    className: styles98.Checkbox
  }, import_react217.default.createElement(Checkbox5, {
    id,
    value,
    checked: select,
    active,
    ...
    role: checkBoxRole
  })), mediaMarkup, label) : import_react217.default.createElement("button", {
    id,
    type: "button",
  ...
  const scrollMarkup = active ? import_react217.default.createElement(Scrollable.ScrollTo, null) : null;
  return import_react217.default.createElement("li", {
    key: id,
...
function OptionList({
  ...
  const [normalizedOptions, setNormalizedOptions] = (0, import_react218.useState)(createNormalizedOptions(options, sections, title));
  ...
  const handleClick = (0, import_react218.useCallback)((sectionIndex, optionIndex) => {
  ...
  const optionsMarkup = optionsExist ? normalizedOptions.map(({
    ...
    const titleMarkup = title2 ? import_react218.default.createElement("p", {
    ...
    const optionsMarkup2 = options2 && options2.map((option, optionIndex) => {
      ...
      return import_react218.default.createElement(Option3, Object.assign({
        key: optionId
      }, option, {
        id: optionId,
    ...
    return import_react218.default.createElement("li", {
      key: title2 || `noTitle-${sectionIndex}`
    }, titleMarkup, import_react218.default.createElement("ul", {
      className: styles97.Options,
      id: `${id}-${sectionIndex}`,
      role
    }, optionsMarkup2));
  }) : null;
  return import_react218.default.createElement("ul", {
...
function isInterface(x) {
  return !(0, import_react219.isValidElement)(x) && x !== void 0;
}
...
function isReactElement(x) {
  return (0, import_react220.isValidElement)(x) && x !== void 0;
}
...
function Pagination({
  ...
  const i18n = useI18n();
  const node = (0, import_react221.createRef)();
  ...
  const prev = import_react221.default.createElement(Button, {
    outline: true,
    icon: SvgChevronLeftMinor,
  ...
  const constructedPrevious = previousTooltip && hasPrevious ? import_react221.default.createElement(Tooltip, {
    activatorWrapper: "span",
    content: previousTooltip
  }, prev) : prev;
  const next = import_react221.default.createElement(Button, {
    outline: true,
    icon: SvgChevronRightMinor,
  ...
  const constructedNext = nextTooltip && hasNext ? import_react221.default.createElement(Tooltip, {
    activatorWrapper: "span",
    content: nextTooltip
  }, next) : next;
  const previousHandler = onPrevious || noop11;
  const previousButtonEvents = previousKeys && (previousURL || onPrevious) && hasPrevious && previousKeys.map((key) => import_react221.default.createElement(KeypressListener, {
    key,
    keyCode: key,
    handler: previousURL ? handleCallback(clickPaginationLink("previousURL", node)) : handleCallback(previousHandler)
  }));
  const nextHandler = onNext || noop11;
  const nextButtonEvents = nextKeys && (nextURL || onNext) && hasNext && nextKeys.map((key) => import_react221.default.createElement(KeypressListener, {
    key,
    keyCode: key,
    handler: nextURL ? handleCallback(clickPaginationLink("nextURL", node)) : handleCallback(nextHandler)
  }));
  const labelTextMarkup = hasNext && hasPrevious ? import_react221.default.createElement(TextStyle, null, label) : import_react221.default.createElement(TextStyle, {
    variation: "subdued"
  }, label);
  const labelMarkup = label ? import_react221.default.createElement("div", {
    "aria-live": "polite"
  }, labelTextMarkup) : null;
  return import_react221.default.createElement("nav", {
    "aria-label": navLabel,
    ref: node
  }, previousButtonEvents, nextButtonEvents, import_react221.default.createElement(ButtonGroup, {
    segmented: !label
...
function Title({
  ...
  const titleMarkup = title ? import_react222.default.createElement("h1", {
    className
  }, title) : null;
  const titleMetadataMarkup = titleMetadata ? import_react222.default.createElement("div", {
    className: styles102.TitleMetadata
  }, titleMetadata) : null;
  const wrappedTitleMarkup = titleMetadata ? import_react222.default.createElement("div", {
    className: styles102.TitleWithMetadataWrapper
  }, titleMarkup, titleMetadataMarkup) : titleMarkup;
  const subtitleMarkup = subtitle ? import_react222.default.createElement("div", {
    className: classNames(styles102.SubTitle, compactTitle && styles102.SubtitleCompact)
  }, import_react222.default.createElement("p", null, subtitle)) : null;
  return import_react222.default.createElement(import_react222.default.Fragment, null, wrappedTitleMarkup, subtitleMarkup);
}
...
function Header4({
  ...
  const breadcrumbMarkup = breadcrumbs.length > 0 ? import_react223.default.createElement("div", {
    className: styles101.BreadcrumbWrapper
  }, import_react223.default.createElement(Breadcrumbs, {
    breadcrumbs
  })) : null;
  const paginationMarkup = pagination && !isNavigationCollapsed ? import_react223.default.createElement("div", {
    className: styles101.PaginationWrapper
  }, import_react223.default.createElement(Pagination, pagination)) : null;
  const additionalNavigationMarkup = additionalNavigation ? import_react223.default.createElement("div", {
    className: styles101.AdditionalNavigationWrapper
  }, additionalNavigation) : null;
  const navigationMarkup = breadcrumbMarkup || paginationMarkup || additionalNavigationMarkup ? import_react223.default.createElement("div", {
    className: styles101.Navigation
  }, breadcrumbMarkup, additionalNavigationMarkup, paginationMarkup) : null;
  const pageTitleMarkup = import_react223.default.createElement("div", {
    className: styles101.TitleWrapper
  }, import_react223.default.createElement(Title, {
    title,
    subtitle,
    titleMetadata,
    compactTitle
  }));
  const primaryActionMarkup = primaryAction ? import_react223.default.createElement(PrimaryActionMarkup, {
    primaryAction
  }) : null;
  let actionMenuMarkup = null;
  if (isInterface(secondaryActions) && (secondaryActions.length > 0 || hasGroupsWithActions(actionGroups))) {
    actionMenuMarkup = import_react223.default.createElement(ActionMenu, {
    ...
    actionMenuMarkup = import_react223.default.createElement(import_react223.default.Fragment, null, secondaryActions);
  }
  const additionalMetadataMarkup = additionalMetadata ? import_react223.default.createElement("div", {
    className: styles101.AdditionalMetaData
  }, import_react223.default.createElement(TextStyle, {
    variation: "subdued"
  ...
  }, import_react223.default.createElement(ConditionalRender, {
    condition: [slot1, slot2, slot3, slot4].some(notNull)
  }, import_react223.default.createElement("div", {
    className: styles101.Row
  }, slot1, slot2, import_react223.default.createElement(ConditionalRender, {
    condition: [slot3, slot4].some(notNull)
  }, import_react223.default.createElement("div", {
    className: styles101.RightAlign
  }, import_react223.default.createElement(ConditionalWrapper, {
    condition: [slot3, slot4].every(notNull),
    wrapper: (children2) => import_react223.default.createElement("div", {
      className: styles101.Actions
    }, children2)
  }, slot3, slot4))))), import_react223.default.createElement(ConditionalRender, {
    condition: [slot5, slot6].some(notNull)
  }, import_react223.default.createElement("div", {
    className: styles101.Row
  }, import_react223.default.createElement("div", {
    className: styles101.LeftAlign
  }, slot5), import_react223.default.createElement(ConditionalRender, {
...
function PrimaryActionMarkup({
  ...
  if (isInterface(primaryAction)) {
    ...
    actionMarkup = helpText ? import_react223.default.createElement(Tooltip, {
      content: helpText
    }, content) : content;
  }
  return import_react223.default.createElement("div", {
  ...
  const layouts = {
    ...
    desktopDefault: {
      slots: {
        slot1: breadcrumbMarkup,
        slot2: pageTitleMarkup,
        slot3: import_react223.default.createElement(import_react223.default.Fragment, null, actionMenuMarkup, primaryActionMarkup),
...
function Page({
  ...
  const headerMarkup = hasHeaderContent ? import_react224.default.createElement(Header4, rest) : null;
  return import_react224.default.createElement("div", {
    className: pageClassName
  }, headerMarkup, import_react224.default.createElement("div", {
...
function PageActions({
  ...
  if (isReactElement(primaryAction)) {
    primaryActionMarkup = import_react225.default.createElement(import_react225.default.Fragment, null, primaryAction);
  ...
  if (isInterface(secondaryActions) && secondaryActions.length > 0) {
    secondaryActionsMarkup = import_react225.default.createElement(ButtonGroup, null, buttonsFrom(secondaryActions));
  } else if (isReactElement(secondaryActions)) {
    secondaryActionsMarkup = import_react225.default.createElement(import_react225.default.Fragment, null, secondaryActions);
  }
  ...
  }, import_react225.default.createElement(Stack, {
    distribution,
    spacing: "tight"
...
function PolarisTestProvider({
  ...
  const Wrapper = strict ? import_react226.StrictMode : import_react226.Fragment;
  const intl = (0, import_react226.useMemo)(() => new I18n(i18n || {}), [i18n]);
  const scrollLockManager = (0, import_react226.useMemo)(() => new ScrollLockManager(), []);
  const stickyManager = (0, import_react226.useMemo)(() => new StickyManager(), []);
  const uniqueIdFactory = (0, import_react226.useMemo)(() => new UniqueIdFactory(globalIdGeneratorFactory), []);
  const mergedFrame = createFrameContext(frame);
  const mergedMediaQuery = merge(defaultMediaQuery, mediaQuery);
  return import_react226.default.createElement(Wrapper, null, import_react226.default.createElement(FeaturesContext.Provider, {
    value: features
  }, import_react226.default.createElement(I18nContext.Provider, {
    value: intl
  }, import_react226.default.createElement(ScrollLockManagerContext.Provider, {
    value: scrollLockManager
  }, import_react226.default.createElement(StickyManagerContext.Provider, {
    value: stickyManager
  }, import_react226.default.createElement(UniqueIdFactoryContext.Provider, {
    value: uniqueIdFactory
  }, import_react226.default.createElement(LinkContext.Provider, {
    value: link
  }, import_react226.default.createElement(MediaQueryContext.Provider, {
    value: mergedMediaQuery
  }, import_react226.default.createElement(PortalsManager, null, import_react226.default.createElement(FocusManager, null, import_react226.default.createElement(FrameContext.Provider, {
    value: mergedFrame
  }, children2)))))))))));
}
function noop12() {
...
function ProgressBar({
  ...
  return import_react227.default.createElement("div", {
    className
  }, import_react227.default.createElement("progress", {
    "aria-labelledby": ariaLabelledBy,
    className: styles104.Progress,
    value: parsedProgress,
    max: "100"
  }), import_react227.default.createElement(CSSTransition_default, {
    in: true,
    appear: true,
...
var DualThumb = class extends import_react228.Component {
  constructor(...args) {
    super(...args);
    this.context = void 0;
    this.state = {
    ...
    this.track = (0, import_react228.createRef)();
    this.trackWrapper = (0, import_react228.createRef)();
    this.thumbLower = (0, import_react228.createRef)();
    this.thumbUpper = (0, import_react228.createRef)();
  ...
  render() {
    ...
    const outputMarkupLower = !disabled && output ? import_react228.default.createElement("output", {
      htmlFor: idLower,
    ...
    }, import_react228.default.createElement("span", {
      className: styles105.OutputText
    }, value[0]))) : null;
    const outputUpperClassName = classNames(styles105.Output, styles105.OutputUpper);
    const outputMarkupUpper = !disabled && output ? import_react228.default.createElement("output", {
      htmlFor: idUpper,
    ...
    const prefixMarkup = prefix && import_react228.default.createElement("div", {
      className: styles105.Prefix
    }, prefix);
    const suffixMarkup = suffix && import_react228.default.createElement("div", {
      className: styles105.Suffix
    }, suffix);
    return import_react228.default.createElement(import_react228.default.Fragment, null, import_react228.default.createElement(Labelled, {
      id,
      label,
      error,
      action: labelAction,
    ...
    }, prefixMarkup, import_react228.default.createElement("div", {
      ...
      ref: this.thumbLower
    }), outputMarkupLower, import_react228.default.createElement("div", {
      id: idUpper,
      ...
      ref: this.thumbUpper
    }), outputMarkupUpper), suffixMarkup)), import_react228.default.createElement(EventListener, {
      event: "resize",
...
function SingleThumb(props) {
  ...
  const outputMarkup = !disabled && output && import_react229.default.createElement("output", {
    htmlFor: id,
  ...
  const prefixMarkup = prefix && import_react229.default.createElement("div", {
    className: styles106.Prefix
  }, prefix);
  const suffixMarkup = suffix && import_react229.default.createElement("div", {
  ...
  return import_react229.default.createElement(Labelled, {
    id,
    label,
    error,
    action: labelAction,
    ...
    className,
    style: cssVars
  }, prefixMarkup, import_react229.default.createElement("div", {
    className: styles106.InputWrapper
  }, import_react229.default.createElement("input", {
    type: "range",
...
function RangeSlider({
  ...
  return isDualThumb(value) ? import_react230.default.createElement(DualThumb, Object.assign({
    value
  }, sharedProps)) : import_react230.default.createElement(SingleThumb, Object.assign({
    value
  }, sharedProps));
}
...
var BaseResourceItem = class extends import_react231.Component {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.buttonOverlay = (0, import_react231.createRef)();
    this.setNode = (node) => {
      this.node = node;
    };
    this.handleFocus = (event) => {
  ...
  render() {
    ...
    if (media || selectable) {
      ownedMarkup = import_react231.default.createElement("div", {
    ...
    if (shortcutActions && !loading) {
      if (persistActions) {
        actionsMarkup = import_react231.default.createElement("div", {
          className: styles107.Actions,
          onClick: stopPropagation2
        }, import_react231.default.createElement(ButtonGroup, null, buttonsFrom(shortcutActions, {
          plain: true
        })));
        const disclosureAccessibilityLabel = name ? i18n.translate("Polaris.ResourceList.Item.actionsDropdownLabel", {
          accessibilityLabel: name
        }) : i18n.translate("Polaris.ResourceList.Item.actionsDropdown");
        disclosureMarkup = import_react231.default.createElement("div", {
          className: styles107.Disclosure,
          onClick: stopPropagation2
        }, import_react231.default.createElement(Popover2, {
          activator: import_react231.default.createElement(Button, {
        ...
        }, import_react231.default.createElement(ActionList, {
        ...
        actionsMarkup = import_react231.default.createElement("div", {
          className: styles107.Actions,
          onClick: stopPropagation2
        }, import_react231.default.createElement(ButtonGroup, {
          segmented: true
    ...
    const content = children2 ? import_react231.default.createElement("div", {
    ...
    const containerMarkup = import_react231.default.createElement("div", {
      className: containerClassName,
      id: this.props.id
    ...
    const accessibleMarkup = url ? import_react231.default.createElement(UnstyledLink, {
      ...
      tabIndex,
      id: this.overlayId
    }) : import_react231.default.createElement("button", {
...
function ResourceItem(props) {
  return import_react231.default.createElement(BaseResourceItem, Object.assign({}, props, {
    context: (0, import_react231.useContext)(ResourceListContext),
    i18n: useI18n()
  }));
}
...
function useLazyRef(initialValue) {
  const lazyRef = (0, import_react232.useRef)(UNIQUE_IDENTIFIER);
...
function Select({
  ...
  const inlineLabelMarkup = labelInline && import_react233.default.createElement("span", {
    className: styles109.InlineLabel
  }, label);
  const selectedOption = getSelectedOption(normalizedOptions, value);
  const prefixMarkup = selectedOption.prefix && import_react233.default.createElement("div", {
    className: styles109.Prefix
  }, selectedOption.prefix);
  const contentMarkup = import_react233.default.createElement("div", {
    className: styles109.Content,
    "aria-hidden": true,
    "aria-disabled": disabled
  }, inlineLabelMarkup, prefixMarkup, import_react233.default.createElement("span", {
    className: styles109.SelectedOption
  }, selectedOption.label), import_react233.default.createElement("span", {
    className: styles109.Icon
  }, import_react233.default.createElement(Icon, {
    source: SvgSelectMinor
  })));
  const optionsMarkup = normalizedOptions.map(renderOption);
  return import_react233.default.createElement(Labelled, {
    id,
    label,
    error,
    action: labelAction,
    ...
    className
  }, import_react233.default.createElement("select", {
    id,
    name,
    value,
    ...
    "aria-describedby": describedBy.length ? describedBy.join(" ") : void 0,
    "aria-required": requiredIndicator
  }, optionsMarkup), contentMarkup, import_react233.default.createElement("div", {
...
function renderSingleOption(option) {
  ...
  return import_react233.default.createElement("option", Object.assign({
    key: value,
    value
  }, rest), label);
}
function renderOption(optionOrGroup) {
  if (isGroup(optionOrGroup)) {
    ...
    return import_react233.default.createElement("optgroup", {
      label: title,
      key: title
...
var ResourceList = function ResourceList2({
  ...
  const i18n = useI18n();
  const [selectMode, setSelectMode] = (0, import_react234.useState)(Boolean(selectedItems && selectedItems.length > 0));
  const [loadingPosition, setLoadingPositionState] = (0, import_react234.useState)(0);
  const [lastSelected, setLastSelected] = (0, import_react234.useState)();
  const [smallScreen, setSmallScreen] = (0, import_react234.useState)(isBreakpointsXS2());
  const forceUpdate = (0, import_react234.useReducer)((x = 0) => x + 1, 0)[1];
  const [checkableButtons, setCheckableButtons] = (0, import_react234.useState)(/* @__PURE__ */ new Map());
  const defaultResourceName = useLazyRef(() => ({
    singular: i18n.translate("Polaris.ResourceList.defaultItemSingular"),
    plural: i18n.translate("Polaris.ResourceList.defaultItemPlural")
  }));
  const listRef = (0, import_react234.useRef)(null);
  ...
  const setLoadingPosition = (0, import_react234.useCallback)(() => {
  ...
  const bulkActionsMarkup = isSelectable ? import_react234.default.createElement("div", {
    className: styles108.BulkActionsWrapper
  }, import_react234.default.createElement(BulkActions, {
  ...
  const filterControlMarkup = filterControl ? import_react234.default.createElement("div", {
    className: styles108.FiltersWrapper
  }, filterControl) : null;
  const sortingSelectMarkup = sortOptions && sortOptions.length > 0 && !alternateTool ? import_react234.default.createElement("div", {
    className: styles108.SortWrapper
  }, import_react234.default.createElement(Select, {
  ...
  const alternateToolMarkup = alternateTool && !sortingSelectMarkup ? import_react234.default.createElement("div", {
    className: styles108.AlternateToolWrapper
  }, alternateTool) : null;
  const headerTitleMarkup = import_react234.default.createElement("div", {
    className: styles108.HeaderTitleWrapper
  }, headerTitle());
  const selectButtonMarkup = isSelectable ? import_react234.default.createElement("div", {
    className: styles108.SelectButtonWrapper
  }, import_react234.default.createElement(Button, {
    disabled: selectMode,
    icon: SvgEnableSelectionMinor,
    onClick: () => handleSelectMode(true)
  }, i18n.translate("Polaris.ResourceList.selectButtonText"))) : null;
  const checkableButtonMarkup = isSelectable ? import_react234.default.createElement("div", {
    className: styles108.CheckableButtonWrapper
  }, import_react234.default.createElement(CheckableButton, {
    accessibilityLabel: bulkActionsAccessibilityLabel(),
    label: headerTitle(),
    onToggleAll: handleToggleAll,
    plain: true,
  ...
  const headerWrapperOverlay = loading ? import_react234.default.createElement("div", {
  ...
  const headerMarkup = !showEmptyState && showHeader !== false && !showEmptySearchState && (showHeader || needsHeader) && listRef.current && import_react234.default.createElement("div", {
    className: styles108.HeaderOuterWrapper
  }, import_react234.default.createElement(Sticky, {
    ...
    return import_react234.default.createElement("div", {
      className: headerClassName
    }, import_react234.default.createElement(EventListener, {
      event: "resize",
      handler: handleResize
    }), headerWrapperOverlay, import_react234.default.createElement("div", {
  ...
  const emptySearchStateMarkup = showEmptySearchState ? emptySearchState || import_react234.default.createElement("div", {
    className: styles108.EmptySearchResultWrapper
  }, import_react234.default.createElement(EmptySearchResult, Object.assign({}, emptySearchResultText, {
    withIllustration: true
  }))) : null;
  ...
  const loadingOverlay = loading ? import_react234.default.createElement(import_react234.default.Fragment, null, import_react234.default.createElement("li", {
    className: styles108.SpinnerContainer,
    style: spinnerStyle
  }, import_react234.default.createElement(Spinner, {
    size: spinnerSize,
    accessibilityLabel: "Items are loading"
  })), import_react234.default.createElement("li", {
  ...
  const loadingWithoutItemsMarkup = loading && !itemsExist ? import_react234.default.createElement("div", {
    className,
    tabIndex: -1
  }, loadingOverlay) : null;
  ...
  const listMarkup = itemsExist ? import_react234.default.createElement("ul", {
    className: resourceListClassName,
    ref: listRef,
    "aria-live": "polite",
    "aria-busy": loading
  }, loadingOverlay, import_react234.Children.toArray(items.map(renderItemWithId))) : null;
  const context = {
  ...
  return import_react234.default.createElement(ResourceListContext.Provider, {
    value: context
...
function SettingToggle({
  ...
  const id = (0, import_react235.useMemo)(getUniqueSettingToggleId, []);
  ...
  return import_react235.default.createElement(Card, {
    sectioned: true
  }, import_react235.default.createElement(SettingAction, {
    action: actionMarkup
  }, import_react235.default.createElement("label", {
    htmlFor: id
  }, children2)));
}
...
function SkeletonBodyText({
  ...
  for (let i = 0; i < lines; i++) {
    bodyTextLines.push(import_react236.default.createElement("div", {
      className: styles110.SkeletonBodyText,
      key: i
    }));
  }
  return import_react236.default.createElement(import_react236.default.Fragment, null, bodyTextLines);
}
...
function SkeletonPage({
  ...
  const titleContent = title ? import_react238.default.createElement("h1", {
    className: styles112.Title
  }, title) : import_react238.default.createElement("div", {
    className: styles112.SkeletonTitle
  });
  const titleMarkup = import_react238.default.createElement("div", {
    className: styles112.TitleWrapper
  }, titleContent);
  const primaryActionMarkup = primaryAction ? import_react238.default.createElement("div", {
    className: styles112.PrimaryAction
  }, import_react238.default.createElement(SkeletonDisplayText, {
    size: "large"
  })) : null;
  const breadcrumbMarkup = breadcrumbs ? import_react238.default.createElement("div", {
    className: styles112.BreadcrumbAction,
    style: {
      width: 60
    }
  }, import_react238.default.createElement(SkeletonBodyText, {
    lines: 1
  })) : null;
  ...
  }, import_react238.default.createElement("div", {
    className: styles112.Header
  }, breadcrumbMarkup, import_react238.default.createElement("div", {
    className: styles112.TitleAndPrimaryAction
  }, titleMarkup, primaryActionMarkup)), import_react238.default.createElement("div", {
...
function SkeletonTabs({
  ...
  return import_react239.default.createElement("div", {
    ...
    }, import_react239.default.createElement(SkeletonBodyText, {
      lines: 1
    }));
  }));
}
...
function Tab({
  ...
  const wasSelected = (0, import_react242.useRef)(selected);
  const panelFocused = (0, import_react242.useRef)(false);
  const node = (0, import_react242.useRef)(null);
  ...
  const markup = url ? import_react242.default.createElement(UnstyledLink, {
    id,
    url,
    role: "tab",
    tabIndex,
  ...
  }, children2)) : import_react242.default.createElement("button", {
    id,
    role: "tab",
    type: "button",
    tabIndex,
...
// node_modules/@shopify/polaris/build/esm/components/Tabs/components/TabMeasurer/TabMeasurer.js
var TabMeasurer = (0, import_react243.memo)(function TabMeasurer2({
  selected,
  tabs,
  activator,
  tabToFocus,
  ...
  const containerNode = (0, import_react243.useRef)(null);
  const animationFrame = (0, import_react243.useRef)(null);
  const handleMeasurement = (0, import_react243.useCallback)(() => {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
    animationFrame.current = requestAnimationFrame(() => {
  ...
  const tabsMarkup = tabs.map((tab, index) => {
    return import_react243.default.createElement(Tab, {
      measuring: true,
  ...
  return import_react243.default.createElement("div", {
    className: classname,
    ref: containerNode
  }, import_react243.default.createElement(EventListener, {
    event: "resize",
...
var Item9 = class extends import_react244.PureComponent {
  constructor(...args) {
    super(...args);
    this.context = void 0;
  ...
  render() {
    ...
    const markup = url ? import_react244.default.createElement(UnstyledLink, Object.assign({}, sharedProps, {
      url
    }), children2) : import_react244.default.createElement("button", Object.assign({}, sharedProps, {
      type: "button"
    }), children2);
    return import_react244.default.createElement("li", null, markup);
  }
};
...
function List3({
  ...
  const tabs = disclosureTabs.map(({
    ...
    return import_react245.default.createElement(Item9, Object.assign({
      key: id
    }, tabProps, {
      id,
  ...
  return import_react245.default.createElement("ul", {
...
// node_modules/@shopify/polaris/build/esm/components/Tabs/Tabs.js
var TabsInner = class extends import_react246.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      disclosureWidth: 0,
    ...
    this.renderTabMarkup = (tab, index) => {
      ...
      return import_react246.default.createElement(Tab, {
        key: `${index}-${tab.id}`,
        id: tab.id,
  ...
  render() {
    ...
    const panelMarkup = children2 ? tabs.map((_tab, index) => {
      return selected === index ? import_react246.default.createElement(Panel, {
        id: tabs[index].panelID || `${tabs[index].id}-panel`,
        tabID: tabs[index].id,
        key: tabs[index].id
      }, children2) : import_react246.default.createElement(Panel, {
        id: tabs[index].panelID || `${tabs[index].id}-panel`,
        tabID: tabs[index].id,
        key: tabs[index].id,
        hidden: true
    ...
    const disclosureButtonContent = hasCustomDisclosure ? import_react246.default.createElement(import_react246.default.Fragment, null, disclosureText, import_react246.default.createElement(Icon, {
      source: SvgCaretDownMinor,
      color: "subdued"
    })) : import_react246.default.createElement(Icon, {
      source: SvgHorizontalDotsMinor,
      color: "subdued"
    });
    const disclosureButton = import_react246.default.createElement("button", {
      type: "button",
    ...
    const activator = disclosureText ? import_react246.default.createElement("div", {
      className: styles115.TabContainer
    }, disclosureButton) : disclosureButton;
    return import_react246.default.createElement("div", null, import_react246.default.createElement("div", {
      className: styles115.Wrapper
    }, import_react246.default.createElement(TabMeasurer, {
      tabToFocus,
      activator,
      selected,
      tabs,
    ...
    }, tabsMarkup, import_react246.default.createElement("li", {
      className: disclosureTabClassName,
      role: "presentation"
    }, import_react246.default.createElement(Popover2, {
      preferredPosition: "below",
      activator,
      active: disclosureActivatorVisible && showDisclosure,
      onClose: this.handleClose,
      autofocusTarget: "first-node"
    }, import_react246.default.createElement(List3, {
...
function Tabs(props) {
  const i18n = useI18n();
  return import_react246.default.createElement(TabsInner, Object.assign({}, props, {
    i18n
  }));
}
...
var Text = ({
  ...
  return import_react247.default.createElement(Component9, {
    className
  }, children2);
};
...
function Thumbnail({
  ...
  const content = typeof source === "string" ? import_react248.default.createElement(Image, {
    alt,
    source
  }) : import_react248.default.createElement(Icon, {
    accessibilityLabel: alt,
    source
  });
  return import_react248.default.createElement("span", {
    className
  }, content);
}
...
var Toast2 = (0, import_react249.memo)(function Toast3(props) {
...
function SearchDismissOverlay({
  ...
  const node = (0, import_react250.useRef)(null);
  const handleDismiss = (0, import_react250.useCallback)(({
    target
  }) => {
  ...
  return import_react250.default.createElement(import_react250.default.Fragment, null, visible ? import_react250.default.createElement(ScrollLock, null) : null, import_react250.default.createElement("div", {
    ref: node,
...
function Search({
  ...
  const overlayMarkup = visible ? import_react251.default.createElement(SearchDismissOverlay, {
    onDismiss,
    visible: overlayVisible
  }) : null;
  return import_react251.default.createElement(import_react251.default.Fragment, null, overlayMarkup, import_react251.default.createElement("div", {
...
function SearchField({
  ...
  const i18n = useI18n();
  const [forceActive, setForceActive] = (0, import_react252.useState)(false);
  const input = (0, import_react252.useRef)(null);
  const searchId = useUniqueId("SearchField");
  const handleChange = (0, import_react252.useCallback)(({
    currentTarget
  }) => {
    onChange(currentTarget.value);
  }, [onChange]);
  const handleFocus = (0, import_react252.useCallback)(() => onFocus && onFocus(), [onFocus]);
  const handleBlur = (0, import_react252.useCallback)(() => onBlur && onBlur(), [onBlur]);
  const handleClear = (0, import_react252.useCallback)(() => {
    onCancel && onCancel();
    if (!input.current) {
      return;
    }
  ...
  const clearMarkup = value !== "" && import_react252.default.createElement("button", {
    type: "button",
  ...
  }, import_react252.default.createElement(Icon, {
    source: SvgCircleCancelMinor
  }));
  const className = classNames(styles121.SearchField, (focused || active || forceActive) && styles121.focused);
  return import_react252.default.createElement("div", {
    className,
    onFocus: handleFocus,
    onBlur: handleBlur
  }, import_react252.default.createElement(VisuallyHidden, null, import_react252.default.createElement("label", {
    htmlFor: searchId
  }, i18n.translate("Polaris.TopBar.SearchField.search"))), import_react252.default.createElement("input", {
    id: searchId,
  ...
  }), import_react252.default.createElement("span", {
    className: styles121.Icon
  }, import_react252.default.createElement(Icon, {
    source: SvgSearchMinor
  })), clearMarkup, import_react252.default.createElement("div", {
...
function MessageIndicator({
  ...
  const indicatorMarkup = active && import_react253.default.createElement("div", {
...
function Message({
  ...
  const badgeMarkup = badge && import_react254.default.createElement(Badge, {
    status: badge.status
  }, badge.content);
  const {
    to,
  ...
  }, import_react254.default.createElement(Popover2.Section, null, import_react254.default.createElement(Stack, {
    vertical: true,
    spacing: "tight"
  }, import_react254.default.createElement(TextContainer, null, import_react254.default.createElement(Heading, null, title, badgeMarkup), import_react254.default.createElement("p", null, description)), import_react254.default.createElement(Link, {
    url: to
  }, linkContent), import_react254.default.createElement(Button, {
    plain: true,
    onClick
  }, actionContent))));
}
...
function Menu(props) {
  ...
  const messageMarkup = message && import_react255.default.createElement(Message, {
    title: message.title,
  ...
  return import_react255.default.createElement(Popover2, {
    activator: import_react255.default.createElement("div", {
...
function UserMenu({
  ...
  const activatorContentMarkup = import_react256.default.createElement(import_react256.default.Fragment, null, import_react256.default.createElement(MessageIndicator, {
    active: showIndicator
  }, import_react256.default.createElement(Avatar, {
    size: "small",
    source: avatar,
    initials: initials && initials.replace(" ", "")
  })), import_react256.default.createElement("span", {
    className: styles122.Details
  }, import_react256.default.createElement("p", {
    className: styles122.Name
  }, name), import_react256.default.createElement("p", {
    className: styles122.Detail
  }, detail)));
  return import_react256.default.createElement(Menu, {
...
var TopBar = function TopBar2({
  ...
  const navigationButtonMarkup = showNavigationToggle ? import_react257.default.createElement("button", {
    type: "button",
    className: iconClassName,
  ...
  }, import_react257.default.createElement(Icon, {
    source: SvgMobileHamburgerMajor
  }))) : null;
  const width = getWidth(logo, 104);
  let contextMarkup;
  if (contextControl) {
    contextMarkup = import_react257.default.createElement("div", {
  ...
  const searchMarkup = searchField ? import_react257.default.createElement(import_react257.default.Fragment, null, searchField, import_react257.default.createElement(Search, {
  ...
  }, navigationButtonMarkup, contextMarkup, import_react257.default.createElement("div", {
    className: styles118.Contents
  }, import_react257.default.createElement("div", {
    className: styles118.SearchField
  }, searchMarkup), import_react257.default.createElement("div", {
...
function VideoThumbnail({
  ...
  const timeStampMarkup = videoLength ? import_react258.default.createElement("p", {
  ...
  if (showVideoProgress) {
    ...
    progressMarkup = import_react258.default.createElement("div", {
      className: styles126.Progress
    }, import_react258.default.createElement("progress", {
  ...
  }, import_react258.default.createElement("img", {
...
function useRowHovered() {
  const hovered = (0, import_react259.useContext)(RowHoveredContext);
  return hovered;
}
function useRowSelected() {
  const {
    selected
  } = (0, import_react259.useContext)(RowContext);
  return selected;
}
function useContainerScroll() {
  const scrolledContainerRef = (0, import_react259.useContext)(ScrollContext);
