...
var StickyManager = class {
  ...
  evaluateStickyItem(stickyItem, scrollTop, containerTop) {
    ...
    const stickyOffset = offset ? this.getOffset(stickyNode) + parseInt(spacing2["space-5"], 10) : this.getOffset(stickyNode);
...
var PortalsManagerContext = (0, import_react15.createContext)(void 0);
...
var PortalsContainer = (0, import_react16.forwardRef)(PortalsContainerComponent);
...
function PortalsManager({
  ...
  const [portalContainerElement, setPortalContainerElement] = (0, import_react17.useState)(null);
  ...
  return import_react17.default.createElement(PortalsManagerContext.Provider, {
    value: contextValue
  }, children2, container ? null : import_react17.default.createElement(PortalsContainer, {
...
var FocusManagerContext = (0, import_react18.createContext)(void 0);
...
function FocusManager({
  ...
  return import_react19.default.createElement(FocusManagerContext.Provider, {
    value
  }, children2);
}
...
var AppProvider = class extends import_react20.Component {
  ...
  render() {
    ...
    return import_react20.default.createElement(FeaturesContext.Provider, {
      value: features
    }, import_react20.default.createElement(I18nContext.Provider, {
      value: intl
    }, import_react20.default.createElement(ScrollLockManagerContext.Provider, {
      value: this.scrollLockManager
    }, import_react20.default.createElement(StickyManagerContext.Provider, {
      value: this.stickyManager
    }, import_react20.default.createElement(UniqueIdFactoryContext.Provider, {
      value: this.uniqueIdFactory
    }, import_react20.default.createElement(LinkContext.Provider, {
      value: link
    }, import_react20.default.createElement(MediaQueryProvider, null, import_react20.default.createElement(PortalsManager, null, import_react20.default.createElement(FocusManager, null, children2)))))))));
  }
};
...
// node_modules/@shopify/polaris/build/esm/components/AccountConnection/AccountConnection.scss.js
var styles = {
...
function useToggle(initialState) {
  const [value, setState] = (0, import_react21.useState)(initialState);
  return {
    value,
    toggle: (0, import_react21.useCallback)(() => setState((state) => !state), []),
    setTrue: (0, import_react21.useCallback)(() => setState(true), []),
    setFalse: (0, import_react21.useCallback)(() => setState(false), [])
  };
}
...
function useDisableClick(disabled, handleClick) {
  const handleClickWrapper = (0, import_react459.useCallback)((event) => {
    if (disabled) {
...
function useIsAfterInitialMount() {
  const [isAfterInitialMount, setIsAfterInitialMount] = (0, import_react460.useState)(false);
...
function VisuallyHidden({
  ...
  return import_react461.default.createElement("span", {
    className: styles5.VisuallyHidden
  }, children2);
}
...
function Spinner({
  ...
  const spinnerSVGMarkup = size === "large" ? import_react462.default.createElement("svg", {
    viewBox: "0 0 44 44",
    xmlns: "http://www.w3.org/2000/svg"
  }, import_react462.default.createElement("path", {
    d: "M15.542 1.487A21.507 21.507 0 00.5 22c0 11.874 9.626 21.5 21.5 21.5 9.847 0 18.364-6.675 20.809-16.072a1.5 1.5 0 00-2.904-.756C37.803 34.755 30.473 40.5 22 40.5 11.783 40.5 3.5 32.217 3.5 22c0-8.137 5.3-15.247 12.942-17.65a1.5 1.5 0 10-.9-2.863z"
  })) : import_react462.default.createElement("svg", {
    viewBox: "0 0 20 20",
    xmlns: "http://www.w3.org/2000/svg"
  }, import_react462.default.createElement("path", {
  ...
  const accessibilityLabelMarkup = (isAfterInitialMount || !hasFocusableParent) && import_react462.default.createElement(VisuallyHidden, null, accessibilityLabel);
  return import_react462.default.createElement(import_react462.default.Fragment, null, import_react462.default.createElement("span", {
    className
  }, spinnerSVGMarkup), import_react462.default.createElement("span", spanAttributes, accessibilityLabelMarkup));
}
...
function usePortalsManager() {
  const portalsManager = (0, import_react463.useContext)(PortalsManagerContext);
  if (!portalsManager) {
...
function useUniqueId(prefix = "", overrideId = "") {
  const idFactory = (0, import_react464.useContext)(UniqueIdFactoryContext);
  const uniqueIdRef = (0, import_react464.useRef)(null);
  if (!idFactory) {
...
function Portal({
  ...
  return container ? (0, import_react_dom.createPortal)(import_react465.default.createElement("div", {
...
function wrapWithComponent(element, Component9, props) {
  ...
  return isElementOfType(element, Component9) ? element : import_react466.default.createElement(Component9, props, element);
}
...
function isElementOfType(element, Component9) {
  var _element$props;
  if (element == null || !(0, import_react466.isValidElement)(element) || typeof element.type === "string") {
    return false;
  }
  const {
    type: defaultType
...
function elementChildren(children2, predicate = () => true) {
  return import_react466.Children.toArray(children2).filter((child) => (0, import_react466.isValidElement)(child) && predicate(child));
}
...
function KeypressListener({
  ...
  const tracked = (0, import_react467.useRef)({
    handler,
    keyCode
  });
  useIsomorphicLayoutEffect(() => {
  ...
  const handleKeyEvent = (0, import_react467.useCallback)((event) => {
    const {
      handler: handler2,
      keyCode: keyCode2
    } = tracked.current;
...
var ScrollableContext = (0, import_react468.createContext)(void 0);
...
function ScrollTo() {
  const anchorNode = (0, import_react469.useRef)(null);
  const scrollToPosition = (0, import_react469.useContext)(ScrollableContext);
  ...
  return import_react469.default.createElement("a", {
    id,
    ref: anchorNode
  });
}
...
var Scrollable = class extends import_react470.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      topShadow: false,
  ...
  render() {
    ...
    const finalClassName = classNames(className, styles8.Scrollable, vertical && styles8.vertical, horizontal && styles8.horizontal, topShadow && styles8.hasTopShadow, bottomShadow && styles8.hasBottomShadow, vertical && canScroll && styles8.verticalHasScrolling);
    return import_react470.default.createElement(ScrollableContext.Provider, {
      value: this.scrollToPosition
    }, import_react470.default.createElement(StickyManagerContext.Provider, {
      value: this.stickyManager
    }, import_react470.default.createElement("div", Object.assign({
...
var PositionedOverlay = class extends import_react471.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      measuring: true,
  ...
  render() {
    ...
    return import_react471.default.createElement("div", {
      className,
      style,
      ref: this.setOverlay
    }, import_react471.default.createElement(EventListener, {
      event: "resize",
...
function Section({
  ...
  return import_react472.default.createElement("div", {
...
function Pane({
  ...
  const className = classNames(styles6.Pane, fixed && styles6["Pane-fixed"]);
  ...
  return fixed ? import_react473.default.createElement("div", {
    style,
    className
  }, content) : import_react473.default.createElement(Scrollable, {
    shadow: true,
    className,
    style,
    onScrolledToBottom
...
var PopoverOverlay = class extends import_react474.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      transitionStatus: this.props.active ? TransitionStatus.Entering : TransitionStatus.Exited
    };
    this.contentNode = (0, import_react474.createRef)();
    ...
    this.renderPopover = (overlayDetails) => {
      ...
      const content = import_react474.default.createElement("div", {
        id,
      ...
      return import_react474.default.createElement("div", Object.assign({
        className
      }, overlay.props), import_react474.default.createElement(EventListener, {
        event: "click",
        handler: this.handleClick
      }), import_react474.default.createElement(EventListener, {
        event: "touchstart",
        handler: this.handleClick
      }), import_react474.default.createElement(KeypressListener, {
        keyCode: Key.Escape,
        handler: this.handleEscape
      }), import_react474.default.createElement("div", {
        className: styles6.FocusTracker,
        tabIndex: 0,
        onFocus: this.handleFocusFirstItem
      }), import_react474.default.createElement("div", {
        className: styles6.Wrapper
      }, content), import_react474.default.createElement("div", {
        className: styles6.FocusTracker,
        tabIndex: 0,
    ...
    this.overlayRef = (0, import_react474.createRef)();
  }
  forceUpdatePosition() {
  ...
  render() {
    ...
    return import_react474.default.createElement(PositionedOverlay, {
      ref: this.overlayRef,
      fullWidth,
      active,
      activator,
...
function renderPopoverContent(children2, props) {
  const childrenArray = import_react474.Children.toArray(children2);
...
// node_modules/@shopify/polaris/build/esm/components/Popover/Popover.js
var PopoverComponent = (0, import_react475.forwardRef)(function Popover({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react475.useState)();
  const overlayRef = (0, import_react475.useRef)(null);
  const activatorContainer = (0, import_react475.useRef)(null);
  ...
  (0, import_react475.useImperativeHandle)(ref, () => {
    return {
      forceUpdatePosition
    };
  });
  const setAccessibilityAttributes = (0, import_react475.useCallback)(() => {
  ...
  const portal2 = activatorNode ? import_react475.default.createElement(Portal, {
    idPrefix: "popover"
  }, import_react475.default.createElement(PopoverOverlay, Object.assign({
    ref: overlayRef,
    id,
  ...
  return import_react475.default.createElement(WrapperComponent, {
    ref: activatorContainer
  }, import_react475.Children.only(activator), portal2);
});
...
function TextStyle({
  ...
  const className = classNames(variation && styles10[variationName("variation", variation)], variation === VariationValue.Code && styles10.code);
  const Element2 = variationElement(variation);
  return import_react476.default.createElement(Element2, {
    className
  }, children2);
}
...
var WithinFilterContext = (0, import_react477.createContext)(false);
...
function useI18n() {
  const i18n = (0, import_react478.useContext)(I18nContext);
  if (!i18n) {
...
function Pip({
  ...
  return import_react479.default.createElement("span", {
    className
  }, import_react479.default.createElement(VisuallyHidden, null, accessibilityLabel));
}
...
function Icon({
  ...
  const className = classNames(styles13.Icon, color && styles13[variationName("color", color)], color && styles13.applyColor, backdrop && styles13.hasBackdrop);
  const SourceComponent = source;
  const contentMarkup = {
    function: import_react480.default.createElement(SourceComponent, {
      className: styles13.Svg,
      focusable: "false",
      "aria-hidden": "true"
    }),
    placeholder: import_react480.default.createElement("div", {
      className: styles13.Placeholder
    }),
    external: import_react480.default.createElement("img", {
      className: styles13.Img,
      src: `data:image/svg+xml;utf8,${source}`,
      alt: "",
      "aria-hidden": "true"
    })
  };
  return import_react480.default.createElement("span", {
    className
  }, import_react480.default.createElement(VisuallyHidden, null, accessibilityLabel), contentMarkup[sourceType]);
}
...
function Badge({
  ...
  const i18n = useI18n();
  const withinFilter = (0, import_react481.useContext)(WithinFilterContext);
  const className = classNames(styles11.Badge, status && styles11[variationName("status", status)], icon && styles11.icon, size && size !== DEFAULT_SIZE && styles11[variationName("size", size)], withinFilter && styles11.withinFilter);
  ...
  let accessibilityMarkup = Boolean(accessibilityLabel) && import_react481.default.createElement(VisuallyHidden, null, accessibilityLabel);
  if (progress && !icon) {
    accessibilityMarkup = import_react481.default.createElement("span", {
      className: styles11.PipContainer
    }, import_react481.default.createElement(Pip, {
      progress,
      status,
      accessibilityLabelOverride: accessibilityLabel
    }));
  }
  return import_react481.default.createElement("span", {
    className
  }, accessibilityMarkup, icon && import_react481.default.createElement("span", {
    className: styles11.Icon
  }, import_react481.default.createElement(Icon, {
    source: icon
  })), children2 && import_react481.default.createElement("span", null, children2));
}
Badge.Pip = Pip;
...
function useLink() {
  return (0, import_react482.useContext)(LinkContext);
}

// node_modules/@shopify/polaris/build/esm/components/UnstyledLink/UnstyledLink.js
var UnstyledLink = (0, import_react483.memo)((0, import_react483.forwardRef)(function UnstyledLink2(props, _ref) {
  const LinkComponent = useLink();
  if (LinkComponent) {
    return import_react483.default.createElement(LinkComponent, Object.assign({}, unstyled.props, props));
  }
  const {
    external,
    url,
  ...
  return import_react483.default.createElement("a", Object.assign({
    target
  }, rest, {
    href: url,
    rel
...
function Item({
  ...
  if (prefix) {
    prefixMarkup = import_react484.default.createElement("span", {
      className: styles9.Prefix
    }, prefix);
  } else if (icon) {
    prefixMarkup = import_react484.default.createElement("span", {
      className: styles9.Prefix
    }, import_react484.default.createElement(Icon, {
      source: icon
    }));
  } else if (image) {
    prefixMarkup = import_react484.default.createElement("span", {
  ...
  const contentMarkup = helpText ? import_react484.default.createElement("span", {
    className: styles9.ContentBlock
  }, import_react484.default.createElement("span", {
    className: styles9.ContentBlockInner
  }, contentText), import_react484.default.createElement(TextStyle, {
    variation: "subdued"
  }, helpText)) : contentText;
  const badgeMarkup = badge && import_react484.default.createElement("span", {
    className: styles9.Suffix
  }, import_react484.default.createElement(Badge, {
    status: badge.status
  }, badge.content));
  const suffixMarkup = suffix && import_react484.default.createElement("span", {
    className: styles9.Suffix
  }, suffix);
  const textMarkup = import_react484.default.createElement("span", {
    className: styles9.Text
  }, contentMarkup);
  const contentElement = import_react484.default.createElement("span", {
    className: styles9.Content
  }, prefixMarkup, textMarkup, badgeMarkup, suffixMarkup);
  const scrollMarkup = active ? import_react484.default.createElement(Scrollable.ScrollTo, null) : null;
  const control = url ? import_react484.default.createElement(UnstyledLink, {
    id,
    ...
    role
  }, contentElement) : import_react484.default.createElement("button", {
    id,
    type: "button",
    className,
    disabled,
  ...
  return import_react484.default.createElement(import_react484.default.Fragment, null, scrollMarkup, control);
}
...
function Section2({
  ...
  const actionMarkup = section.items.map(({
    ...
    return import_react485.default.createElement("li", {
      key: `${content}-${index}`,
      role: actionRole === "menuitem" ? "presentation" : void 0
    }, import_react485.default.createElement(Item, Object.assign({
      content,
      helpText,
      role: actionRole,
  ...
  const className = section.title ? void 0 : styles9["Section-withoutTitle"];
  const titleMarkup = section.title ? import_react485.default.createElement("p", {
  ...
  const sectionMarkup = import_react485.default.createElement("div", {
    className
  }, titleMarkup, import_react485.default.createElement("ul", {
    className: styles9.Actions,
    role: sectionRole,
    tabIndex: !hasMultipleSections ? -1 : void 0
  }, actionMarkup));
  return hasMultipleSections ? import_react485.default.createElement("li", {
    className: styles9.Section,
    role: "presentation"
...
function ActionList({
  ...
  let finalSections = [];
  const actionListRef = (0, import_react486.useRef)(null);
  if (items) {
    finalSections = [{
      items
    }, ...sections];
  ...
  const className = classNames(styles9.ActionList);
  ...
  const sectionMarkup = finalSections.map((section, index) => {
    return section.items.length > 0 ? import_react486.default.createElement(Section2, {
  ...
  const listeners = actionRole === "menuitem" ? import_react486.default.createElement(import_react486.default.Fragment, null, import_react486.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleFocusNextItem
  }), import_react486.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
    handler: handleFocusPreviousItem
  })) : null;
  return import_react486.default.createElement(Element2, {
    ref: actionListRef,
    className,
    role: elementRole,
...
function UnstyledButton({
  ...
  if (url) {
    buttonMarkup = disabled ? import_react487.default.createElement("a", commonProps, children2) : import_react487.default.createElement(UnstyledLink, Object.assign({}, interactiveProps, {
      url,
      external,
      download
    }, rest), children2);
  } else {
    buttonMarkup = import_react487.default.createElement("button", Object.assign({}, interactiveProps, {
...
function Button({
  ...
  const className = classNames(styles3.Button, primary && styles3.primary, outline && styles3.outline, destructive && styles3.destructive, isDisabled && styles3.disabled, loading && styles3.loading, plain && styles3.plain, pressed && !disabled && !url && styles3.pressed, monochrome && styles3.monochrome, size && size !== DEFAULT_SIZE2 && styles3[variationName("size", size)], textAlign && styles3[variationName("textAlign", textAlign)], fullWidth && styles3.fullWidth, icon && children2 == null && styles3.iconOnly, connectedDisclosure && styles3.connectedDisclosure, removeUnderline && styles3.removeUnderline);
  const disclosureMarkup = disclosure ? import_react488.default.createElement("span", {
    className: styles3.Icon
  }, import_react488.default.createElement("div", {
    className: classNames(styles3.DisclosureIcon, loading && styles3.hidden)
  }, import_react488.default.createElement(Icon, {
    source: loading ? "placeholder" : getDisclosureIconSource(disclosure)
  }))) : null;
  const iconSource = isIconSource(icon) ? import_react488.default.createElement(Icon, {
    source: loading ? "placeholder" : icon
  }) : icon;
  const iconMarkup = iconSource ? import_react488.default.createElement("span", {
    className: classNames(styles3.Icon, loading && styles3.hidden)
  }, iconSource) : null;
  const childMarkup = children2 ? import_react488.default.createElement("span", {
    className: classNames(styles3.Text, removeUnderline && styles3.removeUnderline),
    key: disabled ? "text-disabled" : "text"
  }, children2) : null;
  const spinnerSVGMarkup = loading ? import_react488.default.createElement("span", {
    className: styles3.Spinner
  }, import_react488.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: i18n.translate("Polaris.Button.spinnerAccessibilityLabel")
  })) : null;
  const [disclosureActive, setDisclosureActive] = (0, import_react488.useState)(false);
  const toggleDisclosureActive = (0, import_react488.useCallback)(() => {
  ...
  if (connectedDisclosure) {
    const connectedDisclosureClassName = classNames(styles3.Button, primary && styles3.primary, outline && styles3.outline, size && size !== DEFAULT_SIZE2 && styles3[variationName("size", size)], textAlign && styles3[variationName("textAlign", textAlign)], destructive && styles3.destructive, connectedDisclosure.disabled && styles3.disabled, styles3.iconOnly, styles3.ConnectedDisclosure, monochrome && styles3.monochrome);
    ...
    const connectedDisclosureActivator = import_react488.default.createElement("button", {
      type: "button",
    ...
    }, import_react488.default.createElement("span", {
      className: styles3.Icon
    }, import_react488.default.createElement(Icon, {
      source: SvgCaretDownMinor
    })));
    connectedDisclosureMarkup = import_react488.default.createElement(Popover2, {
      active: disclosureActive,
      onClose: toggleDisclosureActive,
      activator: connectedDisclosureActivator,
      preferredAlignment: "right"
    }, import_react488.default.createElement(ActionList, {
  ...
  const buttonMarkup = import_react488.default.createElement(UnstyledButton, Object.assign({}, commonProps, linkProps, actionProps), import_react488.default.createElement("span", {
    className: styles3.Content
  }, spinnerSVGMarkup, iconMarkup, childMarkup, disclosureMarkup));
  return connectedDisclosureMarkup ? import_react488.default.createElement("div", {
    className: styles3.ConnectedDisclosureWrapper
...
function buttonFrom({
  ...
  return import_react489.default.createElement(Button, Object.assign({
    key,
    onClick: onAction
...
function Item2({
  ...
  const className = classNames(styles14.Item, focused && styles14["Item-focused"], button.props.plain && styles14["Item-plain"]);
  return import_react490.default.createElement("div", {
    className,
...
function ButtonGroup({
  ...
  const className = classNames(styles14.ButtonGroup, spacing3 && styles14[spacing3], segmented && styles14.segmented, fullWidth && styles14.fullWidth);
  const contents = elementChildren(children2).map((child, index) => import_react491.default.createElement(Item2, {
    button: child,
    key: index
  }));
  return import_react491.default.createElement("div", {
    className,
...
function Item3({
  ...
  const className = classNames(styles15.Item, fill && styles15["Item-fill"]);
  return import_react492.default.createElement("div", {
    className
  }, children2);
}

// node_modules/@shopify/polaris/build/esm/components/Stack/Stack.js
var Stack = (0, import_react493.memo)(function Stack2({
  children: children2,
  vertical,
  spacing: spacing3,
  distribution,
  ...
  const className = classNames(styles15.Stack, vertical && styles15.vertical, spacing3 && styles15[variationName("spacing", spacing3)], distribution && styles15[variationName("distribution", distribution)], alignment && styles15[variationName("alignment", alignment)], wrap === false && styles15.noWrap);
  ...
  return import_react493.default.createElement("div", {
    className
  }, itemMarkup);
});
Stack.Item = Item3;
...
function Heading({
  ...
  return import_react494.default.createElement(Element2, {
    className: styles16.Heading,
    id
  }, children2);
}
...
function Header({
  ...
  const actionMarkup = actions ? import_react495.default.createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
  const titleMarkup = (0, import_react495.isValidElement)(title) ? title : import_react495.default.createElement(Heading, null, title);
  const headingMarkup = actionMarkup || children2 ? import_react495.default.createElement(Stack, {
    alignment: "baseline"
  }, import_react495.default.createElement(Stack.Item, {
    fill: true
  }, titleMarkup), actionMarkup, children2) : titleMarkup;
  return import_react495.default.createElement("div", {
...
function Subheading({
  ...
  return import_react496.default.createElement(Element2, {
    "aria-label": ariaLabel,
    className: styles17.Subheading
  }, children2);
}
...
function Section3({
  ...
  const className = classNames(styles2.Section, flush && styles2["Section-flush"], subdued && styles2["Section-subdued"], fullWidth && styles2["Section-fullWidth"], hideOnPrint && styles2["Section-hideOnPrint"]);
  const actionMarkup = actions ? import_react497.default.createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
  const titleMarkup = typeof title === "string" ? import_react497.default.createElement(Subheading, null, title) : title;
  const titleAreaMarkup = titleMarkup || actionMarkup ? import_react497.default.createElement("div", {
    className: styles2.SectionHeader
  }, actionMarkup ? import_react497.default.createElement(Stack, {
    alignment: "baseline"
  }, import_react497.default.createElement(Stack.Item, {
    fill: true
  }, titleMarkup), actionMarkup) : titleMarkup) : null;
  return import_react497.default.createElement("div", {
    className
...
function Subsection({
  ...
  return import_react498.default.createElement("div", {
    className: styles2.Subsection
  }, children2);
}
...
var Card = function Card2({
  ...
  const className = classNames(styles2.Card, subdued && styles2.subdued, hideOnPrint && styles2.hideOnPrint);
  const headerMarkup = title || actions ? import_react499.default.createElement(Header, {
    actions,
    title
  }) : null;
  const content = sectioned ? import_react499.default.createElement(Section3, null, children2) : children2;
  ...
  if (secondaryFooterActions && secondaryFooterActions.length) {
    if (secondaryFooterActions.length === 1) {
      ...
      secondaryFooterActionsMarkup = import_react499.default.createElement(import_react499.default.Fragment, null, import_react499.default.createElement(Popover2, {
        active: secondaryActionsPopoverOpen,
        activator: import_react499.default.createElement(Button, {
          disclosure: true,
      ...
      }, import_react499.default.createElement(ActionList, {
        items: secondaryFooterActions
      })));
    }
  }
  const footerMarkup = primaryFooterActionMarkup || secondaryFooterActionsMarkup ? import_react499.default.createElement("div", {
    className: classNames(styles2.Footer, footerActionAlignment === "left" && styles2.LeftJustified)
  }, footerActionAlignment === "right" ? import_react499.default.createElement(ButtonGroup, null, secondaryFooterActionsMarkup, primaryFooterActionMarkup) : import_react499.default.createElement(ButtonGroup, null, primaryFooterActionMarkup, secondaryFooterActionsMarkup)) : null;
  return import_react499.default.createElement(WithinContentContext.Provider, {
    value: true
  }, import_react499.default.createElement("div", {
    className
...
function SettingAction({
  ...
  return import_react500.default.createElement("div", {
    className: styles18.SettingAction
  }, import_react500.default.createElement("div", {
    className: styles18.Setting
  }, children2), import_react500.default.createElement("div", {
...
function Image({
  ...
  const handleLoad = (0, import_react501.useCallback)(() => {
    if (onLoad)
      onLoad();
  }, [onLoad]);
  return import_react501.default.createElement("img", Object.assign({
    alt,
    src: source,
    crossOrigin,
    className,
...
function Avatar({
  ...
  const i18n = useI18n();
  const isAfterInitialMount = useIsAfterInitialMount();
  function styleClass(name2) {
    return name2 ? STYLE_CLASSES[name2.charCodeAt(0) % STYLE_CLASSES.length] : STYLE_CLASSES[0];
  }
  const [status, setStatus] = (0, import_react502.useState)(Status.Pending);
  (0, import_react502.useEffect)(() => {
    setStatus(Status.Pending);
  }, [source]);
  const handleError = (0, import_react502.useCallback)(() => {
    setStatus(Status.Errored);
    if (onError) {
      onError();
    }
  }, [onError]);
  const handleLoad = (0, import_react502.useCallback)(() => {
  ...
  const className = classNames(styles19.Avatar, size && styles19[variationName("size", size)], hasImage && status === Status.Loaded && styles19.imageHasLoaded, shape2 && styles19[variationName("shape", shape2)], !customer && !source && styles19[variationName("style", styleClass(nameString))]);
  const imageClassName = classNames(styles19.Image, status !== Status.Loaded && styles19.hidden);
  const imageMarkUp = source && isAfterInitialMount && status !== Status.Errored ? import_react502.default.createElement(Image, {
  ...
  const avatarBody = customer || !initials ? import_react502.default.createElement("path", {
    fill: "currentColor",
  ...
  }) : import_react502.default.createElement("text", {
    x: "50%",
    y: "50%",
    dy: verticalOffset,
    fill: "currentColor",
    fontSize: shape2 === "square" ? "15.5" : "20",
    fontWeight: shape2 === "square" ? "600" : "400",
    textAnchor: "middle"
  }, initials);
  const svgMarkup = hasImage ? null : import_react502.default.createElement("span", {
    className: styles19.Initials
  }, import_react502.default.createElement("svg", {
    className: styles19.Svg,
    viewBox: "0 0 40 40"
  }, avatarBody));
  return import_react502.default.createElement("span", {
    "aria-label": label,
    role: "img",
    className
...
function AccountConnection({
  ...
  const avatarMarkup = connected ? import_react503.default.createElement(Avatar, {
    accessibilityLabel: "",
    name: accountName,
    initials,
    source: avatarUrl
  ...
  if (title) {
    titleMarkup = import_react503.default.createElement("div", null, title);
  } else if (accountName) {
    titleMarkup = import_react503.default.createElement("div", null, accountName);
  }
  const detailsMarkup = details ? import_react503.default.createElement("div", null, import_react503.default.createElement(TextStyle, {
    variation: "subdued"
  }, details)) : null;
  const termsOfServiceMarkup = termsOfService ? import_react503.default.createElement("div", {
    className: styles.TermsOfService
  }, termsOfService) : null;
  const actionElement = action ? buttonFrom(action, {
    primary: !connected
  }) : null;
  return import_react503.default.createElement(Card, {
    sectioned: true
  }, import_react503.default.createElement(SettingAction, {
    action: actionElement
  }, import_react503.default.createElement(Stack, null, avatarMarkup, import_react503.default.createElement(Stack.Item, {
    fill: true
  }, import_react503.default.createElement("div", {
...
function RollupActions({
  ...
  const activatorMarkup = import_react504.default.createElement("div", {
    className: styles21.RollupActivator
  }, import_react504.default.createElement(Button, {
    outline: true,
  ...
  return import_react504.default.createElement(Popover2, {
    active: rollupOpen,
    activator: activatorMarkup,
    preferredAlignment: "right",
    onClose: toggleRollupOpen,
    hideOnPrint: true
  }, import_react504.default.createElement(ActionList, {
    items,
    sections,
...
function TooltipOverlay({
  ...
  const i18n = useI18n();
  const markup = active ? import_react505.default.createElement(PositionedOverlay, {
    active,
    activator,
    preferredPosition,
    preventInteraction,
  ...
  function renderTooltip(overlayDetails) {
    ...
    const containerClassName = classNames(styles25.TooltipOverlay, measuring && styles25.measuring, positioning === "above" && styles25.positionedAbove);
    const contentStyles = measuring ? void 0 : {
      minHeight: desiredHeight
    };
    return import_react505.default.createElement("div", Object.assign({
      className: containerClassName
    }, layer.props), import_react505.default.createElement("div", {
      id,
      role: "tooltip",
...
function Tooltip({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react506.useState)(null);
  const id = useUniqueId("TooltipContent");
  const activatorContainer = (0, import_react506.useRef)(null);
  const mouseEntered = (0, import_react506.useRef)(false);
  (0, import_react506.useEffect)(() => {
  ...
  const handleKeyUp = (0, import_react506.useCallback)((event) => {
    if (event.keyCode !== Key.Escape)
      return;
    handleBlur();
  }, [handleBlur]);
  const portal2 = activatorNode ? import_react506.default.createElement(Portal, {
    idPrefix: "tooltip"
  }, import_react506.default.createElement(TooltipOverlay, {
    id,
    preferredPosition,
    activator: activatorNode,
    active,
  ...
  return import_react506.default.createElement(WrapperComponent, {
    onFocus: handleFocus,
    onBlur: handleBlur,
...
function SecondaryAction({
  ...
  const secondaryActionsRef = (0, import_react507.useRef)(null);
  (0, import_react507.useEffect)(() => {
  ...
  const buttonMarkup = import_react507.default.createElement(Button, Object.assign({
    onClick: onAction
  }, rest), children2);
  const actionMarkup = helpText ? import_react507.default.createElement(Tooltip, {
    content: helpText
  }, buttonMarkup) : buttonMarkup;
  return import_react507.default.createElement("span", {
...
function MenuGroup({
  ...
  const handleClose = (0, import_react508.useCallback)(() => {
    onClose(title);
  }, [onClose, title]);
  const handleOpen = (0, import_react508.useCallback)(() => {
    onOpen(title);
  }, [onOpen, title]);
  const handleClick = (0, import_react508.useCallback)(() => {
    if (onClick) {
      onClick(handleOpen);
    } else {
      handleOpen();
  ...
  const handleOffsetWidth = (0, import_react508.useCallback)((width) => {
    if (!getOffsetWidth)
      return;
    getOffsetWidth(width);
  }, [getOffsetWidth]);
  const popoverActivator = import_react508.default.createElement(SecondaryAction, {
    disclosure: true,
    disabled,
    icon,
    accessibilityLabel,
  ...
  return import_react508.default.createElement(Popover2, {
    active: Boolean(active),
    activator: popoverActivator,
    preferredAlignment: "left",
    onClose: handleClose,
    hideOnPrint: true
  }, import_react508.default.createElement(ActionList, {
    items: actions,
    sections,
    onActionAnyItem: handleClose
  }), details && import_react508.default.createElement("div", {
...
function Actions({
  ...
  const i18n = useI18n();
  const actionsLayoutRef = (0, import_react509.useRef)(null);
  const menuGroupWidthRef = (0, import_react509.useRef)(0);
  const availableWidthRef = (0, import_react509.useRef)(0);
  const actionsAndGroupsLengthRef = (0, import_react509.useRef)(0);
  const timesMeasured = (0, import_react509.useRef)(0);
  const actionWidthsRef = (0, import_react509.useRef)([]);
  const rollupActiveRef = (0, import_react509.useRef)(null);
  const [activeMenuGroup, setActiveMenuGroup] = (0, import_react509.useState)(void 0);
  const [measuredActions, setMeasuredActions] = (0, import_react509.useState)({
    showable: [],
    rolledUp: []
  });
  ...
  const handleActionsOffsetWidth = (0, import_react509.useCallback)((width) => {
    actionWidthsRef.current = [...actionWidthsRef.current, width];
  }, []);
  const handleMenuGroupToggle = (0, import_react509.useCallback)((group) => setActiveMenuGroup(activeMenuGroup ? void 0 : group), [activeMenuGroup]);
  const handleMenuGroupClose = (0, import_react509.useCallback)(() => setActiveMenuGroup(void 0), []);
  const updateActions = (0, import_react509.useCallback)(() => {
  ...
  const measureActions = (0, import_react509.useCallback)(() => {
  ...
  const handleResize = (0, import_react509.useMemo)(() => debounce(() => {
  ...
  const actionsMarkup = actions.map((action) => {
    ...
    return import_react509.default.createElement(SecondaryAction, Object.assign({
      key: content,
      onClick: onAction
    }, rest, {
  ...
  const rollUppableActionsMarkup = measuredActions.showable.length > 0 ? measuredActions.showable.map((action) => action.content && import_react509.default.createElement(SecondaryAction, Object.assign({
    key: action.content
  }, action, {
    getOffsetWidth: handleActionsOffsetWidth
  }), action.content)) : null;
  ...
  const groupsMarkup = filteredGroups.map((group) => {
    ...
    if (!isDefaultGroup && !isLastMenuGroup) {
      return import_react509.default.createElement(MenuGroup, Object.assign({
        key: title,
        title,
  ...
  const groupedActionsMarkup = import_react509.default.createElement(ButtonGroup, {
    spacing: "extraTight"
  }, rollUppableActionsMarkup, actionsMarkup, groupsMarkup);
  return import_react509.default.createElement("div", {
    className: styles22.ActionsLayout,
    ref: actionsLayoutRef
  }, groupedActionsMarkup, import_react509.default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }));
}
...
function ActionMenu({
  ...
  return import_react510.default.createElement("div", {
    className: actionMenuClassNames
  }, rollup ? import_react510.default.createElement(RollupActions, {
    accessibilityLabel: rollupActionsLabel,
    items: actions,
    sections: rollupSections
  }) : import_react510.default.createElement(Actions, {
    actions,
    groups,
    onActionRollup
  }));
...
var ComboboxTextFieldContext = (0, import_react511.createContext)(void 0);
var ComboboxListboxContext = (0, import_react511.createContext)({});
var ComboboxListboxOptionContext = (0, import_react511.createContext)({});

// node_modules/@shopify/polaris/build/esm/utilities/combobox/hooks.js
function useComboboxTextField() {
  const context = (0, import_react512.useContext)(ComboboxTextFieldContext);
  if (!context) {
...
function useComboboxListbox() {
  const context = (0, import_react512.useContext)(ComboboxListboxContext);
  return context;
}
...
var ListboxContext = (0, import_react513.createContext)(void 0);
var WithinListboxContext = (0, import_react513.createContext)(false);
var ActionContext = (0, import_react513.createContext)(false);
...
function InlineError({
  ...
  return import_react514.default.createElement("div", {
    id: errorTextID(fieldID),
    className: styles32.InlineError
  }, import_react514.default.createElement("div", {
    className: styles32.Icon
  }, import_react514.default.createElement(Icon, {
...
function Choice({
  ...
  const className = classNames(styles31.Choice, labelHidden && styles31.labelHidden, disabled && styles31.disabled);
  const labelMarkup = import_react515.default.createElement("label", {
    className,
    htmlFor: id,
    onClick,
    onMouseOver,
    onMouseOut
  }, import_react515.default.createElement("span", {
    className: styles31.Control
  }, children2), import_react515.default.createElement("span", {
    className: styles31.Label
  }, label));
  const helpTextMarkup = helpText ? import_react515.default.createElement("div", {
    className: styles31.HelpText,
    id: helpTextID(id)
  }, helpText) : null;
  const errorMarkup = error && typeof error !== "boolean" && import_react515.default.createElement("div", {
    className: styles31.Error
  }, import_react515.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const descriptionMarkup = helpTextMarkup || errorMarkup ? import_react515.default.createElement("div", {
    className: styles31.Descriptions
  }, errorMarkup, helpTextMarkup) : null;
  return descriptionMarkup ? import_react515.default.createElement("div", null, labelMarkup, descriptionMarkup) : labelMarkup;
}
...
// node_modules/@shopify/polaris/build/esm/components/Checkbox/Checkbox.js
var Checkbox = (0, import_react516.forwardRef)(function Checkbox2({
  ariaControls,
  ...
  const inputNode = (0, import_react516.useRef)(null);
  ...
  const [keyFocused, setKeyFocused] = (0, import_react516.useState)(false);
  const isWithinListbox = (0, import_react516.useContext)(WithinListboxContext);
  (0, import_react516.useImperativeHandle)(ref, () => ({
    focus: () => {
  ...
  const backdropClassName = classNames(styles30.Backdrop, mouseOver && styles30.hover);
  ...
  const inputClassName = classNames(styles30.Input, isIndeterminate && styles30["Input-indeterminate"], keyFocused && styles30.keyFocused);
  return import_react516.default.createElement(Choice, {
    id,
    label,
    labelHidden,
    helpText,
  ...
  }, import_react516.default.createElement("span", {
    className: wrapperClassName
  }, import_react516.default.createElement("input", Object.assign({
    ref: inputNode,
    id,
    name,
    value,
  ...
  }, indeterminateAttributes)), import_react516.default.createElement("span", {
    className: backdropClassName,
    onClick: stopPropagation,
    onKeyUp: stopPropagation
  }), import_react516.default.createElement("span", {
    className: styles30.Icon
  }, import_react516.default.createElement(Icon, {
    source: iconSource
  }))));
});
function noop4() {
...
// node_modules/@shopify/polaris/build/esm/components/Listbox/components/TextOption/TextOption.js
var TextOption = (0, import_react517.memo)(function TextOption2({
  children: children2,
  selected,
  disabled
}) {
  const {
    allowMultiple
  } = (0, import_react517.useContext)(ComboboxListboxOptionContext);
  const isAction = (0, import_react517.useContext)(ActionContext);
  ...
  return import_react517.default.createElement("div", {
    className: textOptionClassName
  }, import_react517.default.createElement("div", {
    className: styles29.Content
  }, allowMultiple && !isAction ? import_react517.default.createElement("div", {
    className: styles29.Checkbox
  }, import_react517.default.createElement(Checkbox, {
    disabled,
    checked: selected,
    label: children2
  })) : children2));
...
function useListbox() {
  const listbox = (0, import_react518.useContext)(ListboxContext);
  if (!listbox) {
...
// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Loading/Loading.js
var Loading = (0, import_react519.memo)(function LoadingOption({
  children: children2,
  ...
  (0, import_react519.useEffect)(() => {
    setLoading(label);
    return () => {
      setLoading(void 0);
    };
  }, [label, setLoading]);
  return import_react519.default.createElement("li", {
    className: styles33.ListItem,
    role: "presentation"
  }, children2 ? children2 : import_react519.default.createElement("div", {
    className: styles33.Loading
  }, import_react519.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: label
  })));
});
...
var SectionContext = (0, import_react520.createContext)(null);
...
function Section4({
  ...
  return import_react521.default.createElement(SectionContext.Provider, {
    value: sectionId
  }, import_react521.default.createElement("li", Object.assign({
    role: "presentation"
  }, listboxSectionDataSelector.props), title, import_react521.default.createElement("ul", {
    role: "group",
...
// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Header/Header.scss.js
var styles35 = {
...
function useSection() {
  const context = (0, import_react522.useContext)(SectionContext);
  return context;
}
...
function Header2({
  ...
  const content = typeof children2 === "string" ? import_react523.default.createElement("div", {
    className: styles35.Header
  }, children2) : children2;
  return import_react523.default.createElement("div", {
    "aria-hidden": true,
    id: sectionId
  }, content);
}
...
var MappedActionContext = (0, import_react524.createContext)({});

// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Option/Option.js
var Option = (0, import_react525.memo)(function Option2({
  value,
  children: children2,
  selected,
  disabled = false,
  ...
  const isAction = (0, import_react525.useContext)(ActionContext);
  const {
    role,
    url,
    external,
    onAction,
    destructive
  } = (0, import_react525.useContext)(MappedActionContext);
  const listItemRef = (0, import_react525.useRef)(null);
  const domId = useUniqueId("ListboxOption");
  const sectionId = useSection();
  const isWithinSection = Boolean(sectionId);
  const handleOptionSelect = (0, import_react525.useCallback)((event) => {
    event.preventDefault();
    event.stopPropagation();
    onAction && onAction();
  ...
  const content = typeof children2 === "string" ? import_react525.default.createElement(TextOption, {
    selected,
    disabled
  }, children2) : children2;
  ...
  const contentMarkup = url ? import_react525.default.createElement(UnstyledLink, {
    url,
    external
  }, content) : content;
  return import_react525.default.createElement("li", Object.assign({}, sectionAttributes, {
    ...
    className: classNames(styles37.Option, divider && styles37.divider),
    id: domId,
    ref: listItemRef,
    tabIndex: -1,
...
function Action(props) {
  ...
  const iconMarkup = icon && import_react526.default.createElement("div", {
    className: styles36.Icon
  }, import_react526.default.createElement(Icon, {
    color: "subdued",
    source: icon
  }));
  const className = classNames(styles36.Action, divider && styles36.ActionDivider);
  return import_react526.default.createElement(ActionContext.Provider, {
    value: true
  }, import_react526.default.createElement(Option, props, import_react526.default.createElement("div", {
    className
  }, import_react526.default.createElement(TextOption, {
    selected,
    disabled
...
function Listbox({
  ...
  const [loading, setLoading] = (0, import_react527.useState)();
  const [activeOption, setActiveOption] = (0, import_react527.useState)();
  const [lazyLoading, setLazyLoading] = (0, import_react527.useState)(false);
  const [currentOptions, setCurrentOptions] = (0, import_react527.useState)([]);
  const {
  ...
  const scrollableRef = (0, import_react527.useRef)(null);
  const listboxRef = (0, import_react527.useRef)(null);
  const {
    listboxId,
    textFieldLabelId,
    textFieldFocused,
  ...
  const getNavigableOptions = (0, import_react527.useCallback)(() => {
    if (!listboxRef.current) {
      return [];
    }
    return [...new Set(listboxRef.current.querySelectorAll(OPTION_SELECTOR))];
  }, []);
  const getFirstNavigableOption = (0, import_react527.useCallback)((currentOptions2) => {
  ...
  const handleScrollIntoView = (0, import_react527.useCallback)((option) => {
    const {
      current: scrollable2
    } = scrollableRef;
    if (scrollable2) {
  ...
  const handleKeyToBottom = (0, import_react527.useCallback)(() => {
    if (onKeyToBottom) {
      setLazyLoading(true);
      return Promise.resolve(onKeyToBottom());
    }
  }, [onKeyToBottom]);
  const handleChangeActiveOption = (0, import_react527.useCallback)((nextOption) => {
    if (!nextOption)
  ...
  const getFormattedOption = (0, import_react527.useCallback)((element, index) => {
    return {
      element,
      index,
      domId: element.id,
  ...
  const resetActiveOption = (0, import_react527.useCallback)(() => {
  ...
  (0, import_react527.useEffect)(() => {
    if (autoSelection !== AutoSelection.None && !loading && children2 && import_react527.Children.count(children2) > 0) {
      resetActiveOption();
    }
  ...
  const onOptionSelect = (0, import_react527.useCallback)((option) => {
  ...
  const getNextIndex = (0, import_react527.useCallback)((currentIndex, lastIndex, direction) => {
    let nextIndex;
    if (direction === "down") {
  ...
  const getNextValidOption = (0, import_react527.useCallback)(async (key) => {
  ...
  const handleArrow = (0, import_react527.useCallback)(async (type, event) => {
    event.preventDefault();
    const {
      element,
      nextIndex
  ...
  const handleDownArrow = (0, import_react527.useCallback)((event) => {
    handleArrow("down", event);
  }, [handleArrow]);
  const handleUpArrow = (0, import_react527.useCallback)((event) => {
    handleArrow("up", event);
  }, [handleArrow]);
  const handleEnter = (0, import_react527.useCallback)((event) => {
    event.preventDefault();
    event.stopPropagation();
    if (activeOption) {
  ...
  const handleFocus = (0, import_react527.useCallback)(() => {
    if (enableKeyboardControl)
      return;
    enableKeyboardEvents();
  }, [enableKeyboardControl, enableKeyboardEvents]);
  const handleBlur = (0, import_react527.useCallback)((event) => {
    event.stopPropagation();
  ...
  const listeners = keyboardEventsEnabled || textFieldFocused ? import_react527.default.createElement(import_react527.default.Fragment, null, import_react527.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleDownArrow
  }), import_react527.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
  ...
  const listboxContext = (0, import_react527.useMemo)(() => ({
    onOptionSelect,
    setLoading
  }), [onOptionSelect]);
  return import_react527.default.createElement(import_react527.default.Fragment, null, listeners, import_react527.default.createElement(VisuallyHidden, null, import_react527.default.createElement("div", {
    "aria-live": "polite"
  }, loading ? loading : null)), import_react527.default.createElement(ListboxContext.Provider, {
    value: listboxContext
  }, import_react527.default.createElement(WithinListboxContext.Provider, {
    value: true
  }, children2 ? import_react527.default.createElement("ul", {
    tabIndex: 0,
    role: "listbox",
...
// node_modules/@shopify/polaris/build/esm/components/Autocomplete/components/MappedOption/MappedOption.js
var MappedOption = (0, import_react528.memo)(function MappedOption2({
  label,
  value,
  disabled,
  media,
  ...
  const mediaMarkup = media ? import_react528.default.createElement("div", {
    className: mediaClassNames
  }, media) : null;
  const accessibilityLabel = typeof label === "string" ? label : void 0;
  return import_react528.default.createElement(Listbox.Option, {
    accessibilityLabel,
    key: value,
    selected,
    value,
    disabled
  }, import_react528.default.createElement(Listbox.TextOption, {
    selected,
    disabled
  }, import_react528.default.createElement("div", {
...
var Spinner2 = import_react529.default.forwardRef(function Spinner3({
  onChange,
  onClick,
  onMouseDown,
  onMouseUp
  ...
  return import_react529.default.createElement("div", {
    className: styles39.Spinner,
    onClick,
    "aria-hidden": true,
    ref
  }, import_react529.default.createElement("div", {
    role: "button",
    className: styles39.Segment,
    tabIndex: -1,
    onClick: handleStep(1),
    onMouseDown: handleMouseDown(handleStep(1)),
    onMouseUp
  }, import_react529.default.createElement("div", {
    className: styles39.SpinnerIcon
  }, import_react529.default.createElement(Icon, {
...
function Label({
  ...
  const className = classNames(styles41.Label, hidden && styles41.hidden);
  return import_react530.default.createElement("div", {
    className
  }, import_react530.default.createElement("label", {
    id: labelID(id),
    htmlFor: id,
    className: classNames(styles41.Text, requiredIndicator && styles41.RequiredIndicator)
  }, children2));
}
...
function Labelled({
  ...
  const className = classNames(labelHidden && styles40.hidden);
  const actionMarkup = action ? import_react531.default.createElement("div", {
    className: styles40.Action
  }, buttonFrom(action, {
    plain: true
  })) : null;
  const helpTextMarkup = helpText ? import_react531.default.createElement("div", {
    className: styles40.HelpText,
    id: helpTextID2(id)
  }, helpText) : null;
  const errorMarkup = error && typeof error !== "boolean" && import_react531.default.createElement("div", {
    className: styles40.Error
  }, import_react531.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const labelMarkup = label ? import_react531.default.createElement("div", {
    className: styles40.LabelWrapper
  }, import_react531.default.createElement(Label, Object.assign({
    id,
    requiredIndicator
  }, rest, {
    hidden: false
  }), label), actionMarkup) : null;
  return import_react531.default.createElement("div", {
    className
...
function Item4({
  ...
  const className = classNames(styles42.Item, focused && styles42["Item-focused"], position === "primary" ? styles42["Item-primary"] : styles42["Item-connection"]);
...
function Connected({
  ...
  const leftConnectionMarkup = left ? import_react533.default.createElement(Item4, {
    position: "left"
  }, left) : null;
  const rightConnectionMarkup = right ? import_react533.default.createElement(Item4, {
    position: "right"
  }, right) : null;
  return import_react533.default.createElement("div", {
    className: styles42.Connected
  }, leftConnectionMarkup, import_react533.default.createElement(Item4, {
    position: "primary"
...
function Resizer({
  ...
  const contentNode = (0, import_react534.useRef)(null);
  const minimumLinesNode = (0, import_react534.useRef)(null);
  const animationFrame = (0, import_react534.useRef)();
  const currentHeight = (0, import_react534.useRef)(currentHeightProp);
  if (currentHeightProp !== currentHeight.current) {
    currentHeight.current = currentHeightProp;
  }
  (0, import_react534.useEffect)(() => {
    return () => {
  ...
  const minimumLinesMarkup = minimumLines ? import_react534.default.createElement("div", {
    ref: minimumLinesNode,
    className: styles39.DummyInput,
    dangerouslySetInnerHTML: {
      __html: getContentsForMinimumLines(minimumLines)
    }
  }) : null;
  const handleHeightCheck = (0, import_react534.useCallback)(() => {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
  ...
  (0, import_react534.useLayoutEffect)(() => {
    handleHeightCheck();
  });
  return import_react534.default.createElement("div", {
    "aria-hidden": true,
    className: styles39.Resizer
...
function TextField({
  ...
  const i18n = useI18n();
  const [height, setHeight] = (0, import_react535.useState)(null);
  const [focus, setFocus] = (0, import_react535.useState)(Boolean(focused));
  const isAfterInitial = useIsAfterInitialMount();
  const id = useUniqueId("TextField", idProp);
  const inputRef = (0, import_react535.useRef)(null);
  const textAreaRef = (0, import_react535.useRef)(null);
  const prefixRef = (0, import_react535.useRef)(null);
  const suffixRef = (0, import_react535.useRef)(null);
  const verticalContentRef = (0, import_react535.useRef)(null);
  const buttonPressTimer = (0, import_react535.useRef)();
  const spinnerRef = (0, import_react535.useRef)(null);
  ...
  const className = classNames(styles39.TextField, Boolean(normalizedValue) && styles39.hasValue, disabled && styles39.disabled, readOnly && styles39.readOnly, error && styles39.error, multiline && styles39.multiline, focus && styles39.focus);
  const inputType = type === "currency" ? "text" : type;
  const prefixMarkup = prefix ? import_react535.default.createElement("div", {
    className: styles39.Prefix,
    id: `${id}-Prefix`,
    ref: prefixRef
  }, prefix) : null;
  const suffixMarkup = suffix ? import_react535.default.createElement("div", {
    className: styles39.Suffix,
    id: `${id}-Suffix`,
    ref: suffixRef
  }, suffix) : null;
  ...
  if (showCharacterCount) {
    ...
    const characterCountClassName = classNames(styles39.CharacterCount, multiline && styles39.AlignFieldBottom);
    const characterCountText = !maxLength ? characterCount : `${characterCount}/${maxLength}`;
    characterCountMarkup = import_react535.default.createElement("div", {
  ...
  const clearButtonMarkup = clearButton && clearButtonVisible ? import_react535.default.createElement("button", {
    type: "button",
    className: styles39.ClearButton,
    onClick: handleClearButtonPress,
    disabled
  }, import_react535.default.createElement(VisuallyHidden, null, i18n.translate("Polaris.Common.clear")), import_react535.default.createElement(Icon, {
    source: SvgCircleCancelMinor,
    color: "base"
  })) : null;
  const handleNumberChange = (0, import_react535.useCallback)((steps) => {
    if (onChange == null) {
      return;
    }
  ...
  const handleButtonRelease = (0, import_react535.useCallback)(() => {
    clearTimeout(buttonPressTimer.current);
  }, []);
  const handleButtonPress = (0, import_react535.useCallback)((onChange2) => {
  ...
  const spinnerMarkup = type === "number" && step !== 0 && !disabled && !readOnly ? import_react535.default.createElement(Spinner2, {
    onClick: handleClickChild,
  ...
  const handleExpandingResize = (0, import_react535.useCallback)((height2) => {
    setHeight(height2);
  }, []);
  const resizer = multiline && isAfterInitial ? import_react535.default.createElement(Resizer, {
  ...
  const inputClassName = classNames(styles39.Input, align && styles39[variationName("Input-align", align)], suffix && styles39["Input-suffixed"], clearButton && styles39["Input-hasClearButton"], monospaced && styles39.monospaced, suggestion && styles39.suggestion);
  ...
  const input = (0, import_react535.createElement)(multiline ? "textarea" : "input", {
    name,
    id,
    disabled,
    readOnly,
  ...
  const inputWithVerticalContentMarkup = verticalContent ? import_react535.default.createElement("div", {
    className: styles39.VerticalContent,
    id: `${id}-VerticalContent`,
    ref: verticalContentRef,
    onClick: handleClickChild
  }, verticalContent, input) : null;
  const inputMarkup = verticalContent ? inputWithVerticalContentMarkup : input;
  const backdropMarkup = import_react535.default.createElement("div", {
    className: classNames(styles39.Backdrop, connectedLeft && styles39["Backdrop-connectedLeft"], connectedRight && styles39["Backdrop-connectedRight"])
  });
  return import_react535.default.createElement(Labelled, {
    label,
    id,
    error,
    action: labelAction,
    ...
    helpText,
    requiredIndicator
  }, import_react535.default.createElement(Connected, {
    left: connectedLeft,
    right: connectedRight
  }, import_react535.default.createElement("div", {
    className,
    onClick: handleClick
...
function TextField2({
  ...
  const textFieldId = (0, import_react536.useMemo)(() => idProp || uniqueId, [uniqueId, idProp]);
  const labelId = (0, import_react536.useMemo)(() => labelID(idProp || uniqueId), [uniqueId, idProp]);
  (0, import_react536.useEffect)(() => {
    if (setTextFieldLabelId)
      setTextFieldLabelId(labelId);
  }, [labelId, setTextFieldLabelId]);
  const handleFocus = (0, import_react536.useCallback)((event) => {
    if (onFocus)
      onFocus(event);
    if (onTextFieldFocus)
      onTextFieldFocus();
  ...
  const handleBlur = (0, import_react536.useCallback)((event) => {
    if (onBlur)
      onBlur(event);
    if (onTextFieldBlur)
      onTextFieldBlur();
  ...
  const handleChange = (0, import_react536.useCallback)((value2, id) => {
    if (onChange)
      onChange(value2, id);
    if (onTextFieldChange)
      onTextFieldChange(value2);
  }, [onChange, onTextFieldChange]);
  return import_react536.default.createElement(TextField, Object.assign({}, rest, {
    value,
    id: textFieldId,
    type,
    ariaAutocomplete,
...
function Combobox({
  ...
  const [popoverActive, setPopoverActive] = (0, import_react537.useState)(false);
  const [activeOptionId, setActiveOptionId] = (0, import_react537.useState)();
  const [textFieldLabelId, setTextFieldLabelId] = (0, import_react537.useState)();
  const [listboxId, setListboxId] = (0, import_react537.useState)();
  const [textFieldFocused, setTextFieldFocused] = (0, import_react537.useState)(false);
  const shouldOpen = Boolean(!popoverActive && import_react537.Children.count(children2) > 0);
  const ref = (0, import_react537.useRef)(null);
  const handleClose = (0, import_react537.useCallback)(() => {
    setPopoverActive(false);
    onClose === null || onClose === void 0 ? void 0 : onClose();
    setActiveOptionId(void 0);
  }, [onClose]);
  const handleOpen = (0, import_react537.useCallback)(() => {
    setPopoverActive(true);
    setActiveOptionId(void 0);
  }, []);
  const onOptionSelected = (0, import_react537.useCallback)(() => {
    var _ref$current;
    if (!allowMultiple) {
      handleClose();
      setActiveOptionId(void 0);
  ...
  const handleFocus = (0, import_react537.useCallback)(() => {
    if (shouldOpen) {
      handleOpen();
    }
  }, [shouldOpen, handleOpen]);
  const handleChange = (0, import_react537.useCallback)(() => {
    if (shouldOpen) {
      handleOpen();
    }
  }, [shouldOpen, handleOpen]);
  const handleBlur = (0, import_react537.useCallback)(() => {
    if (popoverActive) {
      handleClose();
    }
  }, [popoverActive, handleClose]);
  const textFieldContextValue = (0, import_react537.useMemo)(() => ({
    activeOptionId,
  ...
  const listboxOptionContextValue = (0, import_react537.useMemo)(() => ({
    allowMultiple
  }), [allowMultiple]);
  const listboxContextValue = (0, import_react537.useMemo)(() => ({
    listboxId,
    textFieldLabelId,
    textFieldFocused,
    willLoadMoreOptions,
  ...
  return import_react537.default.createElement(Popover2, {
    ref,
    active: popoverActive,
    activator: import_react537.default.createElement(ComboboxTextFieldContext.Provider, {
    ...
    preferredPosition,
    onClose: handleClose
  }, import_react537.Children.count(children2) > 0 ? import_react537.default.createElement(Popover2.Pane, {
    onScrolledToBottom,
    height
  }, import_react537.default.createElement(ComboboxListboxContext.Provider, {
    value: listboxContextValue
  }, import_react537.default.createElement(ComboboxListboxOptionContext.Provider, {
    value: listboxOptionContextValue
  }, import_react537.default.createElement("div", {
    className: styles38.Listbox
  }, children2)))) : null);
}
...
function MappedAction({
  ...
  const i18n = useI18n();
  let prefixMarkup = null;
  const contentOverflowStyle = wrapOverflow ? styles43.ContentWrap : void 0;
  if (prefix) {
    prefixMarkup = import_react538.default.createElement("div", {
      className: styles43.Prefix
    }, prefix);
  } else if (icon) {
    prefixMarkup = import_react538.default.createElement("div", {
      className: styles43.Prefix
    }, import_react538.default.createElement(Icon, {
      source: icon
    }));
  } else if (image) {
    prefixMarkup = import_react538.default.createElement("div", {
  ...
  const badgeMarkup = badge && import_react538.default.createElement("span", {
    className: styles43.Suffix
  }, import_react538.default.createElement(Badge, {
    status: badge.status
  }, badge.content));
  const suffixMarkup = suffix && import_react538.default.createElement("span", {
    className: styles43.Suffix
  }, suffix);
  const contentText = ellipsis && content ? i18n.translate("Polaris.Autocomplete.ellipsis", {
    content
  }) : content;
  const contentMarkup = import_react538.default.createElement("div", {
    className: styles43.Text
  }, import_react538.default.createElement("div", {
    className: contentOverflowStyle
  }, contentText), helpText ? import_react538.default.createElement(TextStyle, {
    variation: "subdued"
  }, helpText) : null);
  const context = (0, import_react538.useMemo)(() => ({
    role,
    url,
    external,
    onAction,
  ...
  const actionClassNames = classNames(styles43.Action, disabled && styles43.disabled, destructive && styles43.destructive, active && styles43.selected);
  return import_react538.default.createElement(MappedActionContext.Provider, {
    value: context
  }, import_react538.default.createElement("div", {
    className: styles43.ActionContainer
  }, import_react538.default.createElement(Listbox.Action, {
    selected: active,
    disabled,
    value: content || ""
  }, import_react538.default.createElement("div", {
...
var Autocomplete = function Autocomplete2({
  ...
  const i18n = useI18n();
  const buildMappedOptionFromOption = (0, import_react539.useCallback)((options2) => {
    return options2.map((option) => import_react539.default.createElement(MappedOption, Object.assign({
  ...
  const optionsMarkup = (0, import_react539.useMemo)(() => {
    ...
    if (isSection(conditionalOptions)) {
      ...
      const optionsMarkup2 = conditionalOptions.map(({
        ...
        return import_react539.default.createElement(Listbox.Section, {
          divider: false,
          title: import_react539.default.createElement(Listbox.Header, null, title),
          key: title
        }, optionMarkup);
      });
      return import_react539.default.createElement("div", {
    ...
    if (listTitle) {
      return import_react539.default.createElement(Listbox.Section, {
        divider: false,
        title: import_react539.default.createElement(Listbox.Header, null, listTitle)
      }, optionList);
    }
    return optionList;
  }, [listTitle, loading, options, willLoadMoreResults, buildMappedOptionFromOption]);
  const loadingMarkup = loading ? import_react539.default.createElement(Listbox.Loading, {
    accessibilityLabel: i18n.translate("Polaris.Autocomplete.spinnerAccessibilityLabel")
  }) : null;
  const updateSelection = (0, import_react539.useCallback)((newSelection) => {
  ...
  const actionMarkup = actionBefore && import_react539.default.createElement(MappedAction, actionBefore);
  const emptyStateMarkup = emptyState && options.length < 1 && !loading && import_react539.default.createElement("div", {
    role: "status"
  }, emptyState);
  const autoSelection = actionBefore ? AutoSelection.First : void 0;
  return import_react539.default.createElement(Combobox, {
    activator: textField,
    allowMultiple,
    onScrolledToBottom: onLoadMoreResults,
    preferredPosition,
    willLoadMoreOptions: willLoadMoreResults
  }, actionMarkup || optionsMarkup || loadingMarkup || emptyStateMarkup ? import_react539.default.createElement(Listbox, {
    autoSelection,
...
function useScrollLockManager() {
  const scrollLockManager = (0, import_react540.useContext)(ScrollLockManagerContext);
...
function Backdrop(props) {
  ...
  const className = classNames(styles44.Backdrop, belowNavigation && styles44.belowNavigation, transparent && styles44.transparent);
  return import_react542.default.createElement(import_react542.default.Fragment, null, import_react542.default.createElement(ScrollLock, null), import_react542.default.createElement("div", {
    className,
    onClick,
    onTouchStart
  }));
...
var BannerContext = (0, import_react543.createContext)(false);
...
function unstyledButtonFrom({
  ...
  return import_react544.default.createElement(UnstyledButton, Object.assign({
    key,
    onClick: onAction
  }, action, overrides), content);
}
...
// node_modules/@shopify/polaris/build/esm/components/Banner/Banner.js
var Banner = (0, import_react545.forwardRef)(function Banner2({
  icon,
  action,
  secondaryAction,
  title,
  ...
  const withinContentContainer = (0, import_react545.useContext)(WithinContentContext);
  ...
  const className = classNames(styles45.Banner, status && styles45[variationName("status", status)], onDismiss && styles45.hasDismiss, shouldShowFocus && styles45.keyFocused, withinContentContainer ? styles45.withinContentContainer : styles45.withinPage);
  let headingMarkup = null;
  let headingID;
  if (title) {
    headingID = `${id}Heading`;
    headingMarkup = import_react545.default.createElement("div", {
      className: styles45.Heading,
      id: headingID
    }, import_react545.default.createElement(Heading, {
      element: "p"
    }, title));
  }
  const spinnerMarkup = action !== null && action !== void 0 && action.loading ? import_react545.default.createElement("button", {
    disabled: true,
    "aria-busy": true,
    className: classNames(styles45.Button, styles45.loading)
  }, import_react545.default.createElement("span", {
    className: styles45.Spinner
  }, import_react545.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: i18n.translate("Polaris.Button.spinnerAccessibilityLabel")
  })), action.content) : null;
  const primaryActionMarkup = action ? import_react545.default.createElement("div", {
    className: styles45.PrimaryAction
  }, action.loading ? spinnerMarkup : unstyledButtonFrom(action, {
    className: styles45.Button
  })) : null;
  const secondaryActionMarkup = secondaryAction ? import_react545.default.createElement(SecondaryActionFrom, {
    action: secondaryAction
  }) : null;
  const actionMarkup = action || secondaryAction ? import_react545.default.createElement("div", {
    className: styles45.Actions
  }, import_react545.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup)) : null;
  let contentMarkup = null;
  let contentID;
  if (children2 || actionMarkup) {
    contentID = `${id}Content`;
    contentMarkup = import_react545.default.createElement("div", {
      className: styles45.Content,
      id: contentID
    }, children2, actionMarkup);
  }
  const dismissButton = onDismiss && import_react545.default.createElement("div", {
    className: styles45.Dismiss
  }, import_react545.default.createElement(Button, {
    plain: true,
    icon: SvgCancelSmallMinor,
    onClick: onDismiss,
    accessibilityLabel: "Dismiss notification"
  }));
  return import_react545.default.createElement(BannerContext.Provider, {
    value: true
  }, import_react545.default.createElement("div", {
    className,
    tabIndex: 0,
    ref: wrapperRef,
    role: ariaRoleType,
  ...
  }, dismissButton, import_react545.default.createElement("div", {
    className: styles45.Ribbon
  }, import_react545.default.createElement(Icon, {
    source: iconName,
    color: iconColor
  })), import_react545.default.createElement("div", {
    className: styles45.ContentWrapper
...
function SecondaryActionFrom({
  ...
  if (action.url) {
    return import_react545.default.createElement(UnstyledLink, {
      className: styles45.SecondaryAction,
      url: action.url,
      external: action.external
    }, import_react545.default.createElement("span", {
      className: styles45.Text
    }, action.content));
  }
  return import_react545.default.createElement(UnstyledButton, {
    className: styles45.SecondaryAction,
...
function useBannerFocus(bannerRef) {
  const wrapperRef = (0, import_react545.useRef)(null);
  const [shouldShowFocus, setShouldShowFocus] = (0, import_react545.useState)(false);
  (0, import_react545.useImperativeHandle)(bannerRef, () => ({
    focus: () => {
...
function Breadcrumbs({
  ...
  const contentMarkup = import_react546.default.createElement(import_react546.default.Fragment, null, import_react546.default.createElement("span", {
    className: styles46.Icon
  }, import_react546.default.createElement(Icon, {
    source: SvgArrowLeftMinor
  })), import_react546.default.createElement(VisuallyHidden, null, content));
  const breadcrumbMarkup = "url" in breadcrumb ? import_react546.default.createElement(UnstyledLink, {
    key: content,
    url: breadcrumb.url,
    className: styles46.Breadcrumb,
    onMouseUp: handleMouseUpByBlurring,
    "aria-label": breadcrumb.accessibilityLabel
  }, contentMarkup) : import_react546.default.createElement("button", {
    key: content,
    className: styles46.Breadcrumb,
  ...
  return import_react546.default.createElement("nav", {
    role: "navigation"
  }, breadcrumbMarkup);
}
...
var TransitionGroupContext_default = import_react547.default.createContext(null);
...
var Transition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react548.default.createElement(TransitionGroupContext_default.Provider, {
      value: null
    }, typeof children2 === "function" ? children2(status, childProps) : import_react548.default.cloneElement(import_react548.default.Children.only(children2), childProps));
  };
  return Transition2;
}(import_react548.default.Component);
...
var CSSTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react549.default.createElement(Transition_default, _extends({}, props, {
...
}(import_react549.default.Component);
...
function getChildMapping(children2, mapFn) {
  var mapper = function mapper2(child) {
    return mapFn && (0, import_react550.isValidElement)(child) ? mapFn(child) : child;
  };
  var result = /* @__PURE__ */ Object.create(null);
  if (children2)
    import_react550.Children.map(children2, function(c) {
      return c;
...
function getInitialChildMapping(props, onExited) {
  return getChildMapping(props.children, function(child) {
    return (0, import_react550.cloneElement)(child, {
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach(function(key) {
    ...
    if (!(0, import_react550.isValidElement)(child))
      return;
    var hasPrev = key in prevChildMapping;
    var hasNext = key in nextChildMapping;
    var prevChild = prevChildMapping[key];
    var isLeaving = (0, import_react550.isValidElement)(prevChild) && !prevChild.props.in;
    if (hasNext && (!hasPrev || isLeaving)) {
      children2[key] = (0, import_react550.cloneElement)(child, {
        onExited: onExited.bind(null, child),
        in: true,
    ...
    } else if (hasNext && hasPrev && (0, import_react550.isValidElement)(prevChild)) {
      children2[key] = (0, import_react550.cloneElement)(child, {
        onExited: onExited.bind(null, child),
...
var TransitionGroup = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    delete props.exit;
    if (Component9 === null) {
      return import_react551.default.createElement(TransitionGroupContext_default.Provider, {
        value: contextValue
      }, children2);
    }
    return import_react551.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, import_react551.default.createElement(Component9, props, children2));
  };
  return TransitionGroup2;
}(import_react551.default.Component);
...
var ReplaceTransition = function(_React$Component) {
  ...
  _proto.handleLifecycle = function handleLifecycle(handler, idx, originalArgs) {
    ...
    var child = import_react552.default.Children.toArray(children2)[idx];
  ...
  _proto.render = function render() {
    ...
    var _React$Children$toArr = import_react552.default.Children.toArray(children2), first = _React$Children$toArr[0], second = _React$Children$toArr[1];
    ...
    return import_react552.default.createElement(TransitionGroup_default, props, inProp ? import_react552.default.cloneElement(first, {
      key: "first",
      onEnter: this.handleEnter,
      onEntering: this.handleEntering,
      onEntered: this.handleEntered
    }) : import_react552.default.cloneElement(second, {
      key: "second",
...
}(import_react552.default.Component);
ReplaceTransition.propTypes = true ? {
  in: import_prop_types5.default.bool.isRequired,
  children: function children(props, propName) {
    if (import_react552.default.Children.count(props[propName]) !== 2)
...
function areChildrenDifferent(oldChildren, newChildren) {
  if (oldChildren === newChildren)
    return false;
  if (import_react553.default.isValidElement(oldChildren) && import_react553.default.isValidElement(newChildren) && oldChildren.key != null && oldChildren.key === newChildren.key) {
    return false;
  }
  return true;
}
...
var leaveRenders = (_leaveRenders = {}, _leaveRenders[modes.out] = function(_ref) {
  ...
  return import_react553.default.cloneElement(current, {
    in: false,
  ...
  return [current, import_react553.default.cloneElement(children2, {
    in: true,
...
var enterRenders = (_enterRenders = {}, _enterRenders[modes.out] = function(_ref3) {
  ...
  return import_react553.default.cloneElement(children2, {
    in: true,
    onEntered: callHook(children2, "onEntered", function() {
      changeState(ENTERED, import_react553.default.cloneElement(children2, {
        in: true
      }));
    })
  });
  ...
  }), import_react553.default.cloneElement(children2, {
    in: true
  })];
}, _enterRenders);
var SwitchTransition = function(_React$Component) {
  ...
  SwitchTransition2.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    return {
      current: import_react553.default.cloneElement(props.children, {
        in: true
      })
    };
  };
  _proto.render = function render() {
    ...
    return import_react553.default.createElement(TransitionGroupContext_default.Provider, {
      value: {
...
}(import_react553.default.Component);
...
function useComponentDidMount(callback) {
  const isAfterInitialMount = useIsAfterInitialMount();
  const hasInvokedLifeCycle = (0, import_react554.useRef)(false);
...
function Indicator({
  ...
  const className = classNames(styles48.Indicator, pulse && styles48.pulseIndicator);
  return import_react555.default.createElement("span", {
    className
  });
}
...
function BulkActionButton({
  ...
  const bulkActionButton = (0, import_react556.useRef)(null);
  ...
  return import_react556.default.createElement("div", {
    className: styles47.BulkActionButton,
    ref: bulkActionButton
  }, import_react556.default.createElement(Button, {
    external,
    url,
    "aria-label": accessibilityLabel,
    onClick: onAction,
    disabled,
    disclosure
  }, content), indicator && import_react556.default.createElement(Indicator, null));
}
...
function BulkActionMenu({
  ...
  return import_react557.default.createElement(import_react557.default.Fragment, null, import_react557.default.createElement(Popover2, {
    active: isVisible,
    activator: import_react557.default.createElement(BulkActionButton, {
      disclosure: true,
    ...
    preferInputActivator: true
  }, import_react557.default.createElement(ActionList, {
    items: actions,
...
var ResourceListContext = (0, import_react558.createContext)({});
...
function CheckableButton({
  ...
  const checkBoxRef = (0, import_react559.useRef)(null);
  const {
    registerCheckableButtons
  } = (0, import_react559.useContext)(ResourceListContext);
  ...
  const className = plain ? classNames(styles49.CheckableButton, styles49["CheckableButton-plain"]) : classNames(styles49.CheckableButton, selectMode && styles49["CheckableButton-selectMode"], selected && styles49["CheckableButton-selected"], measuring && styles49["CheckableButton-measuring"]);
  return import_react559.default.createElement("div", {
    className,
    onClick: onToggleAll
  }, import_react559.default.createElement("div", {
    className: styles49.Checkbox
  }, import_react559.default.createElement(Checkbox, {
    label: accessibilityLabel,
    labelHidden: true,
    checked: selected,
    disabled,
    ...
    ref: checkBoxRef
  })), import_react559.default.createElement("span", {
...
var slideClasses = {
  appear: classNames(styles47.Slide, styles47["Slide-appear"]),
  appearActive: classNames(styles47.Slide, styles47["Slide-appearing"]),
  enter: classNames(styles47.Slide, styles47["Slide-enter"]),
  enterActive: classNames(styles47.Slide, styles47["Slide-entering"]),
  exit: classNames(styles47.Slide, styles47["Slide-exit"])
};
var BulkActionsInner = class extends import_react560.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.checkableWrapperNode = (0, import_react560.createRef)();
    this.largeScreenGroupNode = (0, import_react560.createRef)();
    this.smallScreenGroupNode = (0, import_react560.createRef)();
  ...
  render() {
    ...
    const paginatedSelectAllActionMarkup = paginatedSelectAllAction ? import_react560.default.createElement(Button, {
      onClick: paginatedSelectAllAction.onAction,
      plain: true,
      disabled
    }, paginatedSelectAllAction.content) : null;
    const paginatedSelectAllTextMarkup = paginatedSelectAllText && paginatedSelectAllAction ? import_react560.default.createElement("span", {
      "aria-live": "polite"
    }, paginatedSelectAllText) : paginatedSelectAllText;
    const paginatedSelectAllMarkup = paginatedSelectAllActionMarkup || paginatedSelectAllTextMarkup ? import_react560.default.createElement("div", {
      className: styles47.PaginatedSelectAll
    }, paginatedSelectAllTextMarkup, " ", paginatedSelectAllActionMarkup) : null;
    const cancelButton = import_react560.default.createElement(Button, {
      onClick: this.setSelectMode.bind(this, false),
      disabled
    }, i18n.translate("Polaris.Common.cancel"));
    const numberOfPromotedActionsToRender = this.numberOfPromotedActionsToRender();
    const allActionsPopover = this.hasActions() ? import_react560.default.createElement("div", {
      className: styles47.Popover,
      ref: this.setMoreActionsNode
    }, import_react560.default.createElement(Popover2, {
      active: smallScreenPopoverVisible,
      activator: import_react560.default.createElement(BulkActionButton, {
        disclosure: true,
    ...
    const promotedActionsMarkup = promotedActions && numberOfPromotedActionsToRender > 0 ? [...promotedActions].slice(0, numberOfPromotedActionsToRender).map((action, index) => {
      if (instanceOfMenuGroupDescriptor(action)) {
        return import_react560.default.createElement(BulkActionMenu, Object.assign({
          key: index
        }, action, {
          isNewBadgeInBadgeActions: this.isNewBadgeInBadgeActions()
        }));
      }
      return import_react560.default.createElement(BulkActionButton, Object.assign({
        key: index,
        disabled
      }, action, {
    ...
    const actionsPopover = actionSections || rolledInPromotedActions.length > 0 || measuring ? import_react560.default.createElement("div", {
      className: styles47.Popover,
      ref: this.setMoreActionsNode
    }, import_react560.default.createElement(Popover2, {
    ...
    const smallScreenGroup = smallScreen ? import_react560.default.createElement(Transition_default, {
      timeout: 0,
      in: selectMode,
      key: "smallGroup",
      nodeRef: this.smallScreenGroupNode
    }, (status) => {
      const smallScreenGroupClassName = classNames(styles47.Group, styles47["Group-smallScreen"], styles47[`Group-${status}`]);
      return import_react560.default.createElement("div", {
        className: smallScreenGroupClassName,
        ref: this.smallScreenGroupNode
      }, import_react560.default.createElement("div", {
        className: styles47.ButtonGroupWrapper
      }, import_react560.default.createElement(ButtonGroup, {
        segmented: true
      }, import_react560.default.createElement(CSSTransition_default, {
        ...
        className: styles47.CheckableContainer,
        ref: this.checkableWrapperNode
      }, import_react560.default.createElement(CheckableButton, Object.assign({}, checkableButtonProps, {
        smallScreen: true
      })))), allActionsPopover, cancelButton)), paginatedSelectAllMarkup);
    }) : null;
    const largeGroupContent = promotedActionsMarkup || actionsPopover ? import_react560.default.createElement(ButtonGroup, {
      segmented: true
    }, import_react560.default.createElement(CheckableButton, checkableButtonProps), promotedActionsMarkup, actionsPopover) : import_react560.default.createElement(CheckableButton, checkableButtonProps);
    const largeScreenGroup = smallScreen ? null : import_react560.default.createElement(Transition_default, {
      timeout: 0,
      in: selectMode,
      key: "largeGroup",
      nodeRef: this.largeScreenGroupNode
    }, (status) => {
      const largeScreenGroupClassName = classNames(styles47.Group, styles47["Group-largeScreen"], !measuring && styles47[`Group-${status}`], measuring && styles47["Group-measuring"]);
      return import_react560.default.createElement("div", {
        className: largeScreenGroupClassName,
        ref: this.largeScreenGroupNode
      }, import_react560.default.createElement(EventListener, {
        event: "resize",
...
function BulkActions(props) {
  const i18n = useI18n();
  return import_react560.default.createElement(BulkActionsInner, Object.assign({}, props, {
    i18n
  }));
}
...
function TextContainer({
  ...
  const className = classNames(styles51.TextContainer, spacing3 && styles51[variationName("spacing", spacing3)]);
  return import_react561.default.createElement("div", {
    className
  }, children2);
}
...
function CalloutCard({
  ...
  const buttonMarkup = secondaryActionMarkup ? import_react562.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup) : primaryActionMarkup;
  const dismissButton = onDismiss ? import_react562.default.createElement("div", {
    className: styles50.Dismiss
  }, import_react562.default.createElement(Button, {
    plain: true,
    icon: SvgCancelSmallMinor,
    onClick: onDismiss,
  ...
  return import_react562.default.createElement(Card, null, import_react562.default.createElement("div", {
    className: containerClassName
  }, dismissButton, import_react562.default.createElement(Card.Section, null, import_react562.default.createElement("div", {
    className: styles50.CalloutCard
  }, import_react562.default.createElement("div", {
    className: styles50.Content
  }, import_react562.default.createElement("div", {
    className: styles50.Title
  }, import_react562.default.createElement(Heading, null, title)), import_react562.default.createElement(TextContainer, null, children2), import_react562.default.createElement("div", {
    className: styles50.Buttons
  }, buttonMarkup)), import_react562.default.createElement(Image, {
    alt: "",
    className: imageClassName,
    source: illustration
  })))));
...
function Caption({
  ...
  return import_react563.default.createElement("p", {
    className: styles52.Caption
  }, children2);
}
...
function RadioButton({
  ...
  const inputNode = (0, import_react564.useRef)(null);
  const [keyFocused, setKeyFocused] = (0, import_react564.useState)(false);
  const {
    value: mouseOver,
    setTrue: handleMouseOver,
    setFalse: handleMouseOut
  ...
  const ariaDescribedBy = describedBy.length ? describedBy.join(" ") : void 0;
  const inputClassName = classNames(styles54.Input, keyFocused && styles54.keyFocused);
  const backdropClassName = classNames(styles54.Backdrop, mouseOver && styles54.hover);
  return import_react564.default.createElement(Choice, {
    label,
    labelHidden,
    disabled,
    id,
    ...
    onMouseOver: handleMouseOver,
    onMouseOut: handleMouseOut
  }, import_react564.default.createElement("span", {
    className: styles54.RadioButton
  }, import_react564.default.createElement("input", {
    id,
    name,
    value,
    type: "radio",
...
function ChoiceList({
  ...
  const className = classNames(styles53.ChoiceList, titleHidden && styles53.titleHidden);
  const titleMarkup = title ? import_react565.default.createElement("legend", {
    className: styles53.Title
  }, title) : null;
  const choicesMarkup = choices.map((choice) => {
    ...
    const children2 = renderedChildren ? import_react565.default.createElement("div", {
      className: styles53.ChoiceChildren
    }, renderedChildren) : null;
    return import_react565.default.createElement("li", {
      key: value,
      className: styles53.ChoiceItem
    }, import_react565.default.createElement(ControlComponent, {
      name: finalName,
      value,
      id,
      label,
  ...
  const errorMarkup = error && import_react565.default.createElement("div", {
    className: styles53.ChoiceError
  }, import_react565.default.createElement(InlineError, {
    message: error,
    fieldID: finalName
  }));
  return import_react565.default.createElement("fieldset", {
    className,
    id: finalName,
    "aria-invalid": error != null
  }, titleMarkup, import_react565.default.createElement("ul", {
    className: styles53.Choices
...
function Collapsible({
  ...
  const [height, setHeight] = (0, import_react566.useState)(0);
  const [isOpen, setIsOpen] = (0, import_react566.useState)(open);
  const [animationState, setAnimationState] = (0, import_react566.useState)("idle");
  const collapsibleContainer = (0, import_react566.useRef)(null);
  const isFullyOpen = animationState === "idle" && open && isOpen;
  const isFullyClosed = animationState === "idle" && !open && !isOpen;
  const content = expandOnPrint || !isFullyClosed ? children2 : null;
  const wrapperClassName = classNames(styles55.Collapsible, isFullyClosed && styles55.isFullyClosed, expandOnPrint && styles55.expandOnPrint);
  ...
  const handleCompleteAnimation = (0, import_react566.useCallback)(({
    target
  }) => {
  ...
  (0, import_react566.useEffect)(() => {
    if (isFullyClosed || preventMeasuringOnChildrenUpdate)
      return;
    setAnimationState("measuring");
  }, [children2, isFullyClosed, preventMeasuringOnChildrenUpdate]);
  (0, import_react566.useEffect)(() => {
    if (open !== isOpen) {
      setAnimationState("measuring");
    }
...
var Slidable = class extends import_react567.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      dragging: false
  ...
  render() {
    ...
    const moveListener = dragging ? import_react567.default.createElement(EventListener, {
      event: "mousemove",
      handler: this.handleMove,
      passive: false
    }) : null;
    const touchMoveListener = dragging ? import_react567.default.createElement(EventListener, {
      event: "touchmove",
      handler: this.handleMove,
      passive: false
    }) : null;
    const endDragListener = dragging ? import_react567.default.createElement(EventListener, {
      event: "mouseup",
      handler: this.handleDragEnd
    }) : null;
    const touchEndListener = dragging ? import_react567.default.createElement(EventListener, {
      event: "touchend",
      handler: this.handleDragEnd
    }) : null;
    const touchCancelListener = dragging ? import_react567.default.createElement(EventListener, {
      event: "touchcancel",
      handler: this.handleDragEnd
    }) : null;
    return import_react567.default.createElement("div", {
      ref: this.setNode,
      className: styles56.Slidable,
      onMouseDown: this.startDrag,
      onTouchStart: this.startDrag
    }, endDragListener, moveListener, touchMoveListener, touchEndListener, touchCancelListener, import_react567.default.createElement("div", {
      style: draggerPositioning,
      className: styles56.Dragger,
...
// node_modules/@shopify/polaris/build/esm/components/ColorPicker/components/AlphaPicker/AlphaPicker.js
var AlphaPicker = class extends import_react568.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      sliderHeight: 0,
  ...
  render() {
    ...
    return import_react568.default.createElement("div", {
      className: styles56.AlphaPicker,
      ref: this.setSliderHeight
    }, import_react568.default.createElement("div", {
      className: styles56.ColorLayer,
      style: {
        background
      }
    }), import_react568.default.createElement(Slidable, {
      draggerY,
      draggerX: 0,
...
// node_modules/@shopify/polaris/build/esm/components/ColorPicker/components/HuePicker/HuePicker.js
var HuePicker = class extends import_react569.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      sliderHeight: 0,
  ...
  render() {
    ...
    return import_react569.default.createElement("div", {
      className: styles56.HuePicker,
      ref: this.setSliderHeight
    }, import_react569.default.createElement(Slidable, {
      draggerY,
      draggerX: 0,
      onChange: this.handleChange,
      onDraggerHeight: this.setDraggerHeight
...
var ColorPicker = class extends import_react570.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      pickerSize: {
  ...
  render() {
    ...
    const alphaSliderMarkup = allowAlpha ? import_react570.default.createElement(AlphaPicker, {
      alpha,
      color,
      onChange: this.handleAlphaChange
    }) : null;
    const className = classNames(styles56.ColorPicker, fullWidth && styles56.fullWidth);
    return import_react570.default.createElement("div", {
      className,
      id,
      onMouseDown: this.handlePickerDrag
    }, import_react570.default.createElement("div", {
      ref: this.setColorNode,
      className: styles56.MainColor
    }, import_react570.default.createElement("div", {
      className: styles56.ColorLayer,
      style: {
        backgroundColor: colorString
      }
    }), import_react570.default.createElement(Slidable, {
      onChange: this.handleDraggerMove,
      draggerX,
      draggerY
    })), import_react570.default.createElement(HuePicker, {
      hue,
      onChange: this.handleHueChange
    }), alphaSliderMarkup, import_react570.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    }));
  }
...
var FrameContext = (0, import_react571.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/frame/hooks.js
function useFrame() {
  const frame = (0, import_react572.useContext)(FrameContext);
  if (!frame) {
...
// node_modules/@shopify/polaris/build/esm/components/ContextualSaveBar/ContextualSaveBar.js
var ContextualSaveBar = (0, import_react573.memo)(function ContextualSaveBar2({
  message,
  saveAction,
  discardAction,
  alignContentFlush,
...
function Cell({
  ...
  const iconMarkup = import_react574.default.createElement("span", {
    className: iconClassName
  }, import_react574.default.createElement(Icon, {
    source,
    accessibilityLabel: sortAccessibilityLabel
  }));
  const focusable = !(stickyHeadingCell && hasFixedNthColumn && nthColumn && !inFixedNthColumn);
  const sortableHeadingContent = import_react574.default.createElement("button", {
  ...
  const stickyHeading = import_react574.default.createElement("th", Object.assign({
    ref: setRef
  ...
  const headingMarkup = header ? import_react574.default.createElement("th", Object.assign({}, headerCell.props, {
    "aria-sort": sortDirection
  }, colSpanProp, {
    ref: setRef,
    className,
  ...
  }), columnHeadingContent) : import_react574.default.createElement("th", Object.assign({}, colSpanProp, {
    ref: setRef,
    className,
    scope: "row",
    style: {
  ...
  }), truncate ? import_react574.default.createElement(TruncatedText, {
    className: styles57.TooltipContent
  }, content) : content);
  const cellMarkup = header || firstColumn || nthColumn ? headingMarkup : import_react574.default.createElement("td", Object.assign({
    className
  }, colSpanProp), content);
...
var TruncatedText = ({
  ...
  const textRef = (0, import_react574.useRef)(null);
  const {
    current
  } = textRef;
  const text = import_react574.default.createElement("span", {
    ref: textRef,
    className
  }, children2);
  return (current === null || current === void 0 ? void 0 : current.scrollWidth) > (current === null || current === void 0 ? void 0 : current.offsetWidth) ? import_react574.default.createElement(Tooltip, {
...
function AfterInitialMount({
  ...
  return import_react575.default.createElement(import_react575.default.Fragment, null, content);
}
...
function useStickyManager() {
  const stickyManager = (0, import_react576.useContext)(StickyManagerContext);
  if (!stickyManager) {
...
// node_modules/@shopify/polaris/build/esm/components/Sticky/Sticky.js
var StickyInner = class extends import_react577.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      isSticky: false,
  ...
  render() {
    ...
    return import_react577.default.createElement("div", null, import_react577.default.createElement("div", {
...
function Sticky(props) {
  ...
  return import_react577.default.createElement(StickyInner, Object.assign({}, props, {
    stickyManager
  }));
}
...
function Navigation({
  ...
  const pipMarkup = columnVisibilityData.map((column, index) => {
    ...
    return import_react578.default.createElement("div", {
      className,
      key: `pip-${index}`
    });
  });
  ...
  return import_react578.default.createElement("div", {
    ...
    ref: setRef
  }, import_react578.default.createElement(Button, {
    plain: true,
    icon: SvgChevronLeftMinor,
    disabled: isScrolledFarthestLeft,
    accessibilityLabel: leftA11yLabel,
    onClick: navigateTableLeft
  }), pipMarkup, import_react578.default.createElement(Button, {
    plain: true,
...
var DataTableInner = class extends import_react579.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      condensed: false,
    ...
    this.dataTable = (0, import_react579.createRef)();
    this.scrollContainer = (0, import_react579.createRef)();
    this.table = (0, import_react579.createRef)();
    this.stickyTable = (0, import_react579.createRef)();
    this.stickyNav = null;
    this.headerNav = null;
    this.tableHeadings = [];
    this.stickyHeadings = [];
    ...
    this.renderHeading = ({
      ...
      if (inFixedNthColumn && inStickyHeader) {
        ...
        return [import_react579.default.createElement(Cell, Object.assign({
          key: id
        }, cellProps, {
          setRef: (ref) => {
            this.setCellRef({
        ...
        })), import_react579.default.createElement(Cell, Object.assign({
          key: `${id}-sticky`
        }, cellProps, {
          setRef: (ref) => {
            this.setCellRef({
    ...
    this.renderTotals = ({
      ...
      return import_react579.default.createElement(Cell, {
        total: true,
        totalInFooter,
    ...
    this.defaultRenderRow = ({
      ...
      return import_react579.default.createElement("tr", {
        key: `row-${index}`,
        className,
  ...
  render() {
    ...
    const headingMarkup = import_react579.default.createElement("tr", null, headings.map((heading, index) => this.renderHeading({
      heading,
      headingIndex: index,
      inFixedNthColumn: false,
      inStickyHeader: false
    })));
    const totalsMarkup = totals ? import_react579.default.createElement("tr", null, totals.map((total, index) => this.renderTotals({
      total,
      index
    }))) : null;
    ...
    const fixedNthColumnMarkup = condensed && fixedFirstColumns !== 0 && import_react579.default.createElement("table", {
    ...
    }, import_react579.default.createElement("thead", null, import_react579.default.createElement("tr", {
      style: {
      ...
      inStickyHeader: false
    }))), totals && !showTotalsInFooter && import_react579.default.createElement("tr", {
      style: {
      ...
      total,
      index
    })))), import_react579.default.createElement("tbody", null, nthColumns.map((row, index) => this.defaultRenderRow({
      row,
      index,
      inFixedNthColumn: true,
      rowHeights: bodyRowHeights
    }))), totals && showTotalsInFooter && import_react579.default.createElement("tfoot", null, import_react579.default.createElement("tr", null, nthTotals === null || nthTotals === void 0 ? void 0 : nthTotals.map((total, index) => this.renderTotals({
      total,
      index
    })))));
    ...
    const footerMarkup = footerContent ? import_react579.default.createElement("div", {
      className: styles57.Footer
    }, footerContent) : null;
    const headerTotalsMarkup = !showTotalsInFooter ? totalsMarkup : null;
    const footerTotalsMarkup = showTotalsInFooter ? import_react579.default.createElement("tfoot", null, totalsMarkup) : null;
    const navigationMarkup = (location) => hideScrollIndicator ? null : import_react579.default.createElement(Navigation, {
      columnVisibilityData,
      isScrolledFarthestLeft,
      isScrolledFarthestRight,
    ...
    const stickyHeaderMarkup = stickyHeader ? import_react579.default.createElement(AfterInitialMount, null, import_react579.default.createElement("div", {
      className: styles57.StickyHeaderWrapper,
      role: "presentation"
    }, import_react579.default.createElement(Sticky, {
      ...
      return import_react579.default.createElement("div", {
        className: stickyHeaderInnerClassNames
      }, import_react579.default.createElement("div", null, navigationMarkup("sticky")), import_react579.default.createElement("table", {
    ...
    return import_react579.default.createElement("div", {
      className: wrapperClassName,
      ref: this.dataTable
    }, stickyHeaderMarkup, navigationMarkup("header"), import_react579.default.createElement("div", {
      className
    }, import_react579.default.createElement("div", {
      className: styles57.ScrollContainer,
      ref: this.scrollContainer
    }, import_react579.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    }), import_react579.default.createElement(EventListener, {
      capture: true,
    ...
    }), fixedNthColumnMarkup, import_react579.default.createElement("table", {
      className: styles57.Table,
      ref: this.table
    }, import_react579.default.createElement("thead", null, headingMarkup, headerTotalsMarkup), import_react579.default.createElement("tbody", null, bodyMarkup), footerTotalsMarkup)), footerMarkup));
  }
  fixedFirstColumns() {
    const {
      hasFixedFirstColumn,
...
function DataTable(props) {
  const i18n = useI18n();
  return import_react579.default.createElement(DataTableInner, Object.assign({}, props, {
    i18n
  }));
}
...
var Weekday = (0, import_react580.memo)(function Weekday2({
  label,
  title,
  current
}) {
  const className = classNames(styles58.Weekday, current && styles58["Weekday-current"]);
  return import_react580.default.createElement("th", {
    "aria-label": label,
    scope: "col",
    className
  }, title);
...
var Day = (0, import_react581.memo)(function Day2({
  day,
  focused,
  onClick,
  onHover = noop7,
  ...
  const i18n = useI18n();
  const dayNode = (0, import_react581.useRef)(null);
  const hoverValue = lastDayOfMonth || day;
  (0, import_react581.useEffect)(() => {
    if (focused && dayNode.current) {
      dayNode.current.focus();
    }
  }, [focused]);
  if (!day) {
    return import_react581.default.createElement("td", {
  ...
  }, import_react581.default.createElement("button", {
    onFocus: () => onFocus(day),
    type: "button",
    ref: dayNode,
    tabIndex,
...
function Month({
  ...
  const weeks = (0, import_react582.useMemo)(() => getWeeksForMonth(month, year, weekStartsOn), [month, weekStartsOn, year]);
  const weekdays = getOrderedWeekdays(weekStartsOn).map((weekday) => import_react582.default.createElement(Weekday, {
    key: weekday,
    title: i18n.translate(`Polaris.DatePicker.daysAbbreviated.${weekdayName(weekday)}`),
    label: weekdayLabel(weekday),
    current: current && new Date().getDay() === weekday
  }));
  const handleDateClick = (0, import_react582.useCallback)((selectedDate) => {
    onChange(getNewRange(allowRange ? selected : void 0, selectedDate));
  }, [allowRange, onChange, selected]);
  const lastDayOfMonth = (0, import_react582.useMemo)(() => new Date(year, month + 1, 0), [month, year]);
  function renderWeek(day, dayIndex) {
    if (day == null) {
      return import_react582.default.createElement(Day, {
        key: dayIndex,
        onHover,
        lastDayOfMonth
      });
  ...
  const weeksMarkup = weeks.map((week, index) => import_react582.default.createElement("tr", {
    className: styles58.Week,
    key: index
  }, week.map(renderWeek)));
  return import_react582.default.createElement("div", {
    className: styles58.MonthContainer
  }, import_react582.default.createElement("table", {
    role: "grid",
    className: styles58.Month
  }, import_react582.default.createElement("caption", {
    className
  }, i18n.translate(`Polaris.DatePicker.months.${monthName(month)}`), " ", year), import_react582.default.createElement("thead", null, import_react582.default.createElement("tr", {
    className: styles58.WeekHeadings
  }, weekdays)), import_react582.default.createElement("tbody", null, weeksMarkup)));
...
function DatePicker({
  ...
  const i18n = useI18n();
  const [hoverDate, setHoverDate] = (0, import_react583.useState)(void 0);
  const [focusDate, setFocusDate] = (0, import_react583.useState)(void 0);
  (0, import_react583.useEffect)(() => {
    setFocusDate(void 0);
  }, [selected]);
  const handleFocus = (0, import_react583.useCallback)((date) => {
    setFocusDate(date);
  }, []);
  const setFocusDateAndHandleMonthChange = (0, import_react583.useCallback)((date) => {
    if (onMonthChange) {
  ...
  const handleDateSelection = (0, import_react583.useCallback)((range) => {
    const {
      end
    } = range;
    setHoverDate(end);
  ...
  const handleMonthChangeClick = (0, import_react583.useCallback)((month2, year2) => {
    if (!onMonthChange) {
      return;
    }
    setFocusDate(void 0);
  ...
  const handleHover = (0, import_react583.useCallback)((date) => {
    setHoverDate(date);
  }, []);
  const handleKeyUp = (0, import_react583.useCallback)((event) => {
    const {
      key
    } = event;
  ...
  const monthIsSelected = (0, import_react583.useMemo)(() => deriveRange(selected), [selected]);
  ...
  const secondDatePicker = multiMonth ? import_react583.default.createElement(Month, {
    onFocus: handleFocus,
  ...
  return import_react583.default.createElement("div", {
    id,
    className: datePickerClassName,
    onKeyDown: handleKeyDown,
    onKeyUp: handleKeyUp
  }, import_react583.default.createElement("div", {
    className: styles58.Header
  }, import_react583.default.createElement(Button, {
    plain: true,
  ...
  }, import_react583.default.createElement(Month, {
    onFocus: handleFocus,
    focusedDate: focusDate,
    month,
    year,
...
function DescriptionList({
  items,
  spacing: spacing3 = "loose"
}) {
  const terms = items.reduce((allTerms, {
    term,
    description
  }, index) => [...allTerms, import_react584.default.createElement("dt", {
    key: `dt${index}`,
    className: styles59.Term
  }, term), import_react584.default.createElement("dd", {
    key: `dd${index}`,
    className: styles59.Description
  }, description)], []);
  const className = classNames(styles59.DescriptionList, spacing3 === "tight" && styles59.spacingTight);
  return import_react584.default.createElement("dl", {
    className
  }, terms);
}
...
function DisplayText({
  ...
  const className = classNames(styles60.DisplayText, size && styles60[variationName("size", size)]);
  return import_react585.default.createElement(Element2, {
    className
  }, children2);
}
...
// node_modules/@shopify/polaris/build/esm/components/DropZone/context.js
var DropZoneContext = (0, import_react586.createContext)({
  disabled: false,
  focused: false,
  size: "extraLarge",
  type: "file",
...
function FileUpload(props) {
  ...
  const {
    ...
    disabled,
    allowMultiple
  } = (0, import_react587.useContext)(DropZoneContext);
  ...
  const actionClassNames = classNames(styles62.Action, disabled && styles62.disabled);
  const actionMarkup = import_react587.default.createElement("div", {
    className: actionClassNames
  }, actionTitle);
  const fileUploadClassName = classNames(styles62.FileUpload, measuring && styles62.measuring, size === "large" && styles62.large, size === "small" && styles62.small);
  const actionHintMarkup = actionHint && import_react587.default.createElement(Caption, null, import_react587.default.createElement(TextStyle, {
    variation: "subdued"
  }, actionHint));
  let viewMarkup;
  switch (size) {
    case "large":
      viewMarkup = import_react587.default.createElement(Stack, {
        vertical: true,
        spacing: "tight"
    ...
    case "medium":
      ...
      break;
    case "small":
      viewMarkup = import_react587.default.createElement("img", {
        width: "20",
        src: uploadArrow,
        alt: ""
      });
  ...
  return import_react587.default.createElement("div", {
...
var DropZone = function DropZone2({
  ...
  const node = (0, import_react588.useRef)(null);
  const dragTargets = (0, import_react588.useRef)([]);
  const adjustSize = (0, import_react588.useCallback)(debounce(() => {
    if (!node.current) {
      return;
    }
    if (variableHeight) {
  ...
  const [dragging, setDragging] = (0, import_react588.useState)(false);
  const [internalError, setInternalError] = (0, import_react588.useState)(false);
  const {
    value: focused,
    setTrue: handleFocus,
    setFalse: handleBlur
  } = useToggle(false);
  const [size, setSize] = (0, import_react588.useState)("large");
  const [measuring, setMeasuring] = (0, import_react588.useState)(true);
  const i18n = useI18n();
  const getValidatedFiles = (0, import_react588.useCallback)((files) => {
    const acceptedFiles = [];
    const rejectedFiles = [];
  ...
  const handleDrop = (0, import_react588.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
  ...
  const handleDragEnter = (0, import_react588.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
    const fileList = getDataTransferFiles(event);
  ...
  const handleDragOver = (0, import_react588.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
    onDragOver && onDragOver();
  }, [disabled, onDragOver]);
  const handleDragLeave = (0, import_react588.useCallback)((event) => {
    event.preventDefault();
    if (disabled)
      return;
  ...
  const classes = classNames(styles61.DropZone, outline && styles61.hasOutline, focused && styles61.focused, (active || dragging) && styles61.isDragging, disabled && styles61.isDisabled, (internalError || error) && styles61.hasError, !variableHeight && styles61[variationName("size", size)], measuring && styles61.measuring);
  ...
  const context = (0, import_react588.useMemo)(() => ({
    disabled,
    focused,
    size,
    type: type || "file",
  ...
  return import_react588.default.createElement(DropZoneContext.Provider, {
    value: context
  }, import_react588.default.createElement(Labelled, {
    id,
    label: labelValue,
    action: labelAction,
    labelHidden: labelHiddenValue
  }, import_react588.default.createElement("div", {
    ref: node,
    className: classes,
    "aria-disabled": disabled,
    onClick: handleClick,
    onDragStart: stopEvent
  }, dragOverlay, dragErrorOverlay, import_react588.default.createElement(VisuallyHidden, null, import_react588.default.createElement(DropZoneInput, Object.assign({}, inputAttributes, {
    openFileDialog,
    onFileDialogClose
  }))), import_react588.default.createElement("div", {
  ...
  function overlayMarkup(icon, color, text) {
    return import_react588.default.createElement("div", {
      className: styles61.Overlay
    }, import_react588.default.createElement(Stack, {
      vertical: true,
      spacing: "tight"
    }, size === "small" && import_react588.default.createElement(Icon, {
      source: icon,
      color
    }), (size === "medium" || size === "large") && import_react588.default.createElement(Caption, null, import_react588.default.createElement(TextStyle, {
      variation: "strong"
    }, text))));
  }
  function open() {
...
var DropZoneInput = class extends import_react588.Component {
  constructor(...args) {
    super(...args);
    this.fileInputNode = (0, import_react588.createRef)();
  ...
  render() {
    ...
    return import_react588.default.createElement("input", Object.assign({}, inputProps, {
...
function EmptySearchResult({
  ...
  const descriptionMarkup = description ? import_react589.default.createElement("p", null, description) : null;
  const illustrationMarkup = withIllustration ? import_react589.default.createElement(Image, {
    alt: altText,
    source: emptySearch,
    draggable: false
  }) : null;
  return import_react589.default.createElement(Stack, {
    alignment: "center",
    vertical: true
  }, illustrationMarkup, import_react589.default.createElement(DisplayText, {
    size: "small"
  }, title), import_react589.default.createElement(TextStyle, {
    variation: "subdued"
  }, descriptionMarkup));
}
...
function EmptyState({
  ...
  const withinContentContainer = (0, import_react590.useContext)(WithinContentContext);
  const className = classNames(styles63.EmptyState, fullWidth && styles63.fullWidth, imageContained && styles63.imageContained, withinContentContainer && styles63.withinContentContainer);
  const imageMarkup = largeImage ? import_react590.default.createElement(Image, {
    alt: "",
    role: "presentation",
    className: styles63.Image,
    source: largeImage,
    sourceSet: [{
      source: image,
      descriptor: "568w"
  ...
  }) : import_react590.default.createElement(Image, {
    role: "presentation",
    alt: "",
    className: styles63.Image,
    source: image
  ...
  const footerContentMarkup = footerContent ? import_react590.default.createElement("div", {
    className: styles63.FooterContent
  }, import_react590.default.createElement(TextContainer, null, footerContent)) : null;
  const headingSize = withinContentContainer ? "small" : "medium";
  const primaryActionMarkup = action ? buttonFrom(action, {
    primary: true,
    size: "medium"
  }) : null;
  const headingMarkup = heading ? import_react590.default.createElement(DisplayText, {
    size: headingSize
  }, heading) : null;
  const childrenMarkup = children2 ? import_react590.default.createElement("div", {
    className: styles63.Content
  }, children2) : null;
  const textContentMarkup = headingMarkup || children2 ? import_react590.default.createElement(TextContainer, null, headingMarkup, childrenMarkup) : null;
  const actionsMarkup = primaryActionMarkup || secondaryActionMarkup ? import_react590.default.createElement("div", {
    className: styles63.Actions
  }, import_react590.default.createElement(Stack, {
    alignment: "center",
    distribution: "center",
    spacing: "tight"
  }, secondaryActionMarkup, primaryActionMarkup)) : null;
  const detailsMarkup = textContentMarkup || actionsMarkup || footerContentMarkup ? import_react590.default.createElement("div", {
    className: styles63.DetailsContainer
  }, import_react590.default.createElement("div", {
    className: styles63.Details
  }, textContentMarkup, actionsMarkup, footerContentMarkup)) : import_react590.default.createElement("div", {
    className: styles63.DetailsContainer
  });
  return import_react590.default.createElement("div", {
    className
  }, import_react590.default.createElement("div", {
    className: styles63.Section
  }, detailsMarkup, import_react590.default.createElement("div", {
    className: styles63.ImageContainer
  }, imageMarkup)));
}
...
function Truncate({
  ...
  return import_react591.default.createElement("span", {
...
function ExceptionList({
  ...
  const items = itemsList.map((item, index) => {
    ...
    const itemClasses = classNames(styles64.Item, status && styles64[variationName("status", status)]);
    const iconMarkup = icon ? import_react592.default.createElement(Icon, {
      source: icon
    }) : import_react592.default.createElement("span", {
      className: styles64.Bullet
    });
    const titleMarkup = title && import_react592.default.createElement("span", {
      className: styles64.Title
    }, title);
    const descriptionMarkup = description && import_react592.default.createElement("span", {
      className: styles64.Description
    }, description);
    const Element2 = truncate ? Truncate : import_react592.Fragment;
    return import_react592.default.createElement("li", {
      className: itemClasses,
      key: index
    }, import_react592.default.createElement("span", {
      className: styles64.Icon
    }, iconMarkup), import_react592.default.createElement(Element2, null, titleMarkup, descriptionMarkup));
  });
  return import_react592.default.createElement("ul", {
...
function Item5({
  ...
  const className = classNames(styles67.Item, focused && styles67["Item-focused"]);
  return import_react593.default.createElement("div", {
    onBlur: forceFalseFocused,
    onFocus: forceTrueFocused,
    className
  }, children2);
...
var ConnectedFilterControl = class extends import_react594.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      availableWidth: 0,
    ...
    this.container = (0, import_react594.createRef)();
    this.proxyButtonContainer = (0, import_react594.createRef)();
    this.moreFiltersButtonContainer = (0, import_react594.createRef)();
    this.handleResize = debounce(() => {
  ...
  render() {
    ...
    const className = classNames(styles67.ConnectedFilterControl, rightPopoverableActions && styles67.right);
    ...
    const RightContainerClassName = classNames(styles67.RightContainer, !shouldRenderMoreFiltersButton && styles67.RightContainerWithoutMoreFilters, queryFieldHidden && styles67.queryFieldHidden);
    const rightMarkup = actionsToRender.length > 0 ? import_react594.default.createElement("div", {
      className: RightContainerClassName
    }, this.popoverFrom(actionsToRender)) : null;
    const moreFiltersButtonContainerClassname = classNames(styles67.MoreFiltersButtonContainer, actionsToRender.length === 0 && styles67.onlyButtonVisible);
    const rightActionMarkup = rightAction ? import_react594.default.createElement("div", {
      ref: this.moreFiltersButtonContainer,
      className: moreFiltersButtonContainerClassname
    }, shouldRenderMoreFiltersButton && import_react594.default.createElement(Item5, null, rightAction)) : null;
    const proxyButtonMarkup = rightPopoverableActions ? import_react594.default.createElement("div", {
      className: styles67.ProxyButtonContainer,
      ref: this.proxyButtonContainer,
      "aria-hidden": true
    }, rightPopoverableActions.map((action) => import_react594.default.createElement("div", {
      key: action.key,
      "data-key": action.key
    }, this.activatorButtonFrom(action, {
      proxy: true
    })))) : null;
    const auxMarkup = auxiliary ? import_react594.default.createElement("div", {
      className: styles67.AuxiliaryContainer
    }, auxiliary) : null;
    return import_react594.default.createElement(import_react594.default.Fragment, null, proxyButtonMarkup, import_react594.default.createElement("div", {
      className: styles67.Wrapper
    }, import_react594.default.createElement("div", {
      className,
      ref: this.container
    }, children2 ? import_react594.default.createElement("div", {
      className: styles67.CenterContainer
    }, import_react594.default.createElement(Item5, null, children2)) : null, rightMarkup, rightActionMarkup, import_react594.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })), auxMarkup));
  }
  ...
  activatorButtonFrom(action, options) {
    ...
    return import_react594.default.createElement(Button, {
      onClick: action.onAction,
      disclosure: true,
  ...
  popoverFrom(actions) {
    return actions.map((action) => {
      return import_react594.default.createElement(Item5, {
        key: action.key
      }, import_react594.default.createElement(Popover2, {
...
function TagsWrapper({
  ...
  if (hidden) {
    return import_react595.default.createElement(VisuallyHidden, null, children2);
  }
  return import_react595.default.createElement(import_react595.default.Fragment, null, children2);
}
...
function Tag({
  ...
  const className = classNames(styles68.Tag, disabled && styles68.disabled, onClick && styles68.clickable, onRemove && styles68.removable, url && !disabled && styles68.linkable, segmented && styles68.segmented);
  if (onClick) {
    return import_react596.default.createElement("button", {
      type: "button",
      disabled,
      className,
      onClick
  ...
  const removeButton = onRemove ? import_react596.default.createElement("button", {
    type: "button",
    "aria-label": ariaLabel,
    className: classNames(styles68.Button, segmented && styles68.segmented),
    onClick: onRemove,
    onMouseUp: handleMouseUpByBlurring,
    disabled
  }, import_react596.default.createElement(Icon, {
    source: SvgCancelSmallMinor
  })) : null;
  const tagContent = url && !disabled ? import_react596.default.createElement("a", {
    className: classNames(styles68.Link, segmented && styles68.segmented),
    href: url
  }, import_react596.default.createElement("span", {
    title: tagTitle,
    className: styles68.LinkText
  }, children2)) : import_react596.default.createElement("span", {
    title: tagTitle,
    className: styles68.TagText
  }, children2);
  return import_react596.default.createElement("span", {
    className
...
function useMediaQuery() {
  const mediaQuery = (0, import_react597.useContext)(MediaQueryContext);
  if (!mediaQuery) {
...
function useFocusManager({
  ...
  const focusManager = (0, import_react598.useContext)(FocusManagerContext);
  ...
  const value = (0, import_react598.useMemo)(() => ({
    canSafelyFocus
  }), [canSafelyFocus]);
  (0, import_react598.useEffect)(() => {
    if (!trapping)
      return;
    addFocusItem(id);
    return () => {
...
var Focus = (0, import_react599.memo)(function Focus2({
  children: children2,
  disabled,
  root
}) {
  (0, import_react599.useEffect)(() => {
    if (disabled || !root) {
      return;
    }
  ...
  return import_react599.default.createElement(import_react599.default.Fragment, null, children2);
});
function isRef(ref) {
...
function TrapFocus({
  ...
  const focusTrapWrapper = (0, import_react600.useRef)(null);
  const [disableFocus, setDisableFocus] = (0, import_react600.useState)(true);
  (0, import_react600.useEffect)(() => {
  ...
  return import_react600.default.createElement(Focus, {
    disabled: disableFocus,
    root: focusTrapWrapper.current
  }, import_react600.default.createElement("div", {
    ref: focusTrapWrapper
  }, import_react600.default.createElement(EventListener, {
    event: "focusin",
    handler: handleFocusIn
  }), import_react600.default.createElement(KeypressListener, {
    keyCode: Key.Tab,
    keyEvent: "keydown",
    handler: handleTab
  }), children2));
...
var BOTTOM_CLASS_NAMES = {
  enter: classNames(styles69.Bottom, styles69.enterBottom),
  enterActive: classNames(styles69.Bottom, styles69.enterBottomActive),
  exit: classNames(styles69.Bottom, styles69.exitBottom),
  exitActive: classNames(styles69.Bottom, styles69.exitBottomActive)
};
var RIGHT_CLASS_NAMES = {
  enter: classNames(styles69.Right, styles69.enterRight),
  enterActive: classNames(styles69.Right, styles69.enterRightActive),
  exit: classNames(styles69.Right, styles69.exitRight),
  exitActive: classNames(styles69.Right, styles69.exitRightActive)
};
function Sheet({
  children: children2,
  open,
  ...
  const container = (0, import_react601.useRef)(null);
  const activatorRef = (0, import_react601.useRef)(null);
  const handleClose = (0, import_react601.useCallback)(() => {
    onClose();
  ...
  const activatorMarkup = activator && !isRef2(activator) ? import_react601.default.createElement("div", {
    ref: activatorRef
  }, activator) : null;
  return import_react601.default.createElement(import_react601.default.Fragment, null, activatorMarkup, import_react601.default.createElement(Portal, {
    idPrefix: "sheet"
  }, import_react601.default.createElement(CSSTransition_default, {
    nodeRef: container,
    ...
    onEntered,
    onExit
  }, import_react601.default.createElement("div", Object.assign({
    className: styles69.Container
  }, layer.props, overlay.props, {
    ref: container
  }), import_react601.default.createElement(TrapFocus, {
    trapping: open
  }, import_react601.default.createElement("div", {
    role: "dialog",
    "aria-modal": true,
    tabIndex: -1,
    className: styles69.Sheet,
    "aria-label": accessibilityLabel
  }, children2)))), import_react601.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: handleClose
  }), open && import_react601.default.createElement(Backdrop, {
    transparent: true,
    onClick: handleClose
  })));
}
...
var FiltersInner = class extends import_react602.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      open: false,
    ...
    this.moreFiltersButtonContainer = (0, import_react602.createRef)();
    this.moreFiltersDoneButtonContainer = (0, import_react602.createRef)();
    this.focusNode = (0, import_react602.createRef)();
    this.closeFilters = () => {
      this.setState({
        open: false
      }, () => {
  ...
  render() {
    ...
    const backdropMarkup = open ? import_react602.default.createElement(import_react602.default.Fragment, null, import_react602.default.createElement(ScrollLock, null), import_react602.default.createElement("div", {
      className: styles66.Backdrop,
    ...
    const filtersContentMarkup = filters.map((filter, index) => {
      ...
      const className = classNames(styles66.FilterTriggerContainer, filterIsOpen && styles66.open, index === 0 && styles66.first, filters.length !== 1 && index === filters.length - 1 && styles66.last);
      const appliedFilterContent = this.getAppliedFilterContent(filter.key);
      const appliedFilterBadgeMarkup = appliedFilterContent ? import_react602.default.createElement("div", {
        className: styles66.AppliedFilterBadgeContainer
      }, import_react602.default.createElement(Badge, {
        size: "small",
        status: "new"
      }, appliedFilterContent)) : null;
      const collapsibleID = `${filter.key}Collapsible`;
      const buttonClassName = classNames(styles66.FilterTrigger);
      return import_react602.default.createElement("div", {
        key: filter.key,
        className
      }, import_react602.default.createElement("button", {
      ...
      }, import_react602.default.createElement("div", {
        className: styles66.FilterTriggerLabelContainer
      }, import_react602.default.createElement("h3", {
        className: styles66.FilterTriggerTitle
      }, import_react602.default.createElement(TextStyle, {
        variation: this.props.disabled || filter.disabled ? "subdued" : void 0
      }, filter.label)), import_react602.default.createElement("span", {
        className: styles66.FilterTriggerIcon
      }, import_react602.default.createElement(Icon, {
        source: icon,
        color: "base"
      }))), appliedFilterBadgeMarkup), import_react602.default.createElement(Collapsible, {
        id: collapsibleID,
        open: filterIsOpen
      }, import_react602.default.createElement("div", {
        className: styles66.FilterNodeContainer
      }, import_react602.default.createElement(Focus, {
    ...
    const rightActionMarkup = filters.length ? import_react602.default.createElement("div", {
      ref: this.moreFiltersButtonContainer
    }, import_react602.default.createElement(Button, {
    ...
    const filtersControlMarkup = import_react602.default.createElement(ConnectedFilterControl, {
    ...
    }, hideQueryField ? null : import_react602.default.createElement(TextField, {
      ...
      labelHidden: true,
      prefix: import_react602.default.createElement("span", {
        className: styles66.SearchIcon
      }, import_react602.default.createElement(Icon, {
    ...
    const filtersContainerHeaderClassname = classNames(styles66.FiltersContainerHeader);
    const filtersDesktopHeaderMarkup = import_react602.default.createElement("div", {
      className: filtersContainerHeaderClassname
    }, import_react602.default.createElement(DisplayText, {
      size: "small",
      element: "h3"
    }, moreFiltersLabel), import_react602.default.createElement(Button, {
      icon: SvgCancelSmallMinor,
      plain: true,
      accessibilityLabel: i18n.translate("Polaris.Filters.cancel"),
      onClick: this.closeFilters
    }));
    const filtersMobileHeaderMarkup = import_react602.default.createElement("div", {
      className: filtersContainerHeaderClassname
    }, import_react602.default.createElement(Button, {
      icon: SvgCancelSmallMinor,
      plain: true,
    ...
    const filtersDesktopFooterClassname = classNames(styles66.FiltersContainerFooter);
    const filtersDesktopFooterMarkup = import_react602.default.createElement("div", {
      className: filtersDesktopFooterClassname
    }, import_react602.default.createElement(Button, {
      onClick: this.handleClearAll,
      disabled: !this.hasAppliedFilters()
    }, i18n.translate("Polaris.Filters.clearAllFilters")), import_react602.default.createElement("div", {
      ref: this.moreFiltersDoneButtonContainer
    }, import_react602.default.createElement(Button, {
      onClick: this.closeFilters,
      primary: true
    }, i18n.translate("Polaris.Filters.done"))));
    const filtersMobileFooterMarkup = import_react602.default.createElement("div", {
      className: styles66.FiltersMobileContainerFooter
    }, this.hasAppliedFilters() ? import_react602.default.createElement(Button, {
      onClick: onClearAll,
      fullWidth: true
    }, i18n.translate("Polaris.Filters.clearAllFilters")) : import_react602.default.createElement("div", {
      className: styles66.EmptyFooterState
    }, import_react602.default.createElement(TextStyle, {
      variation: "subdued"
    }, import_react602.default.createElement("p", null, i18n.translate("Polaris.Filters.noFiltersApplied")))));
    const shouldHideTagsContainer = !appliedFilters || appliedFilters.length < 1;
    const tagsMarkup = !hideTags ? import_react602.default.createElement(TagsWrapper, {
      hidden: shouldHideTagsContainer
    }, import_react602.default.createElement("div", {
      className: styles66.TagsContainer,
      "aria-live": "polite"
    }, (appliedFilters || []).map((filter) => {
      return import_react602.default.createElement(Tag, {
        key: filter.key,
        onRemove: () => {
    ...
    const filtersMobileContainerContentClassName = classNames(styles66.FiltersMobileContainerContent);
    const filtersDesktopContainerContentClassName = classNames(styles66.FiltersDesktopContainerContent);
    const filtersContainerMarkup = isNavigationCollapsed ? import_react602.default.createElement(Sheet, {
      accessibilityLabel: moreFiltersLabel,
      open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
      onExit: this.setReadyForFocus(false)
    }, filtersMobileHeaderMarkup, import_react602.default.createElement(Scrollable, {
      className: filtersMobileContainerContentClassName,
      shadow: true
    }, filtersContentMarkup, filtersMobileFooterMarkup)) : import_react602.default.createElement(Sheet, {
      accessibilityLabel: moreFiltersLabel,
      open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
      ...
      className: styles66.FiltersContainer
    }, filtersDesktopHeaderMarkup, import_react602.default.createElement(Scrollable, {
      className: filtersDesktopContainerContentClassName,
      shadow: true
    }, filtersContentMarkup), filtersDesktopFooterMarkup));
    const helpTextMarkup = helpText ? import_react602.default.createElement("div", {
      id: "FiltersHelpText",
      className: styles66.HelpText
    }, import_react602.default.createElement(TextStyle, {
      variation: "subdued"
    }, helpText)) : null;
    return import_react602.default.createElement(WithinFilterContext.Provider, {
      value: true
    }, import_react602.default.createElement("div", {
      className: styles66.Filters
    }, filtersControlMarkup, filtersContainerMarkup, tagsMarkup, helpTextMarkup, backdropMarkup, import_react602.default.createElement(KeypressListener, {
      keyCode: Key.Escape,
  ...
  generateFilterMarkup(filter) {
    ...
    const clearButtonMarkup = !filter.hideClearButton && import_react602.default.createElement(Button, {
      plain: true,
    ...
    return import_react602.default.createElement("div", {
      ref: this.focusNode
    }, import_react602.default.createElement(Stack, {
      vertical: true,
      spacing: "tight"
...
function Filters(props) {
  ...
  return import_react602.default.createElement(FiltersInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
function FooterHelp({
  ...
  return import_react603.default.createElement("div", {
    className: styles70.FooterHelp
  }, import_react603.default.createElement("div", {
    className: styles70.Text
  }, children2));
}
...
function Form({
  ...
  const i18n = useI18n();
  const handleSubmit = (0, import_react604.useCallback)((event) => {
    if (!preventDefault2) {
      return;
    }
    event.preventDefault();
  ...
  const submitMarkup = implicitSubmit ? import_react604.default.createElement(VisuallyHidden, null, import_react604.default.createElement("button", {
    type: "submit",
    "aria-hidden": "true",
    tabIndex: -1
  }, i18n.translate("Polaris.Common.submit"))) : null;
  return import_react604.default.createElement("form", {
    acceptCharset,
    action,
...
function Item6({
  ...
  return children2 ? import_react605.default.createElement("div", {
    className: styles71.Item
  }, children2) : null;
}
...
function Group({
  ...
  const className = classNames(condensed ? styles71.condensed : styles71.grouped);
  ...
  if (helpText) {
    ...
    helpTextElement = import_react606.default.createElement("div", {
      id: helpTextID3,
      className: styles71.HelpText
    }, helpText);
  }
  if (title) {
    titleID = `${id}Title`;
    titleElement = import_react606.default.createElement("div", {
      id: titleID,
      className: styles71.Title
    }, title);
  }
  const itemsMarkup = import_react606.Children.map(children2, (child) => wrapWithComponent(child, Item6, {}));
  return import_react606.default.createElement("div", {
    ...
    className: styles71.Items
  }, itemsMarkup), helpTextElement);
}

// node_modules/@shopify/polaris/build/esm/components/FormLayout/FormLayout.js
var FormLayout = (0, import_react607.memo)(function FormLayout2({
  children: children2
}) {
  return import_react607.default.createElement("div", {
    className: styles71.FormLayout
  }, import_react607.Children.map(children2, wrapChildren));
});
...
function useIsMountedRef() {
  const isMounted = (0, import_react608.useRef)(false);
...
function Loading2() {
  ...
  const [progress, setProgress] = (0, import_react609.useState)(0);
  const [animating, setAnimating] = (0, import_react609.useState)(false);
  (0, import_react609.useEffect)(() => {
  ...
  return import_react609.default.createElement("div", {
    className: styles73.Loading,
    "aria-valuenow": progress,
    "aria-valuemin": 0,
    "aria-valuemax": 100,
    role: "progressbar",
    "aria-label": i18n.translate("Polaris.Loading.label")
  }, import_react609.default.createElement("div", {
    className: styles73.Level,
    style: customStyles,
...
function CSSAnimation({
  ...
  const [transitionStatus, setTransitionStatus] = (0, import_react610.useState)(inProp ? TransitionStatus2.Entering : TransitionStatus2.Exited);
  const isMounted = (0, import_react610.useRef)(false);
  const node = (0, import_react610.useRef)(null);
  (0, import_react610.useEffect)(() => {
  ...
  const wrapperClassName = classNames(className, styles74[variationName("start", type)], inProp && styles74[variationName("end", type)]);
  const content = transitionStatus === TransitionStatus2.Exited && !inProp ? null : children2;
  return import_react610.default.createElement("div", {
    className: wrapperClassName,
    ref: node,
...
function Dialog({
  ...
  const containerNode = (0, import_react611.useRef)(null);
  const classes = classNames(styles77.Modal, small && styles77.sizeSmall, large && styles77.sizeLarge, limitHeight && styles77.limitHeight, fullScreen && styles77.fullScreen);
  ...
  return import_react611.default.createElement(TransitionChild, Object.assign({}, props, {
    ...
    onEntered,
    onExited
  }), import_react611.default.createElement("div", {
    className: styles77.Container,
    "data-polaris-layer": true,
    "data-polaris-overlay": true,
    ref: containerNode
  }, import_react611.default.createElement(TrapFocus, null, import_react611.default.createElement("div", {
    role: "dialog",
    "aria-modal": true,
    ...
    className: classes
  }, import_react611.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: onClose
  }), children2)))));
}
...
function FadeUp({
  ...
  return import_react611.default.createElement(CSSTransition_default, Object.assign({}, props, {
...
function CloseButton({
  ...
  const i18n = useI18n();
  return import_react612.default.createElement("button", {
    onClick,
    className: classNames(styles79.CloseButton, titleHidden && styles79.titleHidden),
...
function Header3({
  ...
  return import_react613.default.createElement("div", {
    className: titleHidden || !children2 ? styles78.titleHidden : styles78.Header
  }, import_react613.default.createElement("div", {
    id,
    className: styles78.Title
  }, import_react613.default.createElement(DisplayText, {
    element: "h2",
    size: "small"
  }, children2)), import_react613.default.createElement(CloseButton, {
    titleHidden,
    onClick: onClose
  }));
}
...
function Section5({
  ...
  const className = classNames(styles80.Section, flush && styles80.flush, subdued && styles80.subdued, titleHidden && styles80.titleHidden);
  return import_react614.default.createElement("section", {
    className
  }, children2);
}
...
function Footer({
  ...
  const actions = primaryActionButton || secondaryActionButtons ? import_react615.default.createElement(ButtonGroup, null, secondaryActionButtons, primaryActionButton) : null;
  return import_react615.default.createElement("div", {
    className: styles81.Footer
  }, import_react615.default.createElement("div", {
    className: styles81.FooterContent
  }, import_react615.default.createElement(Stack, {
    alignment: "center"
  }, import_react615.default.createElement(Stack.Item, {
    fill: true
  }, children2), actions)));
}
...
var Modal = function Modal2({
  ...
  const [iframeHeight, setIframeHeight] = (0, import_react616.useState)(IFRAME_LOADING_HEIGHT);
  const headerId = useUniqueId("modal-header");
  const activatorRef = (0, import_react616.useRef)(null);
  const i18n = useI18n();
  const iframeTitle = i18n.translate("Polaris.Modal.iFrameTitle");
  let dialog;
  let backdrop;
  const handleEntered = (0, import_react616.useCallback)(() => {
    if (onTransitionEnd) {
      onTransitionEnd();
    }
  }, [onTransitionEnd]);
  const handleExited = (0, import_react616.useCallback)(() => {
  ...
  const handleIFrameLoad = (0, import_react616.useCallback)((evt) => {
  ...
  if (open) {
    const footerMarkup = !footer && !primaryAction && !secondaryActions ? null : import_react616.default.createElement(Footer, {
      primaryAction,
      secondaryActions
    }, footer);
    ...
    const body = loading ? import_react616.default.createElement("div", {
      className: styles76.Spinner
    }, import_react616.default.createElement(Spinner, null)) : content;
    const scrollContainerMarkup = noScroll ? import_react616.default.createElement("div", {
      className: styles76.Body
    }, body) : import_react616.default.createElement(Scrollable, {
      shadow: true,
      className: styles76.Body,
      onScrolledToBottom
    }, body);
    const bodyMarkup = src ? import_react616.default.createElement("iframe", {
      name: iFrameName,
      title: iframeTitle,
      src,
      className: styles76.IFrame,
      onLoad: handleIFrameLoad,
      style: {
        height: `${iframeHeight}px`
      }
    }) : scrollContainerMarkup;
    dialog = import_react616.default.createElement(Dialog, {
      instant,
      labelledBy: headerId,
      onClose,
      ...
      limitHeight,
      fullScreen
    }, import_react616.default.createElement(Header3, {
      titleHidden,
      id: headerId,
      onClose
    }, title), import_react616.default.createElement("div", {
      className: styles76.BodyWrapper
    }, bodyMarkup), footerMarkup);
    backdrop = import_react616.default.createElement(Backdrop, {
      onClick: onClose
    });
  }
  const animated = !instant;
  const activatorMarkup = activator && !isRef3(activator) ? import_react616.default.createElement("div", {
    ref: activatorRef
  }, activator) : null;
  return import_react616.default.createElement(WithinContentContext.Provider, {
    value: true
  }, activatorMarkup, import_react616.default.createElement(Portal, {
    idPrefix: "modal"
  }, import_react616.default.createElement(TransitionGroup_default, {
    appear: animated,
    enter: animated,
    exit: animated
  }, dialog), backdrop));
...
function DiscardConfirmationModal({
  ...
  const i18n = useI18n();
  return import_react617.default.createElement(Modal, {
...
function ContextualSaveBar3({
  ...
  const handleDiscardAction = (0, import_react618.useCallback)(() => {
  ...
  const discardConfirmationModalMarkup = discardAction && discardAction.onAction && discardAction.discardConfirmationModal && import_react618.default.createElement(DiscardConfirmationModal, {
    open: discardConfirmationModalVisible,
    onCancel: toggleDiscardConfirmationModal,
    onDiscard: handleDiscardAction
  });
  const discardActionMarkup = discardAction && import_react618.default.createElement(Button, {
  ...
  const saveActionMarkup = saveAction && import_react618.default.createElement(Button, {
    primary: true,
    url: saveAction.url,
  ...
  const imageMarkup = logo && import_react618.default.createElement(Image, {
    style: {
      width
    },
  ...
  const logoMarkup = alignContentFlush || contextControl ? null : import_react618.default.createElement("div", {
    className: styles75.LogoContainer,
    style: {
      width
    }
  }, imageMarkup);
  const contextControlMarkup = contextControl ? import_react618.default.createElement("div", {
    className: styles75.ContextControl
  }, contextControl) : null;
  const contentsClassName = classNames(styles75.Contents, fullWidth && styles75.fullWidth);
  return import_react618.default.createElement(import_react618.default.Fragment, null, import_react618.default.createElement("div", {
    className: styles75.ContextualSaveBar
  }, contextControlMarkup, logoMarkup, import_react618.default.createElement("div", {
    className: contentsClassName
  }, import_react618.default.createElement("h2", {
    className: styles75.Message
  }, message), import_react618.default.createElement("div", {
    className: styles75.ActionContainer
  }, import_react618.default.createElement(Stack, {
    spacing: "tight",
    wrap: false
...
function useDeepCompareRef(dependencies, comparator = import_react_fast_compare2.default) {
  const dependencyList = (0, import_react619.useRef)(dependencies);
...
function useDeepEffect(callback, dependencies, customCompare) {
  (0, import_react620.useEffect)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
function useDeepCallback(callback, dependencies, customCompare) {
  return (0, import_react621.useCallback)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
function Toast({
  ...
  const dismissMarkup = import_react622.default.createElement("button", {
    type: "button",
    className: styles83.CloseButton,
    onClick: onDismiss
  }, import_react622.default.createElement(Icon, {
    source: SvgMobileCancelMajor
  }));
  const actionMarkup = action ? import_react622.default.createElement("div", {
    className: styles83.Action
  }, import_react622.default.createElement(Button, {
    plain: true,
    monochrome: true,
    onClick: action.onAction
  }, action.content)) : null;
  const className = classNames(styles83.Toast, error && styles83.error);
  return import_react622.default.createElement("div", {
    className
  }, import_react622.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: onDismiss
...
// node_modules/@shopify/polaris/build/esm/components/Frame/components/ToastManager/ToastManager.js
var ToastManager = (0, import_react623.memo)(function ToastManager2({
  toastMessages
}) {
  const toastNodes = [];
  ...
  const toastsMarkup = toastMessages.map((toast, index) => {
    const toastNode = (0, import_react623.createRef)();
    toastNodes[index] = toastNode;
    return import_react623.default.createElement(CSSTransition_default, {
    ...
    }, import_react623.default.createElement("div", {
      ref: toastNode
    }, import_react623.default.createElement(Toast, toast)));
  });
  return import_react623.default.createElement(Portal, null, import_react623.default.createElement(EventListener, {
    event: "resize",
    handler: updateToasts
  }), import_react623.default.createElement("div", {
    className: styles82.ToastManager,
    "aria-live": "assertive"
  }, import_react623.default.createElement(TransitionGroup_default, {
    component: null
  }, toastsMarkup)));
});
var toastClasses = {
  enter: classNames(styles82.ToastWrapper, styles82["ToastWrapper-enter"]),
  enterDone: classNames(styles82.ToastWrapper, styles82["ToastWrapper-enter-done"]),
  exit: classNames(styles82.ToastWrapper, styles82["ToastWrapper-exit"])
};
...
var FrameInner = class extends import_react624.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      skipFocused: false,
    ...
    this.navigationNode = (0, import_react624.createRef)();
  ...
  render() {
    ...
    const navClassName = classNames(styles72.Navigation, showMobileNavigation && styles72["Navigation-visible"]);
    ...
    const navigationMarkup = navigation ? import_react624.default.createElement(TrapFocus, {
      trapping: mobileNavShowing
    }, import_react624.default.createElement(CSSTransition_default, {
    ...
    }, import_react624.default.createElement("div", Object.assign({
      key: "NavContent"
    }, mobileNavAttributes, {
    ...
    }), navigation, import_react624.default.createElement("button", {
      type: "button",
      className: styles72.NavigationDismiss,
      ...
      tabIndex
    }, import_react624.default.createElement(Icon, {
      source: SvgMobileCancelMajor
    }))))) : null;
    const loadingMarkup = loadingStack > 0 ? import_react624.default.createElement("div", {
      className: styles72.LoadingBar,
      id: APP_FRAME_LOADING_BAR
    }, import_react624.default.createElement(Loading2, null)) : null;
    const contextualSaveBarMarkup = import_react624.default.createElement(CSSAnimation, {
      in: showContextualSaveBar,
      className: styles72.ContextualSaveBar,
      type: "fade"
    }, import_react624.default.createElement(ContextualSaveBar3, this.contextualSaveBar));
    const topBarMarkup = topBar ? import_react624.default.createElement("div", Object.assign({
      className: styles72.TopBar
    }, layer.props, dataPolarisTopBar.props, {
      id: APP_FRAME_TOP_BAR
    }), topBar) : null;
    const globalRibbonMarkup = globalRibbon ? import_react624.default.createElement("div", {
      className: styles72.GlobalRibbonContainer,
      ref: this.setGlobalRibbonContainer
    }, globalRibbon) : null;
    const skipClassName = classNames(styles72.Skip, skipFocused && styles72.focused);
    ...
    const skipMarkup = import_react624.default.createElement("div", {
      className: skipClassName
    }, import_react624.default.createElement("a", {
      href: `#${skipTarget}`,
    ...
    const frameClassName = classNames(styles72.Frame, navigation && styles72.hasNav, topBar && styles72.hasTopBar);
    const navigationOverlayMarkup = showMobileNavigation && isNavigationCollapsed ? import_react624.default.createElement(Backdrop, {
    ...
    return import_react624.default.createElement(FrameContext.Provider, {
      value: context
    }, import_react624.default.createElement("div", Object.assign({
      className: frameClassName
    }, layer.props, navigationAttributes), skipMarkup, topBarMarkup, navigationMarkup, contextualSaveBarMarkup, loadingMarkup, navigationOverlayMarkup, import_react624.default.createElement("main", {
      className: styles72.Main,
      id: APP_FRAME_MAIN,
      "data-has-global-ribbon": Boolean(globalRibbon)
    }, import_react624.default.createElement("div", {
      className: styles72.Content
    }, children2)), import_react624.default.createElement(ToastManager, {
      toastMessages
    }), globalRibbonMarkup, import_react624.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })));
  }
...
var navTransitionClasses = {
  enter: classNames(styles72["Navigation-enter"]),
  enterActive: classNames(styles72["Navigation-enterActive"]),
  enterDone: classNames(styles72["Navigation-enterActive"]),
  exit: classNames(styles72["Navigation-exit"]),
  exitActive: classNames(styles72["Navigation-exitActive"])
};
function Frame(props) {
  const i18n = useI18n();
  const mediaQuery = useMediaQuery();
  return import_react624.default.createElement(FrameInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
function FullscreenBar({
  ...
  const i18n = useI18n();
  return import_react625.default.createElement("div", {
    className: styles84.FullscreenBar
  }, import_react625.default.createElement("button", {
    className: styles84.BackAction,
    onClick: onAction,
    "aria-label": i18n.translate("Polaris.FullscreenBar.accessibilityLabel")
  }, import_react625.default.createElement(Icon, {
    source: SvgExitMajor
...
function Cell2({
  ...
  const className = classNames(styles86.Cell, (columnSpan === null || columnSpan === void 0 ? void 0 : columnSpan.xs) && styles86[`Cell-${columnSpan.xs}-column-xs`], (columnSpan === null || columnSpan === void 0 ? void 0 : columnSpan.sm) && styles86[`Cell-${columnSpan.sm}-column-sm`], (columnSpan === null || columnSpan === void 0 ? void 0 : columnSpan.md) && styles86[`Cell-${columnSpan.md}-column-md`], (columnSpan === null || columnSpan === void 0 ? void 0 : columnSpan.lg) && styles86[`Cell-${columnSpan.lg}-column-lg`], (columnSpan === null || columnSpan === void 0 ? void 0 : columnSpan.xl) && styles86[`Cell-${columnSpan.xl}-column-xl`]);
  const style = {
    gridArea,
  ...
  return import_react626.default.createElement("div", {
    className,
    style
  }, children2);
}
...
var Grid = function Grid2({
  ...
  return import_react627.default.createElement("div", {
    className: styles85.Grid,
    style
  }, children2);
};
...
var IndexContext = (0, import_react628.createContext)(void 0);
var IndexSelectionChangeContext = (0, import_react628.createContext)(void 0);
var IndexRowContext = (0, import_react628.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/index-provider/hooks.js
function useIndexSelectionChange() {
  const onSelectionChange = (0, import_react629.useContext)(IndexSelectionChangeContext);
...
function useIndexRow() {
  const indexRow = (0, import_react629.useContext)(IndexRowContext);
  if (!indexRow) {
    throw new Error(`Missing IndexProvider context`);
  }
  return indexRow;
...
function useIndexValue() {
  const index = (0, import_react629.useContext)(IndexContext);
  if (!index) {
    throw new Error(`Missing IndexProvider context`);
  }
  return index;
...
function useHandleBulkSelection({
  ...
  const lastSelected = (0, import_react629.useRef)(null);
  const handleSelectionChange = (0, import_react629.useCallback)((selectionType, toggleType, selection, sortOrder) => {
...
function IndexProvider({
  ...
  const contextValue = (0, import_react630.useMemo)(() => ({
    itemCount,
  ...
  const rowContextValue = (0, import_react630.useMemo)(() => ({
    selectable: isSelectableIndex,
    selectMode: selectMode && isSelectableIndex,
    condensed
  }), [condensed, selectMode, isSelectableIndex]);
  return import_react630.default.createElement(IndexContext.Provider, {
    value: contextValue
  }, import_react630.default.createElement(IndexRowContext.Provider, {
    value: rowContextValue
  }, import_react630.default.createElement(IndexSelectionChangeContext.Provider, {
...
var Cell3 = (0, import_react631.memo)(function Cell4({
  children: children2,
  className,
  flush
}) {
  const cellClassName = classNames(className, styles87.TableCell, flush && styles87["TableCell-flush"]);
  return import_react631.default.createElement("td", {
...
var RowContext = (0, import_react632.createContext)({});
var RowHoveredContext = (0, import_react632.createContext)(void 0);
var scrollDefaultContext = {
  scrollableContainer: null,
  canScrollLeft: false,
  canScrollRight: false
};
var ScrollContext = (0, import_react632.createContext)(scrollDefaultContext);

// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Checkbox/Checkbox.js
var Checkbox3 = (0, import_react633.memo)(function Checkbox4() {
  const i18n = useI18n();
  const {
    resourceName,
    condensed
  ...
  const {
    ...
    disabled,
    onInteraction
  } = (0, import_react633.useContext)(RowContext);
  const wrapperClassName = classNames(styles88.Wrapper, condensed ? styles88.condensed : styles88.expanded);
  const Wrapper = condensed ? import_react633.Fragment : CheckboxWrapper;
  return import_react633.default.createElement(Wrapper, null, import_react633.default.createElement("div", {
    className: styles88.TableCellContentContainer
  }, import_react633.default.createElement("div", {
    className: wrapperClassName,
    onClick: onInteraction,
    onKeyUp: noop10
  }, import_react633.default.createElement(Checkbox, {
    id: itemId,
...
function CheckboxWrapper({
  ...
  const checkboxNode = (0, import_react633.useRef)(null);
  const handleResize = (0, import_react633.useCallback)(debounce(() => {
  ...
  return import_react633.default.createElement("td", {
...
// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Row/Row.js
var Row = (0, import_react634.memo)(function Row2({
  children: children2,
  selected,
  id,
  position,
  ...
  const handleInteraction = (0, import_react634.useCallback)((event) => {
    event.stopPropagation();
  ...
  const contextValue = (0, import_react634.useMemo)(() => ({
    itemId: id,
    selected,
    position,
  ...
  const primaryLinkElement = (0, import_react634.useRef)(null);
  const isNavigating = (0, import_react634.useRef)(false);
  const tableRowRef = (0, import_react634.useRef)(null);
  const tableRowCallbackRef = (0, import_react634.useCallback)((node) => {
  ...
  const rowClassName = classNames(styles87.TableRow, selectable && condensed && styles87.condensedRow, selected && styles87["TableRow-selected"], subdued && styles87["TableRow-subdued"], hovered && styles87["TableRow-hovered"], disabled && styles87["TableRow-disabled"], status && styles87[variationName("status", status)], !selectable && !primaryLinkElement.current && styles87["TableRow-unclickable"]);
  let handleRowClick;
  ...
  const checkboxMarkup = selectable ? import_react634.default.createElement(Checkbox3, null) : null;
  return import_react634.default.createElement(RowContext.Provider, {
    value: contextValue
  }, import_react634.default.createElement(RowHoveredContext.Provider, {
    value: hovered
  }, import_react634.default.createElement(RowWrapper, {
    key: id,
...
function ScrollContainer({
  ...
  (0, import_react635.useEffect)(() => {
    if (!scrollableContainerRef.current)
      return;
    scrollableContainerRef.current.dispatchEvent(new Event("scroll"));
  }, [scrollableContainerRef]);
  const [containerScroll, setContainerScroll] = (0, import_react635.useState)(scrollDefaultContext);
  const handleScroll = (0, import_react635.useCallback)(debounce(() => {
    if (!scrollableContainerRef.current) {
      return;
    }
  ...
  return import_react635.default.createElement(ScrollContext.Provider, {
    value: containerScroll
  }, import_react635.default.createElement("div", {
...
function IndexTableBase({
  ...
  const tablePosition = (0, import_react636.useRef)({
    top: 0,
    left: 0
  });
  const tableHeadingRects = (0, import_react636.useRef)([]);
  const scrollableContainerElement = (0, import_react636.useRef)(null);
  const tableElement = (0, import_react636.useRef)(null);
  const condensedListElement = (0, import_react636.useRef)(null);
  const [tableInitialized, setTableInitialized] = (0, import_react636.useState)(false);
  const [isSmallScreenSelectable, setIsSmallScreenSelectable] = (0, import_react636.useState)(false);
  const [stickyWrapper, setStickyWrapper] = (0, import_react636.useState)(null);
  const [hideScrollContainer, setHideScrollContainer] = (0, import_react636.useState)(false);
  const [smallScreen, setSmallScreen] = (0, import_react636.useState)(isBreakpointsXS());
  const tableHeadings = (0, import_react636.useRef)([]);
  const stickyTableHeadings = (0, import_react636.useRef)([]);
  const stickyHeaderWrapperElement = (0, import_react636.useRef)(null);
  const firstStickyHeaderElement = (0, import_react636.useRef)(null);
  const stickyHeaderElement = (0, import_react636.useRef)(null);
  const scrollBarElement = (0, import_react636.useRef)(null);
  const scrollContainerElement = (0, import_react636.useRef)(null);
  const scrollingWithBar = (0, import_react636.useRef)(false);
  const scrollingContainer = (0, import_react636.useRef)(false);
  const tableBodyRef = (0, import_react636.useCallback)((node) => {
    if (node !== null && !tableInitialized) {
      setTableInitialized(true);
    }
  }, [tableInitialized]);
  const toggleIsSmallScreenSelectable = (0, import_react636.useCallback)(() => {
    setIsSmallScreenSelectable((value) => !value);
  }, []);
  const handleSelectAllItemsInStore = (0, import_react636.useCallback)(() => {
  ...
  const calculateFirstHeaderOffset = (0, import_react636.useCallback)(() => {
    if (!selectable) {
  ...
  const resizeTableHeadings = (0, import_react636.useMemo)(() => debounce(() => {
  ...
  const resizeTableScrollBar = (0, import_react636.useCallback)(() => {
  ...
  const debounceResizeTableScrollbar = (0, import_react636.useCallback)(debounce(resizeTableScrollBar, SCROLL_BAR_DEBOUNCE_PERIOD, {
    trailing: true
  }), [resizeTableScrollBar]);
  const [canScrollRight, setCanScrollRight] = (0, import_react636.useState)(true);
  const handleCanScrollRight = (0, import_react636.useCallback)(debounce(() => {
  ...
  (0, import_react636.useEffect)(() => {
    handleCanScrollRight();
  }, [handleCanScrollRight]);
  const handleIsSmallScreen = (0, import_react636.useCallback)(() => {
    setSmallScreen(smallScreen);
  }, [smallScreen]);
  const [canFitStickyColumn, setCanFitStickyColumn] = (0, import_react636.useState)(true);
  const handleCanFitStickyColumn = (0, import_react636.useCallback)(() => {
  ...
  const handleResize = (0, import_react636.useCallback)(() => {
  ...
  const handleScrollContainerScroll = (0, import_react636.useCallback)((canScrollLeft, canScrollRight2) => {
  ...
  const handleScrollBarScroll = (0, import_react636.useCallback)(() => {
    if (!scrollableContainerElement.current || !scrollBarElement.current) {
      return;
    }
  ...
  const stickyColumnHeader = import_react636.default.createElement("div", {
    className: styles87.TableHeading,
    key: headings[0].title,
    style: stickyColumnHeaderStyle,
    "data-index-table-sticky-heading": true
  }, import_react636.default.createElement(Stack, {
    spacing: "none",
    wrap: false,
    alignment: "center"
  }, selectable && import_react636.default.createElement("div", {
    className: styles87.FirstStickyHeaderElement,
    ref: firstStickyHeaderElement
  }, renderCheckboxContent()), selectable && import_react636.default.createElement("div", {
    className: styles87["StickyTableHeading-second-scrolling"]
  }, renderHeadingContent(headings[0], 0)), !selectable && import_react636.default.createElement("div", {
    className: styles87.FirstStickyHeaderElement,
    ref: firstStickyHeaderElement
  }, renderHeadingContent(headings[0], 0))));
  const stickyHeadingsMarkup = headings.map(renderStickyHeading);
  const selectedItemsCountLabel = selectedItemsCount === SELECT_ALL_ITEMS ? `${itemCount}+` : selectedItemsCount;
  const handleTogglePage = (0, import_react636.useCallback)(() => {
  ...
  const loadingMarkup = import_react636.default.createElement(CSSTransition_default, {
    in: loading,
  ...
  const stickyTableClassNames = classNames(styles87.StickyTable, condensed && styles87["StickyTable-condensed"]);
  const shouldShowBulkActions = bulkActionsSelectable && selectedItemsCount || isSmallScreenSelectable;
  const stickyHeaderMarkup = import_react636.default.createElement("div", {
    className: stickyTableClassNames,
    role: "presentation"
  }, import_react636.default.createElement(Sticky, {
    boundingElement: stickyWrapper
  }, (isSticky) => {
    const stickyHeaderClassNames = classNames(styles87.StickyTableHeader, isSticky && styles87["StickyTableHeader-isSticky"]);
    const bulkActionClassNames = classNames(styles87.BulkActionsWrapper, condensed && styles87["StickyTableHeader-condensed"], isSticky && styles87["StickyTableHeader-isSticky"]);
    const shouldShowActions = !condensed || selectedItemsCount;
    const promotedActions = shouldShowActions ? promotedBulkActions : [];
    const actions = shouldShowActions ? bulkActions : [];
    const bulkActionsMarkup = shouldShowBulkActions ? import_react636.default.createElement("div", {
      className: bulkActionClassNames,
      "data-condensed": condensed
    }, loadingMarkup, import_react636.default.createElement(BulkActions, {
      smallScreen,
    ...
    const stickyColumnHeaderClassNames = classNames(styles87.StickyTableColumnHeader, hasMoreLeftColumns && styles87["StickyTableColumnHeader-isScrolling"]);
    const selectButtonMarkup = import_react636.default.createElement(Button, {
      icon: SvgEnableSelectionMinor,
      onClick: toggleIsSmallScreenSelectable
    }, i18n.translate("Polaris.IndexTable.selectButtonText"));
    const headerMarkup = condensed ? import_react636.default.createElement("div", {
      className: classNames(styles87.HeaderWrapper, !selectable && styles87.unselectable)
    }, loadingMarkup, sort, selectable && selectButtonMarkup) : import_react636.default.createElement("div", {
      className: stickyHeaderClassNames,
      ref: stickyHeaderWrapperElement
    }, loadingMarkup, import_react636.default.createElement("div", {
      className: stickyColumnHeaderClassNames
    }, stickyColumnHeader), import_react636.default.createElement("div", {
  ...
  const scrollBarWrapperClassNames = classNames(styles87.ScrollBarContainer, condensed && styles87.scrollBarContainerCondensed, hideScrollContainer && styles87.scrollBarContainerHidden);
  const scrollBarClassNames = classNames(tableElement.current && tableInitialized && styles87.ScrollBarContent);
  const scrollBarMarkup = itemCount > 0 ? import_react636.default.createElement(AfterInitialMount, null, import_react636.default.createElement("div", {
  ...
  const tableClassNames = classNames(styles87.Table, hasMoreLeftColumns && styles87["Table-scrolling"], selectMode && styles87.disableTextSelection, selectMode && shouldShowBulkActions && styles87.selectMode, !selectable && styles87["Table-unselectable"], canFitStickyColumn && styles87["Table-sticky"], canFitStickyColumn && lastColumnSticky && styles87["Table-sticky-last"], canFitStickyColumn && lastColumnSticky && canScrollRight && styles87["Table-sticky-scrolling"]);
  const emptyStateMarkup = emptyState ? emptyState : import_react636.default.createElement(EmptySearchResult, {
  ...
  const sharedMarkup = import_react636.default.createElement(import_react636.default.Fragment, null, import_react636.default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }), import_react636.default.createElement(AfterInitialMount, null, stickyHeaderMarkup));
  const bodyMarkup = condensed ? import_react636.default.createElement(import_react636.default.Fragment, null, sharedMarkup, import_react636.default.createElement("ul", {
    "data-selectmode": Boolean(selectMode || isSmallScreenSelectable),
    className: styles87.CondensedList,
    ref: condensedListElement
  }, children2)) : import_react636.default.createElement(import_react636.default.Fragment, null, sharedMarkup, import_react636.default.createElement(ScrollContainer, {
    scrollableContainerRef: scrollableContainerElement,
    onScroll: handleScrollContainerScroll
  }, import_react636.default.createElement("table", {
    ref: tableElement,
    className: tableClassNames
  }, import_react636.default.createElement("thead", null, import_react636.default.createElement("tr", {
    className: styles87.HeadingRow
  }, headingsMarkup)), import_react636.default.createElement("tbody", {
    ref: tableBodyRef
  }, children2))));
  const tableContentMarkup = itemCount > 0 ? bodyMarkup : import_react636.default.createElement("div", {
    className: styles87.EmptySearchResultWrapper
  }, emptyStateMarkup);
  return import_react636.default.createElement(import_react636.default.Fragment, null, import_react636.default.createElement("div", {
  ...
  function renderHeading(heading, index) {
    ...
    const headingContentClassName = classNames(styles87.TableHeading, hasSortable && styles87["TableHeading-sortable"], isSecond && styles87["TableHeading-second"], isLast && !heading.hidden && styles87["TableHeading-last"], !selectable && styles87["TableHeading-unselectable"], heading.flush && styles87["TableHeading-flush"]);
    ...
    const headingContent = import_react636.default.createElement("th", {
    ...
    const checkboxContent = import_react636.default.createElement("th", {
      className: checkboxClassName,
      key: `${heading}-${index}`,
      "data-index-table-heading": true
  ...
  function renderCheckboxContent() {
    return import_react636.default.createElement("div", {
      className: styles87.ColumnHeaderCheckboxWrapper
    }, import_react636.default.createElement(Checkbox, {
  ...
  function renderHeadingContent(heading, index) {
    let headingContent;
    if (heading.new) {
      headingContent = import_react636.default.createElement(Stack, {
        wrap: false,
        alignment: "center"
      }, import_react636.default.createElement("span", null, heading.title), import_react636.default.createElement(Badge, {
        status: "new"
      }, i18n.translate("Polaris.IndexTable.onboardingBadgeText")));
    } else if (heading.hidden) {
      headingContent = import_react636.default.createElement(VisuallyHidden, null, heading.title);
    } else {
    ...
    if (sortable !== null && sortable !== void 0 && sortable[index]) {
      ...
      let source = defaultSortDirection === "ascending" ? SvgSortAscendingMajor : SvgSortDescendingMajor;
      if (isCurrentlySorted) {
        newDirection = isAscending ? "descending" : "ascending";
        source = sortDirection === "ascending" ? SvgSortAscendingMajor : SvgSortDescendingMajor;
      }
      const sortAccessibilityLabel = i18n.translate("Polaris.IndexTable.sortAccessibilityLabel", {
        direction: newDirection
      });
      const iconMarkup = import_react636.default.createElement("span", {
        className: classNames(styles87.TableHeadingSortIcon, isCurrentlySorted && styles87["TableHeadingSortIcon-visible"])
      ...
      return import_react636.default.createElement(UnstyledButton, {
        ...
        className: styles87.TableHeadingSortButton
  ...
  function renderStickyHeading(heading, index) {
    ...
    const stickyHeadingClassName = classNames(styles87.TableHeading, index === 0 && styles87["StickyTableHeading-second"], index === 0 && !selectable && styles87.unselectable);
    return import_react636.default.createElement("div", {
...
function IndexTable({
  ...
  return import_react636.default.createElement(IndexProvider, {
    selectable,
    itemCount,
    selectedItemsCount,
    resourceName: passedResourceName,
    ...
    condensed,
    onSelectionChange
  }, import_react636.default.createElement(IndexTableBase, indexTableBaseProps, children2));
}
...
var InlineCode = ({
  children: children2
}) => import_react637.default.createElement("code", {
...
function KeyboardKey({
  ...
  return import_react638.default.createElement("kbd", {
    className: styles91.KeyboardKey
  }, key);
}
...
function KonamiCode({
  ...
  const [position, setPosition] = (0, import_react639.useState)(0);
...
function AnnotatedSection({
  ...
  const descriptionMarkup = typeof description === "string" ? import_react640.default.createElement("p", null, description) : description;
  return import_react640.default.createElement("div", {
    className: styles92.AnnotatedSection
  }, import_react640.default.createElement("div", {
    className: styles92.AnnotationWrapper
  }, import_react640.default.createElement("div", {
    className: styles92.Annotation
  }, import_react640.default.createElement(TextContainer, null, import_react640.default.createElement(Heading, {
    id
  }, title), descriptionMarkup && import_react640.default.createElement("div", {
    className: styles92.AnnotationDescription
  }, descriptionMarkup))), import_react640.default.createElement("div", {
...
function Section6({
  ...
  const className = classNames(styles92.Section, secondary && styles92["Section-secondary"], fullWidth && styles92["Section-fullWidth"], oneHalf && styles92["Section-oneHalf"], oneThird && styles92["Section-oneThird"]);
  return import_react641.default.createElement("div", {
    className
  }, children2);
}
...
var Layout = function Layout2({
  ...
  const content = sectioned ? import_react642.default.createElement(Section6, null, children2) : children2;
...
function Link({
  ...
  return import_react643.default.createElement(BannerContext.Consumer, null, (BannerContext2) => {
    const shouldBeMonochrome = monochrome || BannerContext2;
    const className = classNames(styles93.Link, shouldBeMonochrome && styles93.monochrome, removeUnderline && styles93.removeUnderline);
    return url ? import_react643.default.createElement(UnstyledLink, {
      onClick,
      className,
      url,
      external,
      ...
      "aria-label": accessibilityLabel,
      "data-primary-link": dataPrimaryLink
    }, children2) : import_react643.default.createElement("button", {
      type: "button",
      onClick,
      className,
      id,
...
function Item7({
  ...
  return import_react644.default.createElement("li", {
    className: styles94.Item
  }, children2);
}
...
var List = function List2({
  ...
  const className = classNames(styles94.List, type && styles94[variationName("type", type)]);
  const ListElement = type === "bullet" ? "ul" : "ol";
  return import_react645.default.createElement(ListElement, {
    className
  }, children2);
};
List.Item = Item7;
...
var Loading3 = (0, import_react646.memo)(function Loading4() {
  const {
    startLoading,
    stopLoading
  } = useFrame();
  (0, import_react646.useEffect)(() => {
    startLoading();
    return () => {
      stopLoading();
    };
...
function MediaCard({
  ...
  if (title) {
    const headerContent = typeof title === "string" ? import_react647.default.createElement(Heading, null, title) : title;
    headerMarkup = import_react647.default.createElement("div", {
      className: styles95.Heading
    }, headerContent);
  }
  const popoverActivator = import_react647.default.createElement(Button, {
    icon: SvgHorizontalDotsMinor,
  ...
  const popoverActionsMarkup = popoverActions.length > 0 ? import_react647.default.createElement("div", {
    className: styles95.Popover
  }, import_react647.default.createElement(Popover2, {
    active: popoverActive,
    activator: popoverActivator,
    onClose: togglePopoverActive,
    preferredAlignment: "left",
    preferredPosition: "below"
  }, import_react647.default.createElement(ActionList, {
    items: popoverActions,
    onActionAnyItem: togglePopoverActive
  }))) : null;
  const primaryActionMarkup = primaryAction ? import_react647.default.createElement("div", {
    className: styles95.PrimaryAction
  }, buttonFrom(primaryAction)) : null;
  const secondaryActionMarkup = secondaryAction ? import_react647.default.createElement("div", {
    className: styles95.SecondaryAction
  }, buttonFrom(secondaryAction, {
    plain: true
  })) : null;
  const actionClassName = classNames(styles95.ActionContainer, portrait && styles95.portrait);
  const actionMarkup = primaryActionMarkup || secondaryActionMarkup ? import_react647.default.createElement("div", {
    className: actionClassName
  }, import_react647.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup)) : null;
  const mediaCardClassName = classNames(styles95.MediaCard, portrait && styles95.portrait);
  const mediaContainerClassName = classNames(styles95.MediaContainer, portrait && styles95.portrait, size === "small" && styles95.sizeSmall);
  const infoContainerClassName = classNames(styles95.InfoContainer, portrait && styles95.portrait, size === "small" && styles95.sizeSmall);
  return import_react647.default.createElement(Card, null, import_react647.default.createElement("div", {
    className: mediaCardClassName
  }, import_react647.default.createElement("div", {
    className: mediaContainerClassName
  }, children2), import_react647.default.createElement("div", {
    className: infoContainerClassName
  }, import_react647.default.createElement(Card.Section, null, popoverActionsMarkup, import_react647.default.createElement(Stack, {
    vertical: true,
    spacing: "tight"
  }, headerMarkup, import_react647.default.createElement("p", {
    className: styles95.Description
...
var NavigationContext = (0, import_react648.createContext)({
  location: ""
});
...
function Secondary({
  ...
  return import_react649.default.createElement(Collapsible, {
    id: id || uid,
    open: expanded,
    transition: {
      duration: "0ms",
  ...
  }, import_react649.default.createElement("ul", {
    className: styles96.List
  }, children2));
}
...
function Item8({
  ...
  const {
    location,
    onNavigationDismiss
  } = (0, import_react650.useContext)(NavigationContext);
  const [keyFocused, setKeyFocused] = (0, import_react650.useState)(false);
  (0, import_react650.useEffect)(() => {
  ...
  const handleKeyUp = (0, import_react650.useCallback)((event) => {
    if (event.keyCode === Key.Tab) {
      !keyFocused && setKeyFocused(true);
    }
  }, [keyFocused]);
  const handleBlur = (0, import_react650.useCallback)(() => {
  ...
  const indicatorMarkup = hasNewChild ? import_react650.default.createElement("span", {
    className: styles96.Indicator
  }, import_react650.default.createElement(Indicator, {
    pulse: true
  })) : null;
  const iconMarkup = icon ? import_react650.default.createElement("div", {
    className: classNames(styles96.Icon, shouldResizeIcon && styles96["Icon-resized"])
  }, import_react650.default.createElement(Icon, {
    source: icon
  })) : null;
  let badgeMarkup = null;
  if (isNew) {
    badgeMarkup = import_react650.default.createElement(Badge, {
      status: "new",
      size: "small"
  ...
  const wrappedBadgeMarkup = badgeMarkup == null ? null : import_react650.default.createElement("div", {
    className: styles96.Badge
  }, badgeMarkup);
  const itemContentMarkup = import_react650.default.createElement(import_react650.default.Fragment, null, iconMarkup, import_react650.default.createElement("span", {
    className: styles96.Text
  }, label, indicatorMarkup), wrappedBadgeMarkup);
  if (url == null) {
    const className2 = classNames(styles96.Item, disabled && styles96["Item-disabled"], keyFocused && styles96.keyFocused, selectedOverride && styles96["Item-selected"]);
    return import_react650.default.createElement("li", {
      className: styles96.ListItem
  ...
  const secondaryActionLinkMarkup = secondaryAction && import_react650.default.createElement(UnstyledLink, {
    external: true,
    url: secondaryAction.url,
    className: styles96.SecondaryAction,
    tabIndex,
    "aria-disabled": disabled,
  ...
  const secondaryActionMarkup = secondaryAction && (secondaryAction.tooltip ? import_react650.default.createElement(Tooltip, secondaryAction.tooltip, secondaryActionLinkMarkup) : secondaryActionLinkMarkup);
  ...
  const itemClassName = classNames(styles96.Item, disabled && styles96["Item-disabled"], selected && canBeActive && styles96["Item-selected"], showExpanded && styles96.subNavigationActive, childIsActive && styles96["Item-child-active"], keyFocused && styles96.keyFocused);
  ...
  if (subNavigationItems.length > 0) {
    ...
    const SecondaryNavigationClassName = classNames(styles96.SecondaryNavigation, showExpanded && styles96.isExpanded, !icon && styles96["SecondaryNavigation-noIcon"]);
    secondaryNavigationMarkup = import_react650.default.createElement("div", {
      className: SecondaryNavigationClassName
    }, import_react650.default.createElement(Secondary, {
      ...
      return import_react650.default.createElement(Item8, Object.assign({
        key: label2
      }, rest, {
        label: label2,
  ...
  const className = classNames(styles96.ListItem, secondaryAction && styles96["ListItem-hasAction"]);
  return import_react650.default.createElement("li", {
    className
  }, import_react650.default.createElement("div", {
    className: styles96.ItemWrapper
  }, import_react650.default.createElement(UnstyledLink, Object.assign({
    url,
...
function Section7({
  ...
  const animationFrame = (0, import_react651.useRef)(null);
  const {
    isNavigationCollapsed
  } = useMediaQuery();
  const [expandedIndex, setExpandedIndex] = (0, import_react651.useState)();
  ...
  (0, import_react651.useEffect)(() => {
    return () => {
      animationFrame.current && cancelAnimationFrame(animationFrame.current);
    };
  });
  const className = classNames(styles96.Section, separator && styles96["Section-withSeparator"], fill && styles96["Section-fill"]);
  const buttonMarkup = action && import_react651.default.createElement("button", {
    type: "button",
    className: styles96.Action,
    "aria-label": action.accessibilityLabel,
    onClick: action.onClick
  }, import_react651.default.createElement(Icon, {
    source: action.icon
  }));
  const actionMarkup = action && (action.tooltip ? import_react651.default.createElement(Tooltip, action.tooltip, buttonMarkup) : buttonMarkup);
  const sectionHeadingMarkup = title && import_react651.default.createElement("li", {
    className: styles96.SectionHeading
  }, import_react651.default.createElement("span", {
    className: styles96.Text
  }, title), actionMarkup);
  const itemsMarkup = items.map((item, index) => {
    ...
    return import_react651.default.createElement(Item8, Object.assign({
      key: label
    }, rest, {
      label,
      subNavigationItems,
  ...
  const toggleClassName = classNames(styles96.Item, styles96.RollupToggle);
  const ariaLabel = rollup && (expanded ? rollup.hide : rollup.view);
  const toggleRollup = rollup && items.length > rollup.after && import_react651.default.createElement("div", {
    className: styles96.ListItem,
    key: "List Item"
  }, import_react651.default.createElement("button", {
    type: "button",
    className: toggleClassName,
    onClick: toggleExpanded,
    "aria-label": ariaLabel
  }, import_react651.default.createElement("span", {
    className: styles96.Icon
  }, import_react651.default.createElement(Icon, {
  ...
  const activeItemsMarkup = rollup && additionalItems.length > 0 && import_react651.default.createElement("li", {
    className: styles96.RollupSection
  }, import_react651.default.createElement(Collapsible, {
    id: additionalItemsId,
    open: expanded
  }, import_react651.default.createElement("ul", {
    className: styles96.List
  }, additionalItems)), toggleRollup);
  return import_react651.default.createElement("ul", {
    className
...
var Navigation2 = function Navigation3({
  ...
  const width = getWidth(logo, 104);
  const logoMarkup = logo ? import_react652.default.createElement("div", {
    className: classNames(styles96.LogoContainer, logoSuffix && styles96.hasLogoSuffix)
  }, import_react652.default.createElement(UnstyledLink, {
    url: logo.url || "",
    className: styles96.LogoLink,
    style: {
      width
    }
  }, import_react652.default.createElement(Image, {
    source: logo.topBarSource || "",
    alt: logo.accessibilityLabel || "",
    className: styles96.Logo,
    style: {
      width
    }
  })), logoSuffix) : null;
  const mediaMarkup = contextControl ? import_react652.default.createElement("div", {
    className: styles96.ContextControl
  }, contextControl) : logoMarkup;
  const context = (0, import_react652.useMemo)(() => ({
    location,
    onNavigationDismiss: onDismiss
  }), [location, onDismiss]);
  return import_react652.default.createElement(NavigationContext.Provider, {
    value: context
  }, import_react652.default.createElement(WithinContentContext.Provider, {
    value: true
  }, import_react652.default.createElement("nav", {
    className: styles96.Navigation,
    "aria-labelledby": ariaLabelledBy
  }, mediaMarkup, import_react652.default.createElement(Scrollable, {
    className: styles96.PrimaryNavigation
  }, children2))));
};
...
// node_modules/@shopify/polaris/build/esm/components/OptionList/OptionList.scss.js
var styles97 = {
...
function Checkbox5({
  ...
  const id = useUniqueId("Checkbox", idProp);
  const [keyFocused, setKeyFocused] = (0, import_react653.useState)(false);
  const className = classNames(styles99.Checkbox, active && styles99.active);
  const handleBlur = () => {
    setKeyFocused(false);
  };
  const handleKeyUp = () => {
  ...
  const inputClassName = classNames(styles99.Input, keyFocused && styles99.keyFocused);
  return import_react653.default.createElement("div", {
    className
  }, import_react653.default.createElement("input", {
    id,
    name,
    value,
    type: "checkbox",
    ...
    onKeyUp: handleKeyUp,
    role
  }), import_react653.default.createElement("div", {
    className: styles99.Backdrop
  }), import_react653.default.createElement("div", {
    className: styles99.Icon
  }, import_react653.default.createElement(Icon, {
...
function Option3({
  ...
  const handleClick = (0, import_react654.useCallback)(() => {
    if (disabled) {
      return;
    }
    onClick(section, index);
  }, [disabled, index, onClick, section]);
  const mediaMarkup = media ? import_react654.default.createElement("div", {
    className: styles98.Media
  }, media) : null;
  const singleSelectClassName = classNames(styles98.SingleSelectOption, focused && styles98.focused, disabled && styles98.disabled, select && styles98.select, active && styles98.active, verticalAlign && styles98[variationName("verticalAlign", verticalAlign)]);
  const multiSelectClassName = classNames(styles98.Label, disabled && styles98.disabled, active && styles98.active, select && styles98.select, verticalAlign && styles98[variationName("verticalAlign", verticalAlign)]);
  const checkBoxRole = role === "option" ? "presentation" : void 0;
  const optionMarkup = allowMultiple ? import_react654.default.createElement("label", {
    htmlFor: id,
    className: multiSelectClassName
  }, import_react654.default.createElement("div", {
    className: styles98.Checkbox
  }, import_react654.default.createElement(Checkbox5, {
    id,
    value,
    checked: select,
    active,
    ...
    role: checkBoxRole
  })), mediaMarkup, label) : import_react654.default.createElement("button", {
    id,
    type: "button",
  ...
  const scrollMarkup = active ? import_react654.default.createElement(Scrollable.ScrollTo, null) : null;
  return import_react654.default.createElement("li", {
    key: id,
    className: styles98.Option,
    tabIndex: -1
...
function OptionList({
  ...
  const [normalizedOptions, setNormalizedOptions] = (0, import_react655.useState)(createNormalizedOptions(options, sections, title));
  ...
  const handleClick = (0, import_react655.useCallback)((sectionIndex, optionIndex) => {
  ...
  const optionsMarkup = optionsExist ? normalizedOptions.map(({
    ...
    const titleMarkup = title2 ? import_react655.default.createElement("p", {
      className: styles97.Title
    }, title2) : null;
    const optionsMarkup2 = options2 && options2.map((option, optionIndex) => {
      ...
      return import_react655.default.createElement(Option3, Object.assign({
        key: optionId
      }, option, {
        id: optionId,
    ...
    return import_react655.default.createElement("li", {
      key: title2 || `noTitle-${sectionIndex}`
    }, titleMarkup, import_react655.default.createElement("ul", {
      className: styles97.Options,
      id: `${id}-${sectionIndex}`,
      role
    }, optionsMarkup2));
  }) : null;
  return import_react655.default.createElement("ul", {
    className: styles97.OptionList,
    role
  }, optionsMarkup);
}
...
function isInterface(x) {
  return !(0, import_react656.isValidElement)(x) && x !== void 0;
}
...
function isReactElement(x) {
  return (0, import_react657.isValidElement)(x) && x !== void 0;
}
...
function Pagination({
  ...
  const i18n = useI18n();
  const node = (0, import_react658.createRef)();
  ...
  const prev = import_react658.default.createElement(Button, {
    outline: true,
    icon: SvgChevronLeftMinor,
  ...
  const constructedPrevious = previousTooltip && hasPrevious ? import_react658.default.createElement(Tooltip, {
    activatorWrapper: "span",
    content: previousTooltip
  }, prev) : prev;
  const next = import_react658.default.createElement(Button, {
    outline: true,
    icon: SvgChevronRightMinor,
  ...
  const constructedNext = nextTooltip && hasNext ? import_react658.default.createElement(Tooltip, {
    activatorWrapper: "span",
    content: nextTooltip
  }, next) : next;
  const previousHandler = onPrevious || noop11;
  const previousButtonEvents = previousKeys && (previousURL || onPrevious) && hasPrevious && previousKeys.map((key) => import_react658.default.createElement(KeypressListener, {
    key,
    keyCode: key,
    handler: previousURL ? handleCallback(clickPaginationLink("previousURL", node)) : handleCallback(previousHandler)
  }));
  const nextHandler = onNext || noop11;
  const nextButtonEvents = nextKeys && (nextURL || onNext) && hasNext && nextKeys.map((key) => import_react658.default.createElement(KeypressListener, {
    key,
    keyCode: key,
    handler: nextURL ? handleCallback(clickPaginationLink("nextURL", node)) : handleCallback(nextHandler)
  }));
  const labelTextMarkup = hasNext && hasPrevious ? import_react658.default.createElement(TextStyle, null, label) : import_react658.default.createElement(TextStyle, {
    variation: "subdued"
  }, label);
  const labelMarkup = label ? import_react658.default.createElement("div", {
    "aria-live": "polite"
  }, labelTextMarkup) : null;
  return import_react658.default.createElement("nav", {
    "aria-label": navLabel,
    ref: node
  }, previousButtonEvents, nextButtonEvents, import_react658.default.createElement(ButtonGroup, {
    segmented: !label
...
function Title({
  ...
  const className = classNames(styles102.Title, subtitle && styles102.TitleWithSubtitle);
  const titleMarkup = title ? import_react659.default.createElement("h1", {
    className
  }, title) : null;
  const titleMetadataMarkup = titleMetadata ? import_react659.default.createElement("div", {
    className: styles102.TitleMetadata
  }, titleMetadata) : null;
  const wrappedTitleMarkup = titleMetadata ? import_react659.default.createElement("div", {
    className: styles102.TitleWithMetadataWrapper
  }, titleMarkup, titleMetadataMarkup) : titleMarkup;
  const subtitleMarkup = subtitle ? import_react659.default.createElement("div", {
    className: classNames(styles102.SubTitle, compactTitle && styles102.SubtitleCompact)
  }, import_react659.default.createElement("p", null, subtitle)) : null;
  return import_react659.default.createElement(import_react659.default.Fragment, null, wrappedTitleMarkup, subtitleMarkup);
}
...
function Header4({
  ...
  const breadcrumbMarkup = breadcrumbs.length > 0 ? import_react660.default.createElement("div", {
    className: styles101.BreadcrumbWrapper
  }, import_react660.default.createElement(Breadcrumbs, {
    breadcrumbs
  })) : null;
  const paginationMarkup = pagination && !isNavigationCollapsed ? import_react660.default.createElement("div", {
    className: styles101.PaginationWrapper
  }, import_react660.default.createElement(Pagination, pagination)) : null;
  const additionalNavigationMarkup = additionalNavigation ? import_react660.default.createElement("div", {
    className: styles101.AdditionalNavigationWrapper
  }, additionalNavigation) : null;
  const navigationMarkup = breadcrumbMarkup || paginationMarkup || additionalNavigationMarkup ? import_react660.default.createElement("div", {
    className: styles101.Navigation
  }, breadcrumbMarkup, additionalNavigationMarkup, paginationMarkup) : null;
  const pageTitleMarkup = import_react660.default.createElement("div", {
    className: styles101.TitleWrapper
  }, import_react660.default.createElement(Title, {
    title,
    subtitle,
    titleMetadata,
    compactTitle
  }));
  const primaryActionMarkup = primaryAction ? import_react660.default.createElement(PrimaryActionMarkup, {
    primaryAction
  }) : null;
  let actionMenuMarkup = null;
  if (isInterface(secondaryActions) && (secondaryActions.length > 0 || hasGroupsWithActions(actionGroups))) {
    actionMenuMarkup = import_react660.default.createElement(ActionMenu, {
    ...
    actionMenuMarkup = import_react660.default.createElement(import_react660.default.Fragment, null, secondaryActions);
  }
  const additionalMetadataMarkup = additionalMetadata ? import_react660.default.createElement("div", {
    className: styles101.AdditionalMetaData
  }, import_react660.default.createElement(TextStyle, {
    variation: "subdued"
  }, additionalMetadata)) : null;
  const headerClassNames = classNames(styles101.Header, isSingleRow && styles101.isSingleRow, titleHidden && styles101.titleHidden, navigationMarkup && styles101.hasNavigation, actionMenuMarkup && styles101.hasActionMenu, isNavigationCollapsed && styles101.mobileView, !breadcrumbs.length && styles101.noBreadcrumbs, title && title.length < LONG_TITLE && styles101.mediumTitle, title && title.length > LONG_TITLE && styles101.longTitle);
  const {
    slot1,
    slot2,
    slot3,
  ...
  }, import_react660.default.createElement(ConditionalRender, {
    condition: [slot1, slot2, slot3, slot4].some(notNull)
  }, import_react660.default.createElement("div", {
    className: styles101.Row
  }, slot1, slot2, import_react660.default.createElement(ConditionalRender, {
    condition: [slot3, slot4].some(notNull)
  }, import_react660.default.createElement("div", {
    className: styles101.RightAlign
  }, import_react660.default.createElement(ConditionalWrapper, {
    condition: [slot3, slot4].every(notNull),
    wrapper: (children2) => import_react660.default.createElement("div", {
      className: styles101.Actions
    }, children2)
  }, slot3, slot4))))), import_react660.default.createElement(ConditionalRender, {
    condition: [slot5, slot6].some(notNull)
  }, import_react660.default.createElement("div", {
    className: styles101.Row
  }, import_react660.default.createElement("div", {
    className: styles101.LeftAlign
  }, slot5), import_react660.default.createElement(ConditionalRender, {
...
function PrimaryActionMarkup({
  ...
  if (isInterface(primaryAction)) {
    ...
    actionMarkup = helpText ? import_react660.default.createElement(Tooltip, {
      content: helpText
    }, content) : content;
  }
  return import_react660.default.createElement("div", {
    className: styles101.PrimaryActionWrapper
  }, actionMarkup);
}
  ...
  const layouts = {
    ...
    desktopDefault: {
      slots: {
        slot1: breadcrumbMarkup,
        slot2: pageTitleMarkup,
        slot3: import_react660.default.createElement(import_react660.default.Fragment, null, actionMenuMarkup, primaryActionMarkup),
...
function Page({
  ...
  const pageClassName = classNames(styles100.Page, fullWidth && styles100.fullWidth, narrowWidth && styles100.narrowWidth);
  ...
  const contentClassName = classNames(!hasHeaderContent && styles100.Content, divider && hasHeaderContent && styles100.divider);
  const headerMarkup = hasHeaderContent ? import_react661.default.createElement(Header4, rest) : null;
  return import_react661.default.createElement("div", {
    className: pageClassName
  }, headerMarkup, import_react661.default.createElement("div", {
...
function PageActions({
  ...
  if (isReactElement(primaryAction)) {
    primaryActionMarkup = import_react662.default.createElement(import_react662.default.Fragment, null, primaryAction);
  ...
  if (isInterface(secondaryActions) && secondaryActions.length > 0) {
    secondaryActionsMarkup = import_react662.default.createElement(ButtonGroup, null, buttonsFrom(secondaryActions));
  } else if (isReactElement(secondaryActions)) {
    secondaryActionsMarkup = import_react662.default.createElement(import_react662.default.Fragment, null, secondaryActions);
  }
  const distribution = secondaryActionsMarkup ? "equalSpacing" : "trailing";
  return import_react662.default.createElement("div", {
    className: styles103.PageActions
  }, import_react662.default.createElement(Stack, {
    distribution,
    spacing: "tight"
...
function PolarisTestProvider({
  ...
  const Wrapper = strict ? import_react663.StrictMode : import_react663.Fragment;
  const intl = (0, import_react663.useMemo)(() => new I18n(i18n || {}), [i18n]);
  const scrollLockManager = (0, import_react663.useMemo)(() => new ScrollLockManager(), []);
  const stickyManager = (0, import_react663.useMemo)(() => new StickyManager(), []);
  const uniqueIdFactory = (0, import_react663.useMemo)(() => new UniqueIdFactory(globalIdGeneratorFactory), []);
  const mergedFrame = createFrameContext(frame);
  const mergedMediaQuery = merge(defaultMediaQuery, mediaQuery);
  return import_react663.default.createElement(Wrapper, null, import_react663.default.createElement(FeaturesContext.Provider, {
    value: features
  }, import_react663.default.createElement(I18nContext.Provider, {
    value: intl
  }, import_react663.default.createElement(ScrollLockManagerContext.Provider, {
    value: scrollLockManager
  }, import_react663.default.createElement(StickyManagerContext.Provider, {
    value: stickyManager
  }, import_react663.default.createElement(UniqueIdFactoryContext.Provider, {
    value: uniqueIdFactory
  }, import_react663.default.createElement(LinkContext.Provider, {
    value: link
  }, import_react663.default.createElement(MediaQueryContext.Provider, {
    value: mergedMediaQuery
  }, import_react663.default.createElement(PortalsManager, null, import_react663.default.createElement(FocusManager, null, import_react663.default.createElement(FrameContext.Provider, {
    value: mergedFrame
  }, children2)))))))))));
}
function noop12() {
...
function createFrameContext({
  ...
  showToast = noop12,
  hideToast = noop12,
  setContextualSaveBar = noop12,
  removeContextualSaveBar = noop12,
  startLoading = noop12,
  stopLoading = noop12
} = {}) {
  return {
...
function ProgressBar({
  ...
  const i18n = useI18n();
  const className = classNames(styles104.ProgressBar, size && styles104[variationName("size", size)], color && styles104[variationName("color", color)]);
  ...
  return import_react664.default.createElement("div", {
    className
  }, import_react664.default.createElement("progress", {
    "aria-labelledby": ariaLabelledBy,
    className: styles104.Progress,
    value: parsedProgress,
    max: "100"
  }), import_react664.default.createElement(CSSTransition_default, {
    in: true,
    appear: true,
    timeout: parseInt(progressBarDuration, 10),
    classNames: {
      appearActive: styles104.IndicatorAppearActive,
      appearDone: styles104.IndicatorAppearDone
    }
  }, import_react664.default.createElement("div", {
    className: styles104.Indicator,
    style: {
      "--pc-progress-bar-duration": progressBarDuration,
      "--pc-progress-bar-percent": parsedProgress / 100
    }
  }, import_react664.default.createElement("span", {
    className: styles104.Label
  }, parsedProgress, "%"))));
}
...
var DualThumb = class extends import_react665.Component {
  constructor(...args) {
    super(...args);
    this.context = void 0;
    this.state = {
    ...
    this.track = (0, import_react665.createRef)();
    this.trackWrapper = (0, import_react665.createRef)();
    this.thumbLower = (0, import_react665.createRef)();
    this.thumbUpper = (0, import_react665.createRef)();
  ...
  render() {
    ...
    const ariaDescribedBy = describedBy.length ? describedBy.join(" ") : void 0;
    const trackWrapperClassName = classNames(styles105.TrackWrapper, error && styles105.error, disabled && styles105.disabled);
    const thumbLowerClassName = classNames(styles105.Thumbs, styles105.ThumbLower, disabled && styles105.disabled);
    const thumbUpperClassName = classNames(styles105.Thumbs, styles105.ThumbUpper, disabled && styles105.disabled);
    ...
    const outputLowerClassName = classNames(styles105.Output, styles105.OutputLower);
    const outputMarkupLower = !disabled && output ? import_react665.default.createElement("output", {
      htmlFor: idLower,
      className: outputLowerClassName,
      style: {
        left: `${leftPositionThumbLower}px`
      }
    }, import_react665.default.createElement("div", {
      className: styles105.OutputBubble
    }, import_react665.default.createElement("span", {
      className: styles105.OutputText
    }, value[0]))) : null;
    const outputUpperClassName = classNames(styles105.Output, styles105.OutputUpper);
    const outputMarkupUpper = !disabled && output ? import_react665.default.createElement("output", {
      htmlFor: idUpper,
    ...
    const prefixMarkup = prefix && import_react665.default.createElement("div", {
      className: styles105.Prefix
    }, prefix);
    const suffixMarkup = suffix && import_react665.default.createElement("div", {
      className: styles105.Suffix
    }, suffix);
    return import_react665.default.createElement(import_react665.default.Fragment, null, import_react665.default.createElement(Labelled, {
      id,
      label,
      error,
      action: labelAction,
      ...
      className: classNames(styles105.DualThumb, sharedStyles.RangeSlider)
    }, prefixMarkup, import_react665.default.createElement("div", {
      className: trackWrapperClassName,
      onMouseDown: this.handleMouseDownTrack,
      ref: this.trackWrapper
    }, import_react665.default.createElement("div", {
      className: styles105.Track,
      style: cssVars,
      ref: this.track
    }), import_react665.default.createElement("div", {
      className: styles105["Track--dashed"]
    }), import_react665.default.createElement("div", {
      id: idLower,
      ...
      ref: this.thumbLower
    }), outputMarkupLower, import_react665.default.createElement("div", {
      id: idUpper,
      ...
      ref: this.thumbUpper
    }), outputMarkupUpper), suffixMarkup)), import_react665.default.createElement(EventListener, {
      event: "resize",
...
function SingleThumb(props) {
  ...
  const outputMarkup = !disabled && output && import_react666.default.createElement("output", {
    htmlFor: id,
    className: styles106.Output
  }, import_react666.default.createElement("div", {
    className: styles106.OutputBubble
  }, import_react666.default.createElement("span", {
    className: styles106.OutputText
  }, clampedValue)));
  const prefixMarkup = prefix && import_react666.default.createElement("div", {
    className: styles106.Prefix
  }, prefix);
  const suffixMarkup = suffix && import_react666.default.createElement("div", {
    className: styles106.Suffix
  }, suffix);
  const className = classNames(styles106.SingleThumb, sharedStyles.RangeSlider, error && styles106.error, disabled && styles106.disabled);
  return import_react666.default.createElement(Labelled, {
    id,
    label,
    error,
    action: labelAction,
    ...
    className,
    style: cssVars
  }, prefixMarkup, import_react666.default.createElement("div", {
    className: styles106.InputWrapper
  }, import_react666.default.createElement("input", {
    type: "range",
    className: styles106.Input,
    id,
    name: id,
    min,
    max,
...
function RangeSlider({
  ...
  return isDualThumb(value) ? import_react667.default.createElement(DualThumb, Object.assign({
    value
  }, sharedProps)) : import_react667.default.createElement(SingleThumb, Object.assign({
    value
  }, sharedProps));
}
...
var BaseResourceItem = class extends import_react668.Component {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.buttonOverlay = (0, import_react668.createRef)();
    this.setNode = (node) => {
      this.node = node;
    };
    this.handleFocus = (event) => {
  ...
  render() {
    ...
    const mediaMarkup = media ? import_react668.default.createElement("div", {
      className: styles107.Media
    }, media) : null;
    if (selectable) {
      const checkboxAccessibilityLabel = name || accessibilityLabel || i18n.translate("Polaris.Common.checkbox");
      handleMarkup = import_react668.default.createElement("div", {
        className: styles107.Handle,
        onClick: this.handleLargerSelectionArea
      }, import_react668.default.createElement("div", {
        onClick: stopPropagation2,
        className: styles107.CheckboxWrapper
      }, import_react668.default.createElement("div", {
        onChange: this.handleLargerSelectionArea
      }, import_react668.default.createElement(Checkbox, {
        id: this.checkboxId,
    ...
    if (media || selectable) {
      ownedMarkup = import_react668.default.createElement("div", {
        className: classNames(styles107.Owned, !mediaMarkup && styles107.OwnedNoMedia)
      }, handleMarkup, mediaMarkup);
    }
    const className = classNames(styles107.ResourceItem, focused && styles107.focused, selectable && styles107.selectable, selected && styles107.selected, selectMode && styles107.selectMode, persistActions && styles107.persistActions, focusedInner && styles107.focusedInner);
    const listItemClassName = classNames(styles107.ListItem, focused && !focusedInner && styles107.focused);
    let actionsMarkup = null;
    let disclosureMarkup = null;
    if (shortcutActions && !loading) {
      if (persistActions) {
        actionsMarkup = import_react668.default.createElement("div", {
          className: styles107.Actions,
          onClick: stopPropagation2
        }, import_react668.default.createElement(ButtonGroup, null, buttonsFrom(shortcutActions, {
          plain: true
        })));
        const disclosureAccessibilityLabel = name ? i18n.translate("Polaris.ResourceList.Item.actionsDropdownLabel", {
          accessibilityLabel: name
        }) : i18n.translate("Polaris.ResourceList.Item.actionsDropdown");
        disclosureMarkup = import_react668.default.createElement("div", {
          className: styles107.Disclosure,
          onClick: stopPropagation2
        }, import_react668.default.createElement(Popover2, {
          activator: import_react668.default.createElement(Button, {
        ...
        }, import_react668.default.createElement(ActionList, {
        ...
        actionsMarkup = import_react668.default.createElement("div", {
          className: styles107.Actions,
          onClick: stopPropagation2
        }, import_react668.default.createElement(ButtonGroup, {
          segmented: true
    ...
    const content = children2 ? import_react668.default.createElement("div", {
      className: styles107.Content
    }, children2) : null;
    const containerClassName = classNames(styles107.Container, verticalAlignment && styles107[variationName("alignment", verticalAlignment)]);
    const containerMarkup = import_react668.default.createElement("div", {
      className: containerClassName,
      id: this.props.id
    ...
    const accessibleMarkup = url ? import_react668.default.createElement(UnstyledLink, {
      "aria-describedby": this.props.id,
      "aria-label": ariaLabel,
      className: styles107.Link,
      url,
      external,
      tabIndex,
      id: this.overlayId
    }) : import_react668.default.createElement("button", {
      className: styles107.Button,
      "aria-label": ariaLabel,
      "aria-controls": ariaControls,
      "aria-expanded": ariaExpanded,
      onClick: this.handleClick,
    ...
    return import_react668.default.createElement("li", {
...
function ResourceItem(props) {
  return import_react668.default.createElement(BaseResourceItem, Object.assign({}, props, {
    context: (0, import_react668.useContext)(ResourceListContext),
    i18n: useI18n()
  }));
}
...
function useLazyRef(initialValue) {
  const lazyRef = (0, import_react669.useRef)(UNIQUE_IDENTIFIER);
...
function Select({
  ...
  const className = classNames(styles109.Select, error && styles109.error, disabled && styles109.disabled);
  ...
  const inlineLabelMarkup = labelInline && import_react670.default.createElement("span", {
    className: styles109.InlineLabel
  }, label);
  const selectedOption = getSelectedOption(normalizedOptions, value);
  const prefixMarkup = selectedOption.prefix && import_react670.default.createElement("div", {
    className: styles109.Prefix
  }, selectedOption.prefix);
  const contentMarkup = import_react670.default.createElement("div", {
    className: styles109.Content,
    "aria-hidden": true,
    "aria-disabled": disabled
  }, inlineLabelMarkup, prefixMarkup, import_react670.default.createElement("span", {
    className: styles109.SelectedOption
  }, selectedOption.label), import_react670.default.createElement("span", {
    className: styles109.Icon
  }, import_react670.default.createElement(Icon, {
    source: SvgSelectMinor
  })));
  const optionsMarkup = normalizedOptions.map(renderOption);
  return import_react670.default.createElement(Labelled, {
    id,
    label,
    error,
    action: labelAction,
    ...
    helpText,
    requiredIndicator
  }, import_react670.default.createElement("div", {
    className
  }, import_react670.default.createElement("select", {
    id,
    name,
    value,
    className: styles109.Input,
    disabled,
    onFocus,
    onBlur,
    onChange: handleChange,
    ...
    "aria-describedby": describedBy.length ? describedBy.join(" ") : void 0,
    "aria-required": requiredIndicator
  }, optionsMarkup), contentMarkup, import_react670.default.createElement("div", {
...
function renderSingleOption(option) {
  ...
  return import_react670.default.createElement("option", Object.assign({
    key: value,
    value
  }, rest), label);
}
function renderOption(optionOrGroup) {
  if (isGroup(optionOrGroup)) {
    ...
    return import_react670.default.createElement("optgroup", {
      label: title,
      key: title
...
var ResourceList = function ResourceList2({
  items,
  filterControl,
  emptyState,
  emptySearchState,
  ...
  const i18n = useI18n();
  const [selectMode, setSelectMode] = (0, import_react671.useState)(Boolean(selectedItems && selectedItems.length > 0));
  const [loadingPosition, setLoadingPositionState] = (0, import_react671.useState)(0);
  const [lastSelected, setLastSelected] = (0, import_react671.useState)();
  const [smallScreen, setSmallScreen] = (0, import_react671.useState)(isBreakpointsXS2());
  const forceUpdate = (0, import_react671.useReducer)((x = 0) => x + 1, 0)[1];
  const [checkableButtons, setCheckableButtons] = (0, import_react671.useState)(/* @__PURE__ */ new Map());
  const defaultResourceName = useLazyRef(() => ({
    singular: i18n.translate("Polaris.ResourceList.defaultItemSingular"),
    plural: i18n.translate("Polaris.ResourceList.defaultItemPlural")
  }));
  const listRef = (0, import_react671.useRef)(null);
  ...
  const setLoadingPosition = (0, import_react671.useCallback)(() => {
  ...
  const bulkActionsMarkup = isSelectable ? import_react671.default.createElement("div", {
    className: styles108.BulkActionsWrapper
  }, import_react671.default.createElement(BulkActions, {
  ...
  const filterControlMarkup = filterControl ? import_react671.default.createElement("div", {
    className: styles108.FiltersWrapper
  }, filterControl) : null;
  const sortingSelectMarkup = sortOptions && sortOptions.length > 0 && !alternateTool ? import_react671.default.createElement("div", {
    className: styles108.SortWrapper
  }, import_react671.default.createElement(Select, {
  ...
  const alternateToolMarkup = alternateTool && !sortingSelectMarkup ? import_react671.default.createElement("div", {
    className: styles108.AlternateToolWrapper
  }, alternateTool) : null;
  const headerTitleMarkup = import_react671.default.createElement("div", {
    className: styles108.HeaderTitleWrapper
  }, headerTitle());
  const selectButtonMarkup = isSelectable ? import_react671.default.createElement("div", {
    className: styles108.SelectButtonWrapper
  }, import_react671.default.createElement(Button, {
    disabled: selectMode,
    icon: SvgEnableSelectionMinor,
    onClick: () => handleSelectMode(true)
  }, i18n.translate("Polaris.ResourceList.selectButtonText"))) : null;
  const checkableButtonMarkup = isSelectable ? import_react671.default.createElement("div", {
    className: styles108.CheckableButtonWrapper
  }, import_react671.default.createElement(CheckableButton, {
    accessibilityLabel: bulkActionsAccessibilityLabel(),
    label: headerTitle(),
    onToggleAll: handleToggleAll,
    plain: true,
  ...
  const headerWrapperOverlay = loading ? import_react671.default.createElement("div", {
    className: styles108["HeaderWrapper-overlay"]
  }) : null;
  ...
  const headerMarkup = !showEmptyState && showHeader !== false && !showEmptySearchState && (showHeader || needsHeader) && listRef.current && import_react671.default.createElement("div", {
    className: styles108.HeaderOuterWrapper
  }, import_react671.default.createElement(Sticky, {
    boundingElement: listRef.current
  }, (isSticky) => {
    const headerClassName = classNames(styles108.HeaderWrapper, sortOptions && sortOptions.length > 0 && !alternateTool && styles108["HeaderWrapper-hasSort"], alternateTool && styles108["HeaderWrapper-hasAlternateTool"], isSelectable && styles108["HeaderWrapper-hasSelect"], loading && styles108["HeaderWrapper-disabled"], isSelectable && selectMode && styles108["HeaderWrapper-inSelectMode"], isSticky && styles108["HeaderWrapper-isSticky"]);
    return import_react671.default.createElement("div", {
      className: headerClassName
    }, import_react671.default.createElement(EventListener, {
      event: "resize",
      handler: handleResize
    }), headerWrapperOverlay, import_react671.default.createElement("div", {
      className: styles108.HeaderContentWrapper
    }, headerTitleMarkup, checkableButtonMarkup, alternateToolMarkup, sortingSelectMarkup, selectButtonMarkup), bulkActionsMarkup);
  }));
  const emptySearchStateMarkup = showEmptySearchState ? emptySearchState || import_react671.default.createElement("div", {
    className: styles108.EmptySearchResultWrapper
  }, import_react671.default.createElement(EmptySearchResult, Object.assign({}, emptySearchResultText, {
    withIllustration: true
  }))) : null;
  ...
  const loadingOverlay = loading ? import_react671.default.createElement(import_react671.default.Fragment, null, import_react671.default.createElement("li", {
    className: styles108.SpinnerContainer,
    style: spinnerStyle
  }, import_react671.default.createElement(Spinner, {
    size: spinnerSize,
    accessibilityLabel: "Items are loading"
  })), import_react671.default.createElement("li", {
    className: styles108.LoadingOverlay
  })) : null;
  const className = classNames(styles108.ItemWrapper, loading && styles108["ItemWrapper-isLoading"]);
  const loadingWithoutItemsMarkup = loading && !itemsExist ? import_react671.default.createElement("div", {
    className,
    tabIndex: -1
  }, loadingOverlay) : null;
  const resourceListClassName = classNames(styles108.ResourceList, loading && styles108.disabledPointerEvents, selectMode && styles108.disableTextSelection);
  const listMarkup = itemsExist ? import_react671.default.createElement("ul", {
    className: resourceListClassName,
    ref: listRef,
    "aria-live": "polite",
    "aria-busy": loading
  }, loadingOverlay, import_react671.Children.toArray(items.map(renderItemWithId))) : null;
  const context = {
  ...
  return import_react671.default.createElement(ResourceListContext.Provider, {
    value: context
  }, import_react671.default.createElement("div", {
    className: styles108.ResourceListWrapper
...
function SettingToggle({
  ...
  const id = (0, import_react672.useMemo)(getUniqueSettingToggleId, []);
  ...
  return import_react672.default.createElement(Card, {
    sectioned: true
  }, import_react672.default.createElement(SettingAction, {
    action: actionMarkup
  }, import_react672.default.createElement("label", {
    htmlFor: id
  }, children2)));
}
...
function SkeletonBodyText({
  ...
  for (let i = 0; i < lines; i++) {
    bodyTextLines.push(import_react673.default.createElement("div", {
      className: styles110.SkeletonBodyText,
      key: i
    }));
  }
  return import_react673.default.createElement(import_react673.default.Fragment, null, bodyTextLines);
}
...
function SkeletonDisplayText({
  ...
  const className = classNames(styles111.DisplayText, size && styles111[variationName("size", size)]);
...
function SkeletonPage({
  ...
  const i18n = useI18n();
  const className = classNames(styles112.Page, fullWidth && styles112.fullWidth, narrowWidth && styles112.narrowWidth);
  const titleContent = title ? import_react675.default.createElement("h1", {
    className: styles112.Title
  }, title) : import_react675.default.createElement("div", {
    className: styles112.SkeletonTitle
  });
  const titleMarkup = import_react675.default.createElement("div", {
    className: styles112.TitleWrapper
  }, titleContent);
  const primaryActionMarkup = primaryAction ? import_react675.default.createElement("div", {
    className: styles112.PrimaryAction
  }, import_react675.default.createElement(SkeletonDisplayText, {
    size: "large"
  })) : null;
  const breadcrumbMarkup = breadcrumbs ? import_react675.default.createElement("div", {
    className: styles112.BreadcrumbAction,
    style: {
      width: 60
    }
  }, import_react675.default.createElement(SkeletonBodyText, {
    lines: 1
  })) : null;
  return import_react675.default.createElement("div", {
    ...
    className: styles112.Header
  }, breadcrumbMarkup, import_react675.default.createElement("div", {
    className: styles112.TitleAndPrimaryAction
  }, titleMarkup, primaryActionMarkup)), import_react675.default.createElement("div", {
    className: styles112.Content
  }, children2));
}
...
function SkeletonTabs({
  ...
  return import_react676.default.createElement("div", {
    className: styles113.Tabs
  }, [...Array(count).keys()].map((key) => {
    const tabWidthClassName = key % 2 === 0 ? styles113["Tab-short"] : styles113["Tab-long"];
    return import_react676.default.createElement("div", {
      key,
      className: classNames(styles113.Tab, tabWidthClassName)
    }, import_react676.default.createElement(SkeletonBodyText, {
      lines: 1
    }));
  }));
}
...
function SkeletonThumbnail({
  ...
  const className = classNames(styles114.SkeletonThumbnail, size && styles114[variationName("size", size)]);
  return import_react677.default.createElement("div", {
    className
  });
}
...
function Panel({
  ...
  const className = classNames(styles115.Panel, hidden && styles115["Panel-hidden"]);
  return import_react678.default.createElement("div", {
    className,
    id,
    role: "tabpanel",
...
function Tab({
  ...
  const wasSelected = (0, import_react679.useRef)(selected);
  const panelFocused = (0, import_react679.useRef)(false);
  const node = (0, import_react679.useRef)(null);
  (0, import_react679.useEffect)(() => {
    if (measuring) {
      return;
    }
  ...
  const className = classNames(styles115.Tab, selected && styles115["Tab-selected"]);
  let tabIndex;
  ...
  const tabContainerClassNames = classNames(styles115.TabContainer, selected && styles115.Underline);
  const markup = url ? import_react679.default.createElement(UnstyledLink, {
    id,
    url,
    role: "tab",
    tabIndex,
    ...
    "aria-label": accessibilityLabel,
    onMouseUp: handleMouseUpByBlurring
  }, import_react679.default.createElement("span", {
    className: styles115.Title
  }, children2)) : import_react679.default.createElement("button", {
    id,
    role: "tab",
    type: "button",
    tabIndex,
  ...
  return import_react679.default.createElement("li", {
...
// node_modules/@shopify/polaris/build/esm/components/Tabs/components/TabMeasurer/TabMeasurer.js
var TabMeasurer = (0, import_react680.memo)(function TabMeasurer2({
  selected,
  tabs,
  activator,
  tabToFocus,
  ...
  const containerNode = (0, import_react680.useRef)(null);
  const animationFrame = (0, import_react680.useRef)(null);
  const handleMeasurement = (0, import_react680.useCallback)(() => {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
    animationFrame.current = requestAnimationFrame(() => {
  ...
  const tabsMarkup = tabs.map((tab, index) => {
    return import_react680.default.createElement(Tab, {
      measuring: true,
  ...
  const classname = classNames(styles115.Tabs, styles115.TabMeasurer);
  return import_react680.default.createElement("div", {
    className: classname,
    ref: containerNode
  }, import_react680.default.createElement(EventListener, {
    event: "resize",
...
var Item9 = class extends import_react681.PureComponent {
  constructor(...args) {
    super(...args);
    this.context = void 0;
  ...
  render() {
    ...
    const classname = classNames(styles115.Item);
    const sharedProps = {
      id,
    ...
    const markup = url ? import_react681.default.createElement(UnstyledLink, Object.assign({}, sharedProps, {
      url
    }), children2) : import_react681.default.createElement("button", Object.assign({}, sharedProps, {
      type: "button"
    }), children2);
    return import_react681.default.createElement("li", null, markup);
  }
};
...
function List3({
  ...
  const tabs = disclosureTabs.map(({
    ...
    return import_react682.default.createElement(Item9, Object.assign({
      key: id
    }, tabProps, {
      id,
  ...
  return import_react682.default.createElement("ul", {
    className: styles115.List,
...
// node_modules/@shopify/polaris/build/esm/components/Tabs/Tabs.js
var TabsInner = class extends import_react683.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      disclosureWidth: 0,
    ...
    this.renderTabMarkup = (tab, index) => {
      ...
      return import_react683.default.createElement(Tab, {
        key: `${index}-${tab.id}`,
        id: tab.id,
    ...
    this.handleFocus = (event) => {
      ...
      const target = event.target;
      if (target.classList.contains(styles115.Tab) || target.classList.contains(styles115.Item)) {
        let tabToFocus = -1;
      ...
      if (target.classList.contains(styles115.DisclosureActivator)) {
        return;
      }
      ...
      if (relatedTarget instanceof HTMLElement && !relatedTarget.classList.contains(styles115.Tab) && !relatedTarget.classList.contains(styles115.Item) && !relatedTarget.classList.contains(styles115.DisclosureActivator)) {
        this.setState({
          tabToFocus: selected
        });
      }
    ...
    this.handleBlur = (event) => {
      ...
      if (target instanceof HTMLElement && !target.classList.contains(styles115.Tab) && !target.classList.contains(styles115.Item)) {
        this.setState({
          tabToFocus: -1
        });
      }
  ...
  render() {
    ...
    const panelMarkup = children2 ? tabs.map((_tab, index) => {
      return selected === index ? import_react683.default.createElement(Panel, {
        id: tabs[index].panelID || `${tabs[index].id}-panel`,
        tabID: tabs[index].id,
        key: tabs[index].id
      }, children2) : import_react683.default.createElement(Panel, {
        id: tabs[index].panelID || `${tabs[index].id}-panel`,
        tabID: tabs[index].id,
        key: tabs[index].id,
        hidden: true
    ...
    const classname = classNames(styles115.Tabs, fitted && styles115.fitted, disclosureActivatorVisible && styles115.fillSpace);
    const disclosureTabClassName = classNames(styles115.DisclosureTab, disclosureActivatorVisible && styles115["DisclosureTab-visible"]);
    const disclosureButtonClassName = classNames(styles115.DisclosureActivator, hasCustomDisclosure && styles115.Tab);
    const disclosureButtonContentWrapperClassName = classNames(styles115.Title, hasCustomDisclosure && styles115.titleWithIcon);
    const disclosureButtonContent = hasCustomDisclosure ? import_react683.default.createElement(import_react683.default.Fragment, null, disclosureText, import_react683.default.createElement(Icon, {
      source: SvgCaretDownMinor,
      color: "subdued"
    })) : import_react683.default.createElement(Icon, {
      source: SvgHorizontalDotsMinor,
      color: "subdued"
    });
    const disclosureButton = import_react683.default.createElement("button", {
      type: "button",
      className: disclosureButtonClassName,
      onClick: this.handleDisclosureActivatorClick,
      "aria-label": i18n.translate("Polaris.Tabs.toggleTabsLabel")
    }, import_react683.default.createElement("span", {
      className: disclosureButtonContentWrapperClassName
    }, disclosureButtonContent));
    const activator = disclosureText ? import_react683.default.createElement("div", {
      className: styles115.TabContainer
    }, disclosureButton) : disclosureButton;
    return import_react683.default.createElement("div", null, import_react683.default.createElement("div", {
      className: styles115.Wrapper
    }, import_react683.default.createElement(TabMeasurer, {
      tabToFocus,
      activator,
      selected,
      tabs,
      siblingTabHasFocus: tabToFocus > -1,
      handleMeasurement: this.handleMeasurement
    }), import_react683.default.createElement("ul", {
      role: "tablist",
      className: classname,
      onFocus: this.handleFocus,
      onBlur: this.handleBlur,
    ...
    }, tabsMarkup, import_react683.default.createElement("li", {
      className: disclosureTabClassName,
      role: "presentation"
    }, import_react683.default.createElement(Popover2, {
      preferredPosition: "below",
      activator,
      active: disclosureActivatorVisible && showDisclosure,
      onClose: this.handleClose,
      autofocusTarget: "first-node"
    }, import_react683.default.createElement(List3, {
...
function Tabs(props) {
  const i18n = useI18n();
  return import_react683.default.createElement(TabsInner, Object.assign({}, props, {
    i18n
  }));
}
...
var Text = ({
  ...
  const className = classNames(styles116.root, styles116[variant], fontWeight ? styles116[fontWeight] : styles116[VariantFontWeightMapping[variant]], (alignment || truncate) && styles116.block, alignment && styles116[alignment], color && styles116[color], truncate && styles116.truncate, visuallyHidden && styles116.visuallyHidden);
  return import_react684.default.createElement(Component9, {
    className
  }, children2);
};
...
function Thumbnail({
  ...
  const className = classNames(styles117.Thumbnail, size && styles117[variationName("size", size)], transparent && styles117.transparent);
  const content = typeof source === "string" ? import_react685.default.createElement(Image, {
    alt,
    source
  }) : import_react685.default.createElement(Icon, {
    accessibilityLabel: alt,
    source
  });
  return import_react685.default.createElement("span", {
    className
  }, content);
}
...
var Toast2 = (0, import_react686.memo)(function Toast3(props) {
...
function SearchDismissOverlay({
  ...
  const node = (0, import_react687.useRef)(null);
  const handleDismiss = (0, import_react687.useCallback)(({
    target
  }) => {
  ...
  return import_react687.default.createElement(import_react687.default.Fragment, null, visible ? import_react687.default.createElement(ScrollLock, null) : null, import_react687.default.createElement("div", {
    ref: node,
    className: classNames(styles120.SearchDismissOverlay, visible && styles120.visible),
...
function Search({
  ...
  const overlayMarkup = visible ? import_react688.default.createElement(SearchDismissOverlay, {
    onDismiss,
    visible: overlayVisible
  }) : null;
  return import_react688.default.createElement(import_react688.default.Fragment, null, overlayMarkup, import_react688.default.createElement("div", {
    className: classNames(styles119.Search, visible && styles119.visible)
  }, import_react688.default.createElement("div", {
    className: styles119.SearchContent
  }, import_react688.default.createElement("div", {
    className: styles119.Results
  }, children2))));
}
...
function SearchField({
  ...
  const i18n = useI18n();
  const [forceActive, setForceActive] = (0, import_react689.useState)(false);
  const input = (0, import_react689.useRef)(null);
  const searchId = useUniqueId("SearchField");
  const handleChange = (0, import_react689.useCallback)(({
    currentTarget
  }) => {
    onChange(currentTarget.value);
  }, [onChange]);
  const handleFocus = (0, import_react689.useCallback)(() => onFocus && onFocus(), [onFocus]);
  const handleBlur = (0, import_react689.useCallback)(() => onBlur && onBlur(), [onBlur]);
  const handleClear = (0, import_react689.useCallback)(() => {
    onCancel && onCancel();
    if (!input.current) {
      return;
    }
  ...
  const clearMarkup = value !== "" && import_react689.default.createElement("button", {
    type: "button",
    "aria-label": i18n.translate("Polaris.TopBar.SearchField.clearButtonLabel"),
    className: styles121.Clear,
    onClick: handleClear,
    onBlur: () => {
  ...
  }, import_react689.default.createElement(Icon, {
    source: SvgCircleCancelMinor
  }));
  const className = classNames(styles121.SearchField, (focused || active || forceActive) && styles121.focused);
  return import_react689.default.createElement("div", {
    className,
    onFocus: handleFocus,
    onBlur: handleBlur
  }, import_react689.default.createElement(VisuallyHidden, null, import_react689.default.createElement("label", {
    htmlFor: searchId
  }, i18n.translate("Polaris.TopBar.SearchField.search"))), import_react689.default.createElement("input", {
    id: searchId,
  ...
  }), import_react689.default.createElement("span", {
    className: styles121.Icon
  }, import_react689.default.createElement(Icon, {
    source: SvgSearchMinor
  })), clearMarkup, import_react689.default.createElement("div", {
    className: classNames(styles121.Backdrop, showFocusBorder && styles121.BackdropShowFocusBorder)
  }));
}
...
function MessageIndicator({
  ...
  const indicatorMarkup = active && import_react690.default.createElement("div", {
    className: styles123.MessageIndicator
  });
  return import_react690.default.createElement("div", {
    className: styles123.MessageIndicatorWrapper
...
function Message({
  ...
  const badgeMarkup = badge && import_react691.default.createElement(Badge, {
    status: badge.status
  }, badge.content);
  const {
    to,
  ...
  return import_react691.default.createElement("div", {
    className: styles125.Section
  }, import_react691.default.createElement(Popover2.Section, null, import_react691.default.createElement(Stack, {
    vertical: true,
    spacing: "tight"
  }, import_react691.default.createElement(TextContainer, null, import_react691.default.createElement(Heading, null, title, badgeMarkup), import_react691.default.createElement("p", null, description)), import_react691.default.createElement(Link, {
    url: to
  }, linkContent), import_react691.default.createElement(Button, {
    plain: true,
    onClick
  }, actionContent))));
}
...
function Menu(props) {
  ...
  const messageMarkup = message && import_react692.default.createElement(Message, {
    title: message.title,
  ...
  return import_react692.default.createElement(Popover2, {
    activator: import_react692.default.createElement("div", {
      className: styles124.ActivatorWrapper
    }, import_react692.default.createElement("button", {
      type: "button",
      className: styles124.Activator,
      onClick: onOpen,
      "aria-label": accessibilityLabel
    }, activatorContent)),
    active: open,
    ...
    preferredAlignment: "right"
  }, import_react692.default.createElement(ActionList, {
...
function UserMenu({
  ...
  const activatorContentMarkup = import_react693.default.createElement(import_react693.default.Fragment, null, import_react693.default.createElement(MessageIndicator, {
    active: showIndicator
  }, import_react693.default.createElement(Avatar, {
    size: "small",
    source: avatar,
    initials: initials && initials.replace(" ", "")
  })), import_react693.default.createElement("span", {
    className: styles122.Details
  }, import_react693.default.createElement("p", {
    className: styles122.Name
  }, name), import_react693.default.createElement("p", {
    className: styles122.Detail
  }, detail)));
  return import_react693.default.createElement(Menu, {
...
var TopBar = function TopBar2({
  ...
  const iconClassName = classNames(styles118.NavigationIcon, focused && styles118.focused);
  const navigationButtonMarkup = showNavigationToggle ? import_react694.default.createElement("button", {
    type: "button",
    className: iconClassName,
    ...
    className: styles118.IconWrapper
  }, import_react694.default.createElement(Icon, {
    source: SvgMobileHamburgerMajor
  }))) : null;
  const width = getWidth(logo, 104);
  let contextMarkup;
  if (contextControl) {
    contextMarkup = import_react694.default.createElement("div", {
      className: styles118.ContextControl
    }, contextControl);
  } else if (logo) {
    const className = classNames(styles118.LogoContainer, showNavigationToggle || searchField ? styles118.LogoDisplayControl : styles118.LogoDisplayContainer, logoSuffix && styles118.hasLogoSuffix);
    contextMarkup = import_react694.default.createElement("div", {
      className
    }, import_react694.default.createElement(UnstyledLink, {
      url: logo.url || "",
      className: styles118.LogoLink,
      style: {
        width
      }
    }, import_react694.default.createElement(Image, {
      source: logo.topBarSource || "",
      alt: logo.accessibilityLabel || "",
      className: styles118.Logo,
      style: {
        width
      }
    })), logoSuffix);
  }
  const searchMarkup = searchField ? import_react694.default.createElement(import_react694.default.Fragment, null, searchField, import_react694.default.createElement(Search, {
  ...
  return import_react694.default.createElement("div", {
    className: styles118.TopBar
  }, navigationButtonMarkup, contextMarkup, import_react694.default.createElement("div", {
    className: styles118.Contents
  }, import_react694.default.createElement("div", {
    className: styles118.SearchField
  }, searchMarkup), import_react694.default.createElement("div", {
    className: styles118.SecondaryMenu
...
// node_modules/@shopify/polaris/build/esm/components/VideoThumbnail/illustrations/play.svg.js
var img3 = "data:image/svg+xml,%3csvg viewBox='0 0 38 38' xmlns='http://www.w3.org/2000/svg' fill-rule='evenodd' clip-rule='evenodd'%3e%3cpath d='M19 1C9.06 1 1 9.057 1 19c0 9.94 8.057 18 18 18 9.94 0 18-8.057 18-18 0-9.94-8.057-18-18-18z' fill='white'/%3e%3cpath d='M19 1C9.06 1 1 9.057 1 19c0 9.94 8.057 18 18 18 9.94 0 18-8.057 18-18 0-9.94-8.057-18-18-18z' fill='none' stroke='%23b5b5b5'/%3e%3cpath d='M15 11.723c0-.605.7-.942 1.173-.564l10.93 7.215a.72.72 0 010 1.128l-10.93 7.216A.723.723 0 0115 26.153v-14.43z' fill-opacity='.557'/%3e%3c/svg%3e";
var PlayIcon = img3;
...
function VideoThumbnail({
  ...
  const timeStampMarkup = videoLength ? import_react695.default.createElement("p", {
    className: classNames(styles126.Timestamp, showVideoProgress && styles126.withProgress)
  ...
  if (showVideoProgress) {
    ...
    progressMarkup = import_react695.default.createElement("div", {
      className: styles126.Progress
    }, import_react695.default.createElement("progress", {
      className: styles126.ProgressBar,
      value: progressValuePercents,
      max: "100"
    }), import_react695.default.createElement("div", {
      className: styles126.Indicator,
      style: {
        transform: `scaleX(${progressValue})`
      }
    }, import_react695.default.createElement("span", {
      className: styles126.Label
    }, progressValuePercents, "%")));
  }
  return import_react695.default.createElement("div", {
    className: styles126.Thumbnail,
    style: {
      backgroundImage: `url(${thumbnailUrl})`
    }
  }, import_react695.default.createElement("button", {
    type: "button",
    className: styles126.PlayButton,
    "aria-label": buttonLabel,
    onClick,
    onMouseEnter: onBeforeStartPlaying,
    onFocus: onBeforeStartPlaying,
    onTouchStart: onBeforeStartPlaying
  }, import_react695.default.createElement("img", {
    className: styles126.PlayIcon,
    src: PlayIcon,
    alt: ""
...
function useRowHovered() {
  const hovered = (0, import_react696.useContext)(RowHoveredContext);
  return hovered;
}
function useRowSelected() {
  const {
    selected
  } = (0, import_react696.useContext)(RowContext);
  return selected;
}
function useContainerScroll() {
  const scrolledContainerRef = (0, import_react696.useContext)(ScrollContext);
