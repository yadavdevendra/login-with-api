...
declare type Element = 'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6' | 'p' | 'span';
...
declare type Color = 'success' | 'critical' | 'warning' | 'subdued';
...
export declare const Text: ({ alignment, as, children, color, fontWeight, truncate, variant, visuallyHidden, }: TextProps) => JSX.Element;
export {};
