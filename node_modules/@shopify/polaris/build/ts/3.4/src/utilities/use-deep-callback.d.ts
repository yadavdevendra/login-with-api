 ...
 * }
 */
export declare function useDeepCallback(callback: Parameters<typeof useCallback>[0], dependencies: Parameters<typeof useDeepCompareRef>[0], customCompare?: Parameters<typeof useDeepCompareRef>[1]): (...args: any[]) => any;
//# sourceMappingURL=use-deep-callback.d.ts.map
