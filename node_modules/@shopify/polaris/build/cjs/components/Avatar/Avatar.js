...
function Avatar({
  ...
  const isAfterInitialMount = useIsAfterInitialMount.useIsAfterInitialMount(); // WARNING: This approach of utilizing the first letter of the name to generate the icon styling within the Avatar component also exists in one other repository:
